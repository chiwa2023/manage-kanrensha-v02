...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する39
 */
@Component
public class DumpSabunKanrenshaPersonHistory39ItemReader extends RepositoryItemReader<KanrenshaPersonHistory39Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory39ItemReader(
            final @Autowired KanrenshaPersonHistory39Repository partnerPersonHistory39Repository) {
        super(partnerPersonHistory39Repository, new HashMap<String, Direction>());
