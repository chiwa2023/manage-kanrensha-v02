...
/**
 * kanrensha_kigyou_dt_history_06接続用Repository
 */
public interface KanrenshaKigyouDtHistory06Repository extends JpaRepository<KanrenshaKigyouDtHistory06Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory06Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_06"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory06Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_06 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory06Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory06Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
