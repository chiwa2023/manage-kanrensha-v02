 ...
 */
@Component
public class EraseWkTblMasterSeijidantaiAddStdTasklet implements Tasklet, StepExecutionListener {
    ...
    public RepeatStatus execute(final StepContribution contribution, final ChunkContext chunkContext) throws Exception {
        ...
        wkTblKanrenshaSeijidantaiMasterRepository.deleteByInsertUserCode(userCode);
        wkTblKanrenshaSeijidantaiMasterResultRepository.deleteByInsertUserCode(userCode);
