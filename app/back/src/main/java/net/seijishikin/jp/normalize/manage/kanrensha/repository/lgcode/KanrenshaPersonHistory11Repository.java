...
/**
 * kanrensha_person_history_11接続用Repository
 */
public interface KanrenshaPersonHistory11Repository extends JpaRepository<KanrenshaPersonHistory11Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory11Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_11"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory11Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_11 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory11Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory11Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
