...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する19
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory19ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory19Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory19Repository 関連者企業履歴19Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory19ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory19Repository partnerPoliOrgHistory19Repository) {
        super(partnerPoliOrgHistory19Repository, new HashMap<String, Direction>());
