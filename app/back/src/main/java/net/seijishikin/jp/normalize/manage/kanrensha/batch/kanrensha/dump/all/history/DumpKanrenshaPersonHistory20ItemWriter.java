 ...
 */
@Component
public class DumpKanrenshaPersonHistory20ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory20Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory20ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory20Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory20Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
