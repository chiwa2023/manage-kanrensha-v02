...
public interface KanrenshaKigyouDtHistory10Repository extends JpaRepository<KanrenshaKigyouDtHistory10Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory10Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_10 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory10Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory10Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
