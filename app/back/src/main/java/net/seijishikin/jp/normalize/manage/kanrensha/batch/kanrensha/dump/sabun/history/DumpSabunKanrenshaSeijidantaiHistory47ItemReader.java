...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する47
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory47ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory47Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory47Repository 関連者企業履歴47Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory47ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory47Repository partnerPoliOrgHistory47Repository) {
        super(partnerPoliOrgHistory47Repository, new HashMap<String, Direction>());
