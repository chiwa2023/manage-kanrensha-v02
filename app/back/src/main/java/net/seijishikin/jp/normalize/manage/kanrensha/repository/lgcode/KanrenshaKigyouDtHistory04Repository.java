...
public interface KanrenshaKigyouDtHistory04Repository extends JpaRepository<KanrenshaKigyouDtHistory04Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_04 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory04Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
