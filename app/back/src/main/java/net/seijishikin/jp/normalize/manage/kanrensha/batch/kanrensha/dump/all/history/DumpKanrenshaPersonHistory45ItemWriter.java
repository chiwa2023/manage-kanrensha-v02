 ...
 */
@Component
public class DumpKanrenshaPersonHistory45ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory45Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory45ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory45Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory45Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
