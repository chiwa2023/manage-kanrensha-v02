...
/**
 * kanrensha_seijidantai_history_39接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_39)
public class KanrenshaSeijidantaiHistory39Entity // NOPMD DataClass
