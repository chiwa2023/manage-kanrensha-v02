...
public interface KanrenshaKigyouDtHistory23Repository extends JpaRepository<KanrenshaKigyouDtHistory23Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory23Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_23 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory23Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory23Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
