...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する28
 */
@Component
public class DumpSabunKanrenshaPersonHistory28ItemReader extends RepositoryItemReader<KanrenshaPersonHistory28Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory28Repository 関連者企業履歴28Repository
     */
    public DumpSabunKanrenshaPersonHistory28ItemReader(
            final @Autowired KanrenshaPersonHistory28Repository partnerPersonHistory28Repository) {
        super(partnerPersonHistory28Repository, new HashMap<String, Direction>());
