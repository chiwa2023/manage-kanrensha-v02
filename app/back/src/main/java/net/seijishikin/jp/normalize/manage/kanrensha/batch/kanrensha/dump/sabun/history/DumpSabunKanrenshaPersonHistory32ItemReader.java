...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する32
 */
@Component
public class DumpSabunKanrenshaPersonHistory32ItemReader extends RepositoryItemReader<KanrenshaPersonHistory32Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory32Repository 関連者企業履歴32Repository
     */
    public DumpSabunKanrenshaPersonHistory32ItemReader(
            final @Autowired KanrenshaPersonHistory32Repository partnerPersonHistory32Repository) {
        super(partnerPersonHistory32Repository, new HashMap<String, Direction>());
