...
/**
 * kanrensha_person_history_08接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_08)
public class KanrenshaPersonHistory08Entity // NOPMD DataClass
