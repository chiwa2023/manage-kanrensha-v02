...
/**
 * kanrensha_kigyou_dt_history_30接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_30)
public class KanrenshaKigyouDtHistory30Entity // NOPMD DataClass
