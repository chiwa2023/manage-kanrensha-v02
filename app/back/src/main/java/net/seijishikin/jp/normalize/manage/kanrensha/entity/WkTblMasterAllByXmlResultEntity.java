...
/**
 * wk_tbl_master_all_by_xml_result接続用Entity
 */
@Entity
@Table(name = "wk_tbl_master_all_by_xml_result")
public class WkTblMasterAllByXmlResultEntity // NOPMD DataClass
    ...
    @Column(name = "wk_tbl_master_all_by_xml_result_id")
    private Integer wkTblMasterAllByXmlResultId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkTblMasterAllByXmlResultId() {
        return wkTblMasterAllByXmlResultId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkTblMasterAllByXmlResultId テーブルId
     */
    public void setWkTblMasterAllByXmlResultId(final Integer wkTblMasterAllByXmlResultId) {
        this.wkTblMasterAllByXmlResultId = wkTblMasterAllByXmlResultId;
    }
     ...
     * ワークテーブルマスタIdを設定する
     *
     * @param wkTblMasterAllByXmlId ワークテーブルマスタId
     */
