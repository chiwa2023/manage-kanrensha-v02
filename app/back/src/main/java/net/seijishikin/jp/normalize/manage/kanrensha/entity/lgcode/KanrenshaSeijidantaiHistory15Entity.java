...
/**
 * kanrensha_seijidantai_history_15接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_15)
public class KanrenshaSeijidantaiHistory15Entity // NOPMD DataClass
