...
/**
 * kanrensha_seijidantai_history_46接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_46)
public class KanrenshaSeijidantaiHistory46Entity // NOPMD DataClass
