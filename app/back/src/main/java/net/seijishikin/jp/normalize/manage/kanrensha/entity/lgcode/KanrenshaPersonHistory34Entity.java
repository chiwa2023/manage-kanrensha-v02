...
/**
 * kanrensha_person_history_34接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_34)
public class KanrenshaPersonHistory34Entity // NOPMD DataClass
