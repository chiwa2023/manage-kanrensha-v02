...
/**
 * kanrensha_person_history_02接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_02)
public class KanrenshaPersonHistory02Entity // NOPMD DataClass
