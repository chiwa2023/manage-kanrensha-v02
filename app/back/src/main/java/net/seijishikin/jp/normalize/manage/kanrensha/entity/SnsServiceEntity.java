...
/**
 * sns_service接続用Entity
 */
@Entity
@Table(name = "sns_service")
public class SnsServiceEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
