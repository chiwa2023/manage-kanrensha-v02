...
/**
 * kanrensha_seijidantai_history_04接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_04)
public class KanrenshaSeijidantaiHistory04Entity // NOPMD DataClass
