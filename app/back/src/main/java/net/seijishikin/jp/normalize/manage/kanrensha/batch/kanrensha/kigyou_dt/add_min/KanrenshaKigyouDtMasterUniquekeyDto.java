 ...
 * 関連者企業・団体の一意キー取得Dto
 */
public class KanrenshaKigyouDtMasterUniquekeyDto implements Serializable { // NOPMD DataClass
     ...
     */
    public KanrenshaKigyouDtMasterUniquekeyDto(final String kanrenshaName, final String allAddress, final String KigyouDtDelegate) {
        super();
