...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する23
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory23ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory23Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory23Repository 関連者企業履歴23Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory23ItemReader(
            final @Autowired KanrenshaKigyouDtHistory23Repository kanrenshaKigyouDtHistory23Repository) {
        super(kanrenshaKigyouDtHistory23Repository, new HashMap<String, Direction>());
