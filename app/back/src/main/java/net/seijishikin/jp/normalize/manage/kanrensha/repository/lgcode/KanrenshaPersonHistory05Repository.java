...
/**
 * kanrensha_person_history_05接続用Repository
 */
public interface KanrenshaPersonHistory05Repository extends JpaRepository<KanrenshaPersonHistory05Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory05Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_05"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory05Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_05 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory05Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory05Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
