...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する22
 */
@Component
public class DumpSabunKanrenshaPersonHistory22ItemReader extends RepositoryItemReader<KanrenshaPersonHistory22Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory22Repository 関連者企業履歴22Repository
     */
    public DumpSabunKanrenshaPersonHistory22ItemReader(
            final @Autowired KanrenshaPersonHistory22Repository partnerPersonHistory22Repository) {
        super(partnerPersonHistory22Repository, new HashMap<String, Direction>());
