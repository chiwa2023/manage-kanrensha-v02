 ...
 */
@Component
public class DumpKanrenshaSeijidantaiHistory39ItemReader
     ...
     */
    public DumpKanrenshaSeijidantaiHistory39ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory39Repository partnerPoliOrgHistory39Repository) {
        super(partnerPoliOrgHistory39Repository, new HashMap<String, Direction>());
