...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する04
 */
@Component
public class DumpSabunKanrenshaPersonHistory04ItemReader extends RepositoryItemReader<KanrenshaPersonHistory04Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory04ItemReader(
            final @Autowired KanrenshaPersonHistory04Repository partnerPersonHistory04Repository) {
        super(partnerPersonHistory04Repository, new HashMap<String, Direction>());
