...
/**
 * kanrensha_seijidantai_history_99接続用Entity
 */
@Entity
@Table(name = "kanrensha_seijidantai_history_99")
public class KanrenshaSeijidantaiHistory99Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
