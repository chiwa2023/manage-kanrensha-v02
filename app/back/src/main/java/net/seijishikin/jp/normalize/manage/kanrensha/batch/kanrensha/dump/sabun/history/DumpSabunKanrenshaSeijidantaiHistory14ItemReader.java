...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する14
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory14ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory14Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory14Repository 関連者企業履歴14Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory14ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory14Repository partnerPoliOrgHistory14Repository) {
        super(partnerPoliOrgHistory14Repository, new HashMap<String, Direction>());
