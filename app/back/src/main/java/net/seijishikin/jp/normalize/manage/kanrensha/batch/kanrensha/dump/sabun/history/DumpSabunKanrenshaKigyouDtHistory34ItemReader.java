...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する34
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory34ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory34Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory34Repository 関連者企業履歴34Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory34ItemReader(
            final @Autowired KanrenshaKigyouDtHistory34Repository kanrenshaKigyouDtHistory34Repository) {
        super(kanrenshaKigyouDtHistory34Repository, new HashMap<String, Direction>());
