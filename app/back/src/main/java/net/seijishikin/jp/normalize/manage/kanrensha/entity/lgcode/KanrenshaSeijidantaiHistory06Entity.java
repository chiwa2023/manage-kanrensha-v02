...
/**
 * kanrensha_seijidantai_history_06接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_06)
public class KanrenshaSeijidantaiHistory06Entity // NOPMD DataClass
