...
/**
 * kanrensha_person_history_12接続用Repository
 */
public interface KanrenshaPersonHistory12Repository extends JpaRepository<KanrenshaPersonHistory12Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory12Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_12"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory12Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_12 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory12Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory12Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
