...
/**
 * kanrensha_seijidantai_history_99接続用Repository
 */
public interface KanrenshaSeijidantaiHistory99Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory99Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory99Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_99"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory99Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_99 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory99Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory99Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
