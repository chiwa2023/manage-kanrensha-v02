...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する47
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory47ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory47Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory47Repository 関連者企業履歴47Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory47ItemReader(
            final @Autowired KanrenshaKigyouDtHistory47Repository kanrenshaKigyouDtHistory47Repository) {
        super(kanrenshaKigyouDtHistory47Repository, new HashMap<String, Direction>());
