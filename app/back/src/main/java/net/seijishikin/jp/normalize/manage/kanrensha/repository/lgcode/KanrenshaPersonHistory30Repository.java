...
/**
 * kanrensha_person_history_30接続用Repository
 */
public interface KanrenshaPersonHistory30Repository extends JpaRepository<KanrenshaPersonHistory30Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory30Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_30"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory30Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_30 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory30Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory30Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
