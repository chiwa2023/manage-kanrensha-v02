...
/**
 * kanrensha_person_history_12接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_12)
public class KanrenshaPersonHistory12Entity // NOPMD DataClass
