...
/**
 * kanrensha_kigyou_dt_history_25接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_25)
public class KanrenshaKigyouDtHistory25Entity // NOPMD DataClass
