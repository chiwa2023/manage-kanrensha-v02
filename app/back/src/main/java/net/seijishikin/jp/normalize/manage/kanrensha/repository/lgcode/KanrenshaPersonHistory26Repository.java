...
/**
 * kanrensha_person_history_26接続用Repository
 */
public interface KanrenshaPersonHistory26Repository extends JpaRepository<KanrenshaPersonHistory26Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory26Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_26"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory26Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_26 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory26Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory26Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
