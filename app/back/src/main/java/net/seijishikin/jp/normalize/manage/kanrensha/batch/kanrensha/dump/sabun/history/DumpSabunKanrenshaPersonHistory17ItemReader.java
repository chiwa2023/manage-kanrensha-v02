...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する17
 */
@Component
public class DumpSabunKanrenshaPersonHistory17ItemReader extends RepositoryItemReader<KanrenshaPersonHistory17Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory17Repository 関連者企業履歴17Repository
     */
    public DumpSabunKanrenshaPersonHistory17ItemReader(
            final @Autowired KanrenshaPersonHistory17Repository partnerPersonHistory17Repository) {
        super(partnerPersonHistory17Repository, new HashMap<String, Direction>());
