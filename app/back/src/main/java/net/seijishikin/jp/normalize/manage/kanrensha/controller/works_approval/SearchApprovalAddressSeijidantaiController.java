...
import net.seijishikin.jp.normalize.manage.kanrensha.service.works_approval.SearchApprovalAddressSeijidantaiService;

/**
 * 未承認変更データ政治団体検索Controller
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/works-approval")
public class SearchApprovalAddressSeijidantaiController {
    ...
    public ResponseEntity<SearchWorksApprovalResultDto> practice(
        ...
        try {
            ...
            resultDto.setResultDtoAddress(searchApprovalAddressSeijidantaiService.practice(capsuleDto));
