...
/**
 * kanrensha_person_history_07接続用Repository
 */
public interface KanrenshaPersonHistory07Repository extends JpaRepository<KanrenshaPersonHistory07Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory07Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_07"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory07Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_07 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory07Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory07Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
