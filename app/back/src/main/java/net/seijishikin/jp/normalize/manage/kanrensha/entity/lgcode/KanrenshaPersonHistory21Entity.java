...
/**
 * kanrensha_person_history_21接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_21)
public class KanrenshaPersonHistory21Entity // NOPMD DataClass
