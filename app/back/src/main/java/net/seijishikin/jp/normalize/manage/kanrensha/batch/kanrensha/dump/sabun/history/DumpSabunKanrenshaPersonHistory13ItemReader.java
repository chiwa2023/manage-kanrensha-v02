...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する13
 */
@Component
public class DumpSabunKanrenshaPersonHistory13ItemReader extends RepositoryItemReader<KanrenshaPersonHistory13Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory13Repository 関連者企業履歴13Repository
     */
    public DumpSabunKanrenshaPersonHistory13ItemReader(
            final @Autowired KanrenshaPersonHistory13Repository partnerPersonHistory13Repository) {
        super(partnerPersonHistory13Repository, new HashMap<String, Direction>());
