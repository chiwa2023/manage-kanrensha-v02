...
/**
 * kanrensha_seijidantai_history_23接続用Repository
 */
public interface KanrenshaSeijidantaiHistory23Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory23Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory23Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_23"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory23Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_23 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory23Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory23Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
