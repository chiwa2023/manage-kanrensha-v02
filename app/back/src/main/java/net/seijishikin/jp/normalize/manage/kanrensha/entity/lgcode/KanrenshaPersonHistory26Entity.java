...
/**
 * kanrensha_person_history_26接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_26)
public class KanrenshaPersonHistory26Entity // NOPMD DataClass
