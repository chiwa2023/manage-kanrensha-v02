...
/**
 * kanrensha_kigyou_dt_history_09接続用Repository
 */
public interface KanrenshaKigyouDtHistory09Repository extends JpaRepository<KanrenshaKigyouDtHistory09Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory09Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_09"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory09Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_09 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory09Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory09Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
