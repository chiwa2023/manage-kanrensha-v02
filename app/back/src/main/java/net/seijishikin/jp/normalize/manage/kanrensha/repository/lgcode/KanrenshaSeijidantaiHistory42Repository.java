...
/**
 * kanrensha_seijidantai_history_42接続用Repository
 */
public interface KanrenshaSeijidantaiHistory42Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory42Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory42Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_42"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory42Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_42 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory42Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory42Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
