...
public interface KanrenshaPersonHistory37Repository extends JpaRepository<KanrenshaPersonHistory37Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory37Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory37Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory37Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
