...
/**
 * kanrensha_seijidantai_history_13接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_13)
public class KanrenshaSeijidantaiHistory13Entity // NOPMD DataClass
