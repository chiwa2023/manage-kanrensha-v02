...
/**
 * kanrensha_seijidantai_history_38接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_38)
public class KanrenshaSeijidantaiHistory38Entity // NOPMD DataClass
