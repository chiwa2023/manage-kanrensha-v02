...
/**
 * kanrensha_kigyou_dt_history_05接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_05)
public class KanrenshaKigyouDtHistory05Entity // NOPMD DataClass
