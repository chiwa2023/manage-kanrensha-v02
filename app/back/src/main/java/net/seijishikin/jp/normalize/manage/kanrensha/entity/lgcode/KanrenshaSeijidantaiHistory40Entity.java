...
/**
 * kanrensha_seijidantai_history_40接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_40)
public class KanrenshaSeijidantaiHistory40Entity // NOPMD DataClass
