 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory07ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory07Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory07Repository 関連者企業履歴07Repository
     */
    public DumpKanrenshaKigyouDtHistory07ItemReader(
            final @Autowired KanrenshaKigyouDtHistory07Repository partnerCorpHistory07Repository) {
        super(partnerCorpHistory07Repository, new HashMap<String, Direction>());
