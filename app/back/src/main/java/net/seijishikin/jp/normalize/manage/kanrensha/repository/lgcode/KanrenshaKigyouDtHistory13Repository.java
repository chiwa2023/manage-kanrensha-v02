...
public interface KanrenshaKigyouDtHistory13Repository extends JpaRepository<KanrenshaKigyouDtHistory13Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory13Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_13 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory13Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
