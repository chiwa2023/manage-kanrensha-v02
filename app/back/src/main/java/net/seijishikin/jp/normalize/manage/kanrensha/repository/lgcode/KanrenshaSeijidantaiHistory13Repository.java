...
/**
 * kanrensha_seijidantai_history_13接続用Repository
 */
public interface KanrenshaSeijidantaiHistory13Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory13Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory13Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_13"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory13Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_13 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory13Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory13Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
