 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory14ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory14Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory14Repository 関連者企業履歴14Repository
     */
    public DumpKanrenshaKigyouDtHistory14ItemReader(
            final @Autowired KanrenshaKigyouDtHistory14Repository partnerCorpHistory14Repository) {
        super(partnerCorpHistory14Repository, new HashMap<String, Direction>());
