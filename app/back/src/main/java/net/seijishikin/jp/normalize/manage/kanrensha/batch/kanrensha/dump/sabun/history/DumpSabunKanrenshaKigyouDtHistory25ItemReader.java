...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する25
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory25ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory25Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory25Repository 関連者企業履歴25Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory25ItemReader(
            final @Autowired KanrenshaKigyouDtHistory25Repository kanrenshaKigyouDtHistory25Repository) {
        super(kanrenshaKigyouDtHistory25Repository, new HashMap<String, Direction>());
