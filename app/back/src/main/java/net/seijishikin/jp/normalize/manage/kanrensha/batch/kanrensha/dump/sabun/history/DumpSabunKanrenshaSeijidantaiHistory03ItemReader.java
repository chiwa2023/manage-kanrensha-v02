...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する03
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory03ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory03Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory03Repository 関連者企業履歴03Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory03ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory03Repository partnerPoliOrgHistory03Repository) {
        super(partnerPoliOrgHistory03Repository, new HashMap<>());
