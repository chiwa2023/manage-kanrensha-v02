 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory22ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory22Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory22Repository 関連者企業履歴22Repository
     */
    public DumpKanrenshaKigyouDtHistory22ItemReader(
            final @Autowired KanrenshaKigyouDtHistory22Repository partnerCorpHistory22Repository) {
        super(partnerCorpHistory22Repository, new HashMap<String, Direction>());
