...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する37
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory37ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory37Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory37Repository 関連者企業履歴37Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory37ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory37Repository partnerPoliOrgHistory37Repository) {
        super(partnerPoliOrgHistory37Repository, new HashMap<String, Direction>());
