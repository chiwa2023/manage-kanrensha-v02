...
/**
 * kanrensha_person_history_38接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_38)
public class KanrenshaPersonHistory38Entity // NOPMD DataClass
