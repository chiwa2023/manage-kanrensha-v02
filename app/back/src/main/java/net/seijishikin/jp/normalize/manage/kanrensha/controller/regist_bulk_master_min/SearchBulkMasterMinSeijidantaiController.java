...
import net.seijishikin.jp.normalize.manage.kanrensha.service.regist_bulk_master_min.SearchBulkMasterMinSeijidantaiService;
...
public class SearchBulkMasterMinSeijidantaiController {
    ...
    public ResponseEntity<SearchWkTblMinSeijidantaiPagingResultDto> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchBulkMasterMinSeijidantaiService.practice(capsuleDto));
