...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する38
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory38ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory38Entity> {
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory38ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory38Repository partnerPoliOrgHistory38Repository) {
        super(partnerPoliOrgHistory38Repository, new HashMap<String, Direction>());
