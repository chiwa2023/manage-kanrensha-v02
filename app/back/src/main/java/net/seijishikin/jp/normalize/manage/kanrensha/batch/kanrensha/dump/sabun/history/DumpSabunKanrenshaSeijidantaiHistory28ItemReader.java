...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する28
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory28ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory28Entity> {
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory28ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory28Repository partnerPoliOrgHistory28Repository) {
        super(partnerPoliOrgHistory28Repository, new HashMap<String, Direction>());
