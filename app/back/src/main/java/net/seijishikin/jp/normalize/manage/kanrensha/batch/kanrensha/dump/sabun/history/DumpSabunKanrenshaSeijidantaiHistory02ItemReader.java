...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する02
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory02ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory02Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory02Repository 関連者企業履歴02Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory02ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory02Repository partnerPoliOrgHistory02Repository) {
        super(partnerPoliOrgHistory02Repository, new HashMap<String, Direction>());
