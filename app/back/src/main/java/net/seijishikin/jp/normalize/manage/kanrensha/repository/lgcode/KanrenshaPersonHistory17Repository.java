...
/**
 * kanrensha_person_history_17接続用Repository
 */
public interface KanrenshaPersonHistory17Repository extends JpaRepository<KanrenshaPersonHistory17Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory17Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_17"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory17Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_17 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory17Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory17Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
