 ...
 */
@Component
public class DumpSabunKanrenshaPersonHistory42ItemReader extends RepositoryItemReader<KanrenshaPersonHistory42Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory42ItemReader(
            final @Autowired KanrenshaPersonHistory42Repository partnerPersonHistory42Repository) {
        super(partnerPersonHistory42Repository, new HashMap<String, Direction>());
