...
/**
 * kanrensha_person_history_35接続用Repository
 */
public interface KanrenshaPersonHistory35Repository extends JpaRepository<KanrenshaPersonHistory35Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory35Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_35"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory35Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_35 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory35Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory35Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
