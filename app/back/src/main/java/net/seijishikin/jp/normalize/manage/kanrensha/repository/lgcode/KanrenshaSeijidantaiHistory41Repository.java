...
/**
 * kanrensha_seijidantai_history_41接続用Repository
 */
public interface KanrenshaSeijidantaiHistory41Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory41Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory41Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_41"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory41Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_41 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory41Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory41Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
