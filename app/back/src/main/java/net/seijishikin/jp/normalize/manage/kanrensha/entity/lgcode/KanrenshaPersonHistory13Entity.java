...
/**
 * kanrensha_person_history_13接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_13)
public class KanrenshaPersonHistory13Entity // NOPMD DataClass
