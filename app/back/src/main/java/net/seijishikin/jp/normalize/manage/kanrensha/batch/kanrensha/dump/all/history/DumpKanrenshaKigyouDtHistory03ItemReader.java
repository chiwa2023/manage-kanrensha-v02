 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory03ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory03Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory03Repository 関連者企業履歴03Repository
     */
    public DumpKanrenshaKigyouDtHistory03ItemReader(
            final @Autowired KanrenshaKigyouDtHistory03Repository partnerCorpHistory03Repository) {
        super(partnerCorpHistory03Repository, new HashMap<String, Direction>());
