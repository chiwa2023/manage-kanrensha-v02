...
public interface KanrenshaKigyouDtHistory27Repository extends JpaRepository<KanrenshaKigyouDtHistory27Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory27Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory27Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory27Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
