...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する34
 */
@Component
public class DumpSabunKanrenshaPersonHistory34ItemReader extends RepositoryItemReader<KanrenshaPersonHistory34Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory34ItemReader(
            final @Autowired KanrenshaPersonHistory34Repository partnerPersonHistory34Repository) {
        super(partnerPersonHistory34Repository, new HashMap<String, Direction>());
