...
/**
 * kanrensha_seijidantai_history_12接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_12)
public class KanrenshaSeijidantaiHistory12Entity // NOPMD DataClass
