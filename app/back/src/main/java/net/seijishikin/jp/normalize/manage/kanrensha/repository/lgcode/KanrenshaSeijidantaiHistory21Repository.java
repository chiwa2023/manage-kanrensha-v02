...
/**
 * kanrensha_seijidantai_history_21接続用Repository
 */
public interface KanrenshaSeijidantaiHistory21Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory21Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory21Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_21"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory21Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_21 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory21Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory21Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
