...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する25
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory25ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory25Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory25Repository 関連者企業履歴25Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory25ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory25Repository partnerPoliOrgHistory25Repository) {
        super(partnerPoliOrgHistory25Repository, new HashMap<String, Direction>());
