...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する27
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory27ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory27Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory27Repository 関連者企業履歴27Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory27ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory27Repository partnerPoliOrgHistory27Repository) {
        super(partnerPoliOrgHistory27Repository, new HashMap<String, Direction>());
