...
/**
 * kanrensha_person_history_28接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_28)
public class KanrenshaPersonHistory28Entity // NOPMD DataClass
