...
/**
 * kanrensha_seijidantai_history_36接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_36)
public class KanrenshaSeijidantaiHistory36Entity // NOPMD DataClass
