...
/**
 * kanrensha_seijidantai_history_20接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_20)
public class KanrenshaSeijidantaiHistory20Entity // NOPMD DataClass
