...
/**
 * kanrensha_person_history_39接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_39)
public class KanrenshaPersonHistory39Entity // NOPMD DataClass
