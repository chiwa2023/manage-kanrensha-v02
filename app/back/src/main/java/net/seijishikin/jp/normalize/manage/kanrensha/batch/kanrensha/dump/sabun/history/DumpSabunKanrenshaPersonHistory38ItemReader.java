 ...
 */
@Component
public class DumpSabunKanrenshaPersonHistory38ItemReader extends RepositoryItemReader<KanrenshaPersonHistory38Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory38ItemReader(
            final @Autowired KanrenshaPersonHistory38Repository partnerPersonHistory38Repository) {
        super(partnerPersonHistory38Repository, new HashMap<String, Direction>());
