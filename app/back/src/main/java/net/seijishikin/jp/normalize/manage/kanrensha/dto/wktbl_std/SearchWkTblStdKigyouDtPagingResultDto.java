...
/**
 * 企業／団体一括登録マスタ標準ワークテーブル検索ページングDto
 */
public class SearchWkTblStdKigyouDtPagingResultDto // NOPMD DataClass
    ...
    /** 企業／団体登録候補リスト */
    private List<WkTblKanrenshaKigyouDtMasterEntity> listWktblKigyouDt = new ArrayList<>();
     ...
     * @return 企業／団体登録候補リスト
     */
    public List<WkTblKanrenshaKigyouDtMasterEntity> getListWktblKigyouDt() {
     ...
     */
    public void setListWktblKigyouDt(final List<WkTblKanrenshaKigyouDtMasterEntity> listWktblKigyouDt) {
