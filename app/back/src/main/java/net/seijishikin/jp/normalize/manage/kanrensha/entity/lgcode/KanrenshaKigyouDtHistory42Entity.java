...
/**
 * kanrensha_kigyou_dt_history_42接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_42)
public class KanrenshaKigyouDtHistory42Entity // NOPMD DataClass
