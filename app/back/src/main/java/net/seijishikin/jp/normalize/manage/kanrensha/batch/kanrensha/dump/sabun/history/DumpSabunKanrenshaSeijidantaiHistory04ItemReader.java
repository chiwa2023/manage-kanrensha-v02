...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する04
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory04ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory04Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory04Repository 関連者企業履歴04Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory04ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory04Repository partnerPoliOrgHistory04Repository) {
        super(partnerPoliOrgHistory04Repository, new HashMap<String, Direction>());
