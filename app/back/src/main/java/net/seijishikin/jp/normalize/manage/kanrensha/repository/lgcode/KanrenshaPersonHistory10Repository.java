...
/**
 * kanrensha_person_history_10接続用Repository
 */
public interface KanrenshaPersonHistory10Repository extends JpaRepository<KanrenshaPersonHistory10Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory10Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_10"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory10Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_10 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory10Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory10Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
