...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する09
 */
@Component
public class DumpSabunKanrenshaPersonHistory09ItemReader extends RepositoryItemReader<KanrenshaPersonHistory09Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory09ItemReader(
            final @Autowired KanrenshaPersonHistory09Repository partnerPersonHistory09Repository) {
        super(partnerPersonHistory09Repository, new HashMap<String, Direction>());
