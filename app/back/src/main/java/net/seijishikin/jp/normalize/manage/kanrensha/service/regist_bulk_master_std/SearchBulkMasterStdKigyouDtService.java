 ...
 */
@Service
public class SearchBulkMasterStdKigyouDtService {
     ...
     * @return 検索結果
     */
    public SearchWkTblStdKigyouDtPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblKanrenshaKigyouDtMasterRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        SearchWkTblStdKigyouDtPagingResultDto resultDto = new SearchWkTblStdKigyouDtPagingResultDto();
        resultDto.setAllCount(allCount);
        resultDto.setLimit(limit);
        resultDto.setPageNumber(pageNumber);
        resultDto.setListWktblKigyouDt(wkTblKanrenshaKigyouDtMasterRepository
