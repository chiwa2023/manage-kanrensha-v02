...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する09
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory09ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory09Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory09Repository 関連者企業履歴09Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory09ItemReader(
            final @Autowired KanrenshaKigyouDtHistory09Repository kanrenshaKigyouDtHistory09Repository) {
        super(kanrenshaKigyouDtHistory09Repository, new HashMap<String, Direction>());
