...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する26
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory26ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory26Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory26Repository 関連者企業履歴26Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory26ItemReader(
            final @Autowired KanrenshaKigyouDtHistory26Repository kanrenshaKigyouDtHistory26Repository) {
        super(kanrenshaKigyouDtHistory26Repository, new HashMap<String, Direction>());
