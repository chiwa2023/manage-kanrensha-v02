...
/**
 * kanrensha_kigyou_dt_history_43接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_43)
public class KanrenshaKigyouDtHistory43Entity // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param kanrenshaKigyouDtHistoryId テーブルId
     */
     ...
     * 企業団体関連者コードを設定する
     *
     * @param kigyouDtKanrenshaCode 企業団体関連者コード
     */
