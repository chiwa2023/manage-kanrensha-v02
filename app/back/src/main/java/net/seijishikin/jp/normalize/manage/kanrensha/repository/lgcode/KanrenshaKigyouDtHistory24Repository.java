...
/**
 * kanrensha_kigyou_dt_history_24接続用Repository
 */
public interface KanrenshaKigyouDtHistory24Repository extends JpaRepository<KanrenshaKigyouDtHistory24Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory24Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_24"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory24Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_24 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory24Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
