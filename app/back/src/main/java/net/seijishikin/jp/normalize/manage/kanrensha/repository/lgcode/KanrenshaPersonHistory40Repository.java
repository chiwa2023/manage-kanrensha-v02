...
public interface KanrenshaPersonHistory40Repository extends JpaRepository<KanrenshaPersonHistory40Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory40Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_40 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory40Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory40Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
