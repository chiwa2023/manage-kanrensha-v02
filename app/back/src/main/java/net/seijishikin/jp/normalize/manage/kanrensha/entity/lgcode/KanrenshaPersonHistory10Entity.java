...
/**
 * kanrensha_person_history_10接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_10)
public class KanrenshaPersonHistory10Entity // NOPMD DataClass
