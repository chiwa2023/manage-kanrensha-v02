...
/**
 * kanrensha_kigyou_dt_history_34接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_34)
public class KanrenshaKigyouDtHistory34Entity // NOPMD DataClass
