...
/**
 * kanrensha_person_history_17接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_17)
public class KanrenshaPersonHistory17Entity // NOPMD DataClass
