...
/**
 * kanrensha_person_history_04接続用Repository
 */
public interface KanrenshaPersonHistory04Repository extends JpaRepository<KanrenshaPersonHistory04Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory04Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_04"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory04Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_04 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory04Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory04Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
