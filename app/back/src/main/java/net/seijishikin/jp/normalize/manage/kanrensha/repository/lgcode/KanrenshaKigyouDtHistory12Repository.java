...
public interface KanrenshaKigyouDtHistory12Repository extends JpaRepository<KanrenshaKigyouDtHistory12Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory12Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_12 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory12Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
