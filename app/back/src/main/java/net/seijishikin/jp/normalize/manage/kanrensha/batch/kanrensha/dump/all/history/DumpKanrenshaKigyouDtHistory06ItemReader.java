 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory06ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory06Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory06Repository 関連者企業履歴06Repository
     */
    public DumpKanrenshaKigyouDtHistory06ItemReader(
            final @Autowired KanrenshaKigyouDtHistory06Repository partnerCorpHistory06Repository) {
        super(partnerCorpHistory06Repository, new HashMap<String, Direction>());
