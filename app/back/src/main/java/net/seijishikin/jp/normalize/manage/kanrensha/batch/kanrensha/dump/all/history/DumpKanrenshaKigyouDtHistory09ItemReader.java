 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory09ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory09Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory09Repository 関連者企業履歴09Repository
     */
    public DumpKanrenshaKigyouDtHistory09ItemReader(
            final @Autowired KanrenshaKigyouDtHistory09Repository partnerCorpHistory09Repository) {
        super(partnerCorpHistory09Repository, new HashMap<String, Direction>());
