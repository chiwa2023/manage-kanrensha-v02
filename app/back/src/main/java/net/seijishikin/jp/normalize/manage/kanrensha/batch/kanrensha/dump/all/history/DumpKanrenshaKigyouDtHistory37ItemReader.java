 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory37ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory37Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory37Repository 関連者企業履歴37Repository
     */
    public DumpKanrenshaKigyouDtHistory37ItemReader(
            final @Autowired KanrenshaKigyouDtHistory37Repository partnerCorpHistory37Repository) {
        super(partnerCorpHistory37Repository, new HashMap<String, Direction>());
