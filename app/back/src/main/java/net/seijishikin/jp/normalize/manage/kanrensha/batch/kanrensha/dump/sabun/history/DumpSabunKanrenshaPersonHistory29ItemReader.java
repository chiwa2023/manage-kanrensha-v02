...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する29
 */
@Component
public class DumpSabunKanrenshaPersonHistory29ItemReader extends RepositoryItemReader<KanrenshaPersonHistory29Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory29Repository 関連者企業履歴29Repository
     */
    public DumpSabunKanrenshaPersonHistory29ItemReader(
            final @Autowired KanrenshaPersonHistory29Repository partnerPersonHistory29Repository) {
        super(partnerPersonHistory29Repository, new HashMap<String, Direction>());
