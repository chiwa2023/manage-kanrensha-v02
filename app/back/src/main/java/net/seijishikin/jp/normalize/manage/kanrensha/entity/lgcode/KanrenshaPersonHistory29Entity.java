...
/**
 * kanrensha_person_history_29接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_29)
public class KanrenshaPersonHistory29Entity // NOPMD DataClass
