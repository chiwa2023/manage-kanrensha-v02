...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.person.history.InsertKanrenshaPersonHistoryBatchConfiguration;
...
public class ExecuteBatchHistoryPersonService {

    /** 起動をするJob */
    @Qualifier(InsertKanrenshaPersonHistoryBatchConfiguration.JOB_NAME)
    @Autowired
    private Job insertKanrenshaPersonHistory;
    ...
    public void practice(final Integer year, final LeastUserDto userDto, final TaskPlanWithUseFileDto planFileDto) {
        ...
        try {
            jobLauncher.run(insertKanrenshaPersonHistory, jobParameters);
