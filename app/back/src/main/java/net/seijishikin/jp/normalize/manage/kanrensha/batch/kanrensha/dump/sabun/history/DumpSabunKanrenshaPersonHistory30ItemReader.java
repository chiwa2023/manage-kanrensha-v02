...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する30
 */
@Component
public class DumpSabunKanrenshaPersonHistory30ItemReader extends RepositoryItemReader<KanrenshaPersonHistory30Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory30Repository 関連者企業履歴30Repository
     */
    public DumpSabunKanrenshaPersonHistory30ItemReader(
            final @Autowired KanrenshaPersonHistory30Repository partnerPersonHistory30Repository) {
        super(partnerPersonHistory30Repository, new HashMap<String, Direction>());
