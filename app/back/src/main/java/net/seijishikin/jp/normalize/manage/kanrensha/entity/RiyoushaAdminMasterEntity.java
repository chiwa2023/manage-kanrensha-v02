...
/**
 * riyousha_admin_master接続用Entity
 */
@Entity
@Table(name = "riyousha_admin_master")
public class RiyoushaAdminMasterEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "riyousha_admin_master_id")
    ...
    /** 利用者運営者コード */
    @Column(name = "riyousha_admin_master_code")
