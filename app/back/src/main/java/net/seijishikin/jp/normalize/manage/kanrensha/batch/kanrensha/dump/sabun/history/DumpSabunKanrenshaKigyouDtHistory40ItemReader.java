...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する40
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory40ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory40Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory40Repository 関連者企業履歴40Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory40ItemReader(
            final @Autowired KanrenshaKigyouDtHistory40Repository kanrenshaKigyouDtHistory40Repository) {
        super(kanrenshaKigyouDtHistory40Repository, new HashMap<String, Direction>());
