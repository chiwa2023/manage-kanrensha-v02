...
/**
 * 関連者個人最小登録Csv読み取りItemReader
 */
@Component
public class KanrenshaPersonAddMiniCsvItemReader extends FlatFileItemReader<KanrenshaPersonAddMiniDto> {
     ...
     */
    public KanrenshaPersonAddMiniCsvItemReader(final @Autowired KanrenshaPersonAddMiniLineMapper lineMapper) {
        super();
