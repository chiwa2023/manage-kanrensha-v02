...
/**
 * kanrensha_person_history_31接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_31)
public class KanrenshaPersonHistory31Entity // NOPMD DataClass
