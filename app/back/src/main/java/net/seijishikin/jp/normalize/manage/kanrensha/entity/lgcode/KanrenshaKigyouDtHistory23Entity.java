...
/**
 * kanrensha_kigyou_dt_history_23接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_23)
public class KanrenshaKigyouDtHistory23Entity // NOPMD DataClass
