...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する32
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory32ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory32Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory32Repository 関連者企業履歴32Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory32ItemReader(
            final @Autowired KanrenshaKigyouDtHistory32Repository kanrenshaKigyouDtHistory32Repository) {
        super(kanrenshaKigyouDtHistory32Repository, new HashMap<String, Direction>());
