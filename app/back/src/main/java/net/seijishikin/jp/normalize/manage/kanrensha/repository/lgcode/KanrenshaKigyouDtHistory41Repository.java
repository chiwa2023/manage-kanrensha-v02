...
/**
 * kanrensha_kigyou_dt_history_41接続用Repository
 */
public interface KanrenshaKigyouDtHistory41Repository extends JpaRepository<KanrenshaKigyouDtHistory41Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory41Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_41"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory41Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_41 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory41Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory41Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
