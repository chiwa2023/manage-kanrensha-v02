 ...
 */
@Component
public class DumpKanrenshaPersonHistory18ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory18Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory18ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory18Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory18Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
