...
/**
 * wk_tbl_kanrensha_combine_org_result接続用Entity
 */
@Entity
@Table(name = "wk_tbl_kanrensha_combine_org_result")
public class WkTblKanrenshaCombineOrgResultEntity // NOPMD DataClass
    ...
    @Column(name = "wk_tbl_kanrensha_combine_org_result_id")
    private Integer wkTblKanrenshaCombineOrgResultId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkTblKanrenshaCombineOrgResultId() {
        return wkTblKanrenshaCombineOrgResultId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkTblKanrenshaCombineOrgResultId テーブルId
     */
    public void setWkTblKanrenshaCombineOrgResultId(final Integer wkTblKanrenshaCombineOrgResultId) {
        this.wkTblKanrenshaCombineOrgResultId = wkTblKanrenshaCombineOrgResultId;
    }
     ...
     * ワークテーブルマスタIdを設定する
     *
     * @param wkTblKanrenshaCombineOrgId ワークテーブルマスタId
     */
