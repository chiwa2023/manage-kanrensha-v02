...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する33
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory33ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory33Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory33Repository 関連者企業履歴33Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory33ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory33Repository partnerPoliOrgHistory33Repository) {
        super(partnerPoliOrgHistory33Repository, new HashMap<String, Direction>());
