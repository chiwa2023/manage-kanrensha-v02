...
/**
 * kanrensha_person_history_46接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_46)
public class KanrenshaPersonHistory46Entity // NOPMD DataClass
