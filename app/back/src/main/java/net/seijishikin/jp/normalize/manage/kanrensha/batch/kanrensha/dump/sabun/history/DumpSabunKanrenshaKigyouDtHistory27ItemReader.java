...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する27
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory27ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory27Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory27Repository 関連者企業履歴27Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory27ItemReader(
            final @Autowired KanrenshaKigyouDtHistory27Repository kanrenshaKigyouDtHistory27Repository) {
        super(kanrenshaKigyouDtHistory27Repository, new HashMap<String, Direction>());
