 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory16ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory16Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory16Repository 関連者企業履歴16Repository
     */
    public DumpKanrenshaKigyouDtHistory16ItemReader(
            final @Autowired KanrenshaKigyouDtHistory16Repository partnerCorpHistory16Repository) {
        super(partnerCorpHistory16Repository, new HashMap<String, Direction>());
