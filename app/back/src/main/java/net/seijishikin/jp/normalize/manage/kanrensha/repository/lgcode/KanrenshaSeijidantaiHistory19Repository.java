...
/**
 * kanrensha_seijidantai_history_19接続用Repository
 */
public interface KanrenshaSeijidantaiHistory19Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory19Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory19Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_19"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory19Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_19 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory19Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory19Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
