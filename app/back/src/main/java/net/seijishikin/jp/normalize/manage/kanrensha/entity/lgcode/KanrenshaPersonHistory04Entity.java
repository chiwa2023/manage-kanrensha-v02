...
/**
 * kanrensha_person_history_04接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_04)
public class KanrenshaPersonHistory04Entity // NOPMD DataClass
