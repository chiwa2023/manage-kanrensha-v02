 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory27ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory27Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory27Repository 関連者企業履歴27Repository
     */
    public DumpKanrenshaKigyouDtHistory27ItemReader(
            final @Autowired KanrenshaKigyouDtHistory27Repository partnerCorpHistory27Repository) {
        super(partnerCorpHistory27Repository, new HashMap<String, Direction>());
