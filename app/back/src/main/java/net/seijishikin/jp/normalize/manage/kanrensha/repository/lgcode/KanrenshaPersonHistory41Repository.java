...
public interface KanrenshaPersonHistory41Repository extends JpaRepository<KanrenshaPersonHistory41Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory41Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_41 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory41Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory41Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
