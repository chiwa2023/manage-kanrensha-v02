...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する39
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory39ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory39Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory39Repository 関連者企業履歴39Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory39ItemReader(
            final @Autowired KanrenshaKigyouDtHistory39Repository kanrenshaKigyouDtHistory39Repository) {
        super(kanrenshaKigyouDtHistory39Repository, new HashMap<String, Direction>());
