...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する25
 */
@Component
public class DumpSabunKanrenshaPersonHistory25ItemReader extends RepositoryItemReader<KanrenshaPersonHistory25Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory25Repository 関連者企業履歴25Repository
     */
    public DumpSabunKanrenshaPersonHistory25ItemReader(
            final @Autowired KanrenshaPersonHistory25Repository partnerPersonHistory25Repository) {
        super(partnerPersonHistory25Repository, new HashMap<String, Direction>());
