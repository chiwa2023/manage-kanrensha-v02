...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する15
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory15ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory15Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory15Repository 関連者企業履歴15Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory15ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory15Repository partnerPoliOrgHistory15Repository) {
        super(partnerPoliOrgHistory15Repository, new HashMap<String, Direction>());
