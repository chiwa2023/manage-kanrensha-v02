...
public class ForceSabunDumpStdMasterKigyouDtService {
    ...
    public void practice(final Integer year, final InsertTaskPlanResultDto planDto, final LocalDate startDate,
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, SabunMasterStd.SABUN_STD_KIGYOU).toString())
        ...
        try {
            jobOperator.run(dumpSabunMasterKigyouDtoration, jobParameters);
