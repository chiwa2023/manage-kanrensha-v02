...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する17
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory17ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory17Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory17Repository 関連者企業履歴17Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory17ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory17Repository partnerPoliOrgHistory17Repository) {
        super(partnerPoliOrgHistory17Repository, new HashMap<String, Direction>());
