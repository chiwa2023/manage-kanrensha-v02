...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する11
 */
@Component
public class DumpSabunKanrenshaPersonHistory11ItemReader extends RepositoryItemReader<KanrenshaPersonHistory11Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory11Repository 関連者企業履歴11Repository
     */
    public DumpSabunKanrenshaPersonHistory11ItemReader(
            final @Autowired KanrenshaPersonHistory11Repository partnerPersonHistory11Repository) {
        super(partnerPersonHistory11Repository, new HashMap<String, Direction>());
