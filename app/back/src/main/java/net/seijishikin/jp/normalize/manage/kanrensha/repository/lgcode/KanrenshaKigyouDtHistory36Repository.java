...
/**
 * kanrensha_kigyou_dt_history_36接続用Repository
 */
public interface KanrenshaKigyouDtHistory36Repository extends JpaRepository<KanrenshaKigyouDtHistory36Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory36Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_36"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory36Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_36 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory36Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory36Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
