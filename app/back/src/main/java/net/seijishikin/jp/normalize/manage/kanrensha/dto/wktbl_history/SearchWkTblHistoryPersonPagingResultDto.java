...
/**
 * 個人一括登録履歴ワークテーブル検索ページングDto
 */
public class SearchWkTblHistoryPersonPagingResultDto // NOPMD DataClass
    ...
    /** 個人登録候補リスト */
    private List<WkTblKanrenshaPersonHistoryEntity> listWktblPerson = new ArrayList<>();
     ...
     * @return 個人登録候補リスト
     */
    public List<WkTblKanrenshaPersonHistoryEntity> getListWktblPerson() {
     ...
     */
    public void setListWktblPerson(final List<WkTblKanrenshaPersonHistoryEntity> listWktblPerson) {
