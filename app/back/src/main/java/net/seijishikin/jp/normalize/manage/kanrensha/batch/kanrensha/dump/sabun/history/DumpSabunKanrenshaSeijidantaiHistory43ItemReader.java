...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する43
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory43ItemReader
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory43ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory43Repository partnerPoliOrgHistory43Repository) {
        super(partnerPoliOrgHistory43Repository, new HashMap<String, Direction>());
