...
/**
 * kanrensha_seijidantai_history_35接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_35)
public class KanrenshaSeijidantaiHistory35Entity // NOPMD DataClass
