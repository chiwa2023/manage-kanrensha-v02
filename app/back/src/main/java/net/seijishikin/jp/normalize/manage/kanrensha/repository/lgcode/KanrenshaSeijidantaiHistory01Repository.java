...
/**
 * kanrensha_seijidantai_history_01接続用Repository
 */
public interface KanrenshaSeijidantaiHistory01Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory01Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory01Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_01"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory01Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_01 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory01Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory01Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
