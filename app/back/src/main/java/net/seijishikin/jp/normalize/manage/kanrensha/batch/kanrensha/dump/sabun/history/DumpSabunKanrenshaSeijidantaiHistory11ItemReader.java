...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する11
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory11ItemReader
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory11ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory11Repository partnerPoliOrgHistory11Repository) {
        super(partnerPoliOrgHistory11Repository, new HashMap<String, Direction>());
