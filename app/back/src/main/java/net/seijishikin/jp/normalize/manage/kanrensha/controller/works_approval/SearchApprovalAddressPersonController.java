...
import net.seijishikin.jp.normalize.manage.kanrensha.service.works_approval.SearchApprovalAddressPersonService;

/**
 * 未承認変更データ個人検索Controller
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/works-approval")
public class SearchApprovalAddressPersonController {
    ...
    public ResponseEntity<SearchWorksApprovalResultDto> practice(
        ...
        try {
            ...
            resultDto.setResultDtoAddress(searchApprovalAddressPersonService.practice(capsuleDto));
