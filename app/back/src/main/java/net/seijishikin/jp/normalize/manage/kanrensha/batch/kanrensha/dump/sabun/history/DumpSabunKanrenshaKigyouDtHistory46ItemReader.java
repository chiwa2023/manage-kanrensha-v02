...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する46
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory46ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory46Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory46Repository 関連者企業履歴46Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory46ItemReader(
            final @Autowired KanrenshaKigyouDtHistory46Repository kanrenshaKigyouDtHistory46Repository) {
        super(kanrenshaKigyouDtHistory46Repository, new HashMap<String, Direction>());
