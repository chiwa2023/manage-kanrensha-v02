...
/**
 * kanrensha_kigyou_dt_history_15接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_15)
public class KanrenshaKigyouDtHistory15Entity // NOPMD DataClass
