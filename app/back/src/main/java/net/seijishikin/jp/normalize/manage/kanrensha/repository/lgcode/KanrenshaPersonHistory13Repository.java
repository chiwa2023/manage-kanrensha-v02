...
/**
 * kanrensha_person_history_13接続用Repository
 */
public interface KanrenshaPersonHistory13Repository extends JpaRepository<KanrenshaPersonHistory13Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory13Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_13"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory13Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_13 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory13Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory13Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
