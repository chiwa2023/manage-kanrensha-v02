...
public class SaveRiyoushaManagerEntityService {
    ...
    private Integer practiceInsert(final SaveRiyoushaManagerCapsuleDto capsuleDto) {
        ...
        if (capsuleDto.getRiyoushaManagerDto().getIsCombineUser()) {
            insertCombineUserRiyoushaLogic.practcie(UserRoleConstants.MANAGER,
                    savedMasterEntity.getRiyoushaManagerMasterCode(), capsuleDto.getUserDto());
        }
