...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する02
 */
@Component
public class DumpSabunKanrenshaPersonHistory02ItemReader extends RepositoryItemReader<KanrenshaPersonHistory02Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory02Repository 関連者企業履歴02Repository
     */
    public DumpSabunKanrenshaPersonHistory02ItemReader(
            final @Autowired KanrenshaPersonHistory02Repository partnerPersonHistory02Repository) {
        super(partnerPersonHistory02Repository, new HashMap<String, Direction>());
