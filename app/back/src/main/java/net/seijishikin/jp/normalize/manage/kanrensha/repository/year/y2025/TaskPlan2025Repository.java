 ...
 */
public interface TaskPlan2025Repository
        extends JpaRepository<TaskPlan2025Entity, Integer>, PagingAndSortingRepository<TaskPlan2025Entity, Integer> {
     ...
     * @return 検索結果
     */
    List<TaskPlan2025Entity> findByTaskPlanCode(Integer taskCode);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM task_plan_2025 WHERE is_latest= 1 AND is_finished = 0 AND task_user_code = 0 "
