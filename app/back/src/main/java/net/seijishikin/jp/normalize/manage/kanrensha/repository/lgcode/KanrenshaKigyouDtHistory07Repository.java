...
/**
 * kanrensha_kigyou_dt_history_07接続用Repository
 */
public interface KanrenshaKigyouDtHistory07Repository extends JpaRepository<KanrenshaKigyouDtHistory07Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory07Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_07"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory07Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_07 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory07Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory07Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
