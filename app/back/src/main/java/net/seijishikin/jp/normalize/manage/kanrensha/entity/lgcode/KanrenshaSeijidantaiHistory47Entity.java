...
/**
 * kanrensha_seijidantai_history_47接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_47)
public class KanrenshaSeijidantaiHistory47Entity // NOPMD DataClass
