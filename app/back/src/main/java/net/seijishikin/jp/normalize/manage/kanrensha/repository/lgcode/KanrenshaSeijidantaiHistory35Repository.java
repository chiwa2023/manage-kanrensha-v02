...
/**
 * kanrensha_seijidantai_history_35接続用Repository
 */
public interface KanrenshaSeijidantaiHistory35Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory35Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory35Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_35"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory35Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_35 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory35Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory35Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
