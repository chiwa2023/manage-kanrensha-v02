...
public interface KanrenshaPersonHistory39Repository extends JpaRepository<KanrenshaPersonHistory39Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory39Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_39 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory39Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory39Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
