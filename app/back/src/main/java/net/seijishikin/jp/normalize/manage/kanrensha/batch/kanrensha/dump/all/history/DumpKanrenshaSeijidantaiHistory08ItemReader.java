 ...
 */
@Component
public class DumpKanrenshaSeijidantaiHistory08ItemReader
     ...
     */
    public DumpKanrenshaSeijidantaiHistory08ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory08Repository partnerPoliOrgHistory08Repository) {
        super(partnerPoliOrgHistory08Repository, new HashMap<String, Direction>());
