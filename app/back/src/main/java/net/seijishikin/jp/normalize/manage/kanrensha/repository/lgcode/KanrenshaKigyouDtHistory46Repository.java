...
/**
 * kanrensha_kigyou_dt_history_46接続用Repository
 */
public interface KanrenshaKigyouDtHistory46Repository extends JpaRepository<KanrenshaKigyouDtHistory46Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory46Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_46"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory46Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_46 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory46Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory46Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
