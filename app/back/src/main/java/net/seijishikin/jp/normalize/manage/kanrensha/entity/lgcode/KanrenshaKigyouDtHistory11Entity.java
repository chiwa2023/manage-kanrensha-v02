...
/**
 * kanrensha_kigyou_dt_history_11接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_11)
public class KanrenshaKigyouDtHistory11Entity // NOPMD DataClass
