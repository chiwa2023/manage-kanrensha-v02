...
/**
 * kanrensha_kigyou_dt_history_19接続用Repository
 */
public interface KanrenshaKigyouDtHistory19Repository extends JpaRepository<KanrenshaKigyouDtHistory19Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory19Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_19"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory19Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_19 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory19Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
