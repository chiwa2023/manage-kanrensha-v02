...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新マスタ差分データItemReader
 */
@Component
public class DumpSabunMasterKigyouDtItemReader extends RepositoryItemReader<KanrenshaKigyouDtMasterEntity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtMasterRepository 関連者企業マスタRepository
     */
    public DumpSabunMasterKigyouDtItemReader(
            final @Autowired KanrenshaKigyouDtMasterRepository kanrenshaKigyouDtMasterRepository) {
        super(kanrenshaKigyouDtMasterRepository, new HashMap<String, Direction>());
