...
public interface KanrenshaKigyouDtHistory15Repository extends JpaRepository<KanrenshaKigyouDtHistory15Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory15Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory15Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory15Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
