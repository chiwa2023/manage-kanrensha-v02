 ...
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory31ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory31Entity> {
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory31ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory31Repository partnerPoliOrgHistory31Repository) {
        super(partnerPoliOrgHistory31Repository, new HashMap<String, Direction>());
