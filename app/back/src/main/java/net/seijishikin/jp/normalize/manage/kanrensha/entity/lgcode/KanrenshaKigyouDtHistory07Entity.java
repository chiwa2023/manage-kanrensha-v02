...
/**
 * kanrensha_kigyou_dt_history_07接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_07)
public class KanrenshaKigyouDtHistory07Entity // NOPMD DataClass
