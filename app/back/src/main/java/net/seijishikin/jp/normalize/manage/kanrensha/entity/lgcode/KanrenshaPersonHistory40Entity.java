...
/**
 * kanrensha_person_history_40接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_40)
public class KanrenshaPersonHistory40Entity // NOPMD DataClass
