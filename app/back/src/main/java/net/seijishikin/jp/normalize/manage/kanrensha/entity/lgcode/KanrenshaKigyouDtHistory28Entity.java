...
/**
 * kanrensha_kigyou_dt_history_28接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_28)
public class KanrenshaKigyouDtHistory28Entity // NOPMD DataClass
