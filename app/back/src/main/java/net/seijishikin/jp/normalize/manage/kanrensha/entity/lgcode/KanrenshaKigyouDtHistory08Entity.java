...
/**
 * kanrensha_kigyou_dt_history_08接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_08)
public class KanrenshaKigyouDtHistory08Entity // NOPMD DataClass
