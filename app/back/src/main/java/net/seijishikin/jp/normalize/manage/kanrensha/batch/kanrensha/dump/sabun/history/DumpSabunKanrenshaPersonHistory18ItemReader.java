...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する18
 */
@Component
public class DumpSabunKanrenshaPersonHistory18ItemReader extends RepositoryItemReader<KanrenshaPersonHistory18Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory18Repository 関連者企業履歴18Repository
     */
    public DumpSabunKanrenshaPersonHistory18ItemReader(
            final @Autowired KanrenshaPersonHistory18Repository partnerPersonHistory18Repository) {
        super(partnerPersonHistory18Repository, new HashMap<String, Direction>());
