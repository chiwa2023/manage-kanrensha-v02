...
/**
 * kanrensha_kigyou_dt_history_06接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_06)
public class KanrenshaKigyouDtHistory06Entity // NOPMD DataClass
