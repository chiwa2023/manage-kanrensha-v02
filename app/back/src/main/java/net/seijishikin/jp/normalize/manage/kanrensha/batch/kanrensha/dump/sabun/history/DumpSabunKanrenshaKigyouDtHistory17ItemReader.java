 ...
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory17ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory17Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory17Repository 関連者企業履歴17Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory17ItemReader(
            final @Autowired KanrenshaKigyouDtHistory17Repository kanrenshaKigyouDtHistory17Repository) {
        super(kanrenshaKigyouDtHistory17Repository, new HashMap<String, Direction>());
