...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する19
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory19ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory19Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory19Repository 関連者企業履歴19Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory19ItemReader(
            final @Autowired KanrenshaKigyouDtHistory19Repository kanrenshaKigyouDtHistory19Repository) {
        super(kanrenshaKigyouDtHistory19Repository, new HashMap<String, Direction>());
