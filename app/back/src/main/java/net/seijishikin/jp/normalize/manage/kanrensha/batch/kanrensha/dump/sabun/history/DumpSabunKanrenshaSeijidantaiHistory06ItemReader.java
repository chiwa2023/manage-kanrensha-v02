...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する06
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory06ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory06Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory06Repository 関連者企業履歴06Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory06ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory06Repository partnerPoliOrgHistory06Repository) {
        super(partnerPoliOrgHistory06Repository, new HashMap<String, Direction>());
