...
/**
 * kanrensha_person_history_19接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_19)
public class KanrenshaPersonHistory19Entity // NOPMD DataClass
