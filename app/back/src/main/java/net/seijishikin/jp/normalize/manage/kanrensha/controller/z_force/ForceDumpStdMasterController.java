...
import net.seijishikin.jp.normalize.manage.kanrensha.service.z_force.AsyncForceDumpStdMasterService;
 ...
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/dump-master-std")
public class ForceDumpStdMasterController {

    /** 非同期処理専用Service */
    @Autowired
    private AsyncForceDumpStdMasterService asyncForceDumpStdMasterService;
