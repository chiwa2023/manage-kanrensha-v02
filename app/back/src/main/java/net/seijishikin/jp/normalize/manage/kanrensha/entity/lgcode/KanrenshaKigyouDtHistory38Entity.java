...
/**
 * kanrensha_kigyou_dt_history_38接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_38)
public class KanrenshaKigyouDtHistory38Entity // NOPMD DataClass
