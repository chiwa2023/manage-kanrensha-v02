...
/**
 * kanrensha_seijidantai_history_02接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_02)
public class KanrenshaSeijidantaiHistory02Entity // NOPMD DataClass
