 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory30ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory30Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory30Repository 関連者企業履歴30Repository
     */
    public DumpKanrenshaKigyouDtHistory30ItemReader(
            final @Autowired KanrenshaKigyouDtHistory30Repository partnerCorpHistory30Repository) {
        super(partnerCorpHistory30Repository, new HashMap<String, Direction>());
