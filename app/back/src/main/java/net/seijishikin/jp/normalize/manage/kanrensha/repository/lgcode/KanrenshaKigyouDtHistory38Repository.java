...
/**
 * kanrensha_kigyou_dt_history_38接続用Repository
 */
public interface KanrenshaKigyouDtHistory38Repository extends JpaRepository<KanrenshaKigyouDtHistory38Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory38Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_38"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory38Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_38 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory38Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory38Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
