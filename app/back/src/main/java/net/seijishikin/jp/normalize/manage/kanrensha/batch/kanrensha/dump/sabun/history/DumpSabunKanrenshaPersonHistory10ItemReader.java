...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する10
 */
@Component
public class DumpSabunKanrenshaPersonHistory10ItemReader extends RepositoryItemReader<KanrenshaPersonHistory10Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory10Repository 関連者企業履歴10Repository
     */
    public DumpSabunKanrenshaPersonHistory10ItemReader(
            final @Autowired KanrenshaPersonHistory10Repository partnerPersonHistory10Repository) {
        super(partnerPersonHistory10Repository, new HashMap<String, Direction>());
