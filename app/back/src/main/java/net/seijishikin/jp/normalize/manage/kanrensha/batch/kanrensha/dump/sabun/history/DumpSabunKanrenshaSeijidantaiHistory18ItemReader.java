...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する18
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory18ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory18Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory18Repository 関連者企業履歴18Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory18ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory18Repository partnerPoliOrgHistory18Repository) {
        super(partnerPoliOrgHistory18Repository, new HashMap<String, Direction>());
