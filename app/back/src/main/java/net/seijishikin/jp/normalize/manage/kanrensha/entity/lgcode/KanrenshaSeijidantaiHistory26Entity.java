...
/**
 * kanrensha_seijidantai_history_26接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_26)
public class KanrenshaSeijidantaiHistory26Entity // NOPMD DataClass
