...
/**
 * 標準郵便番号書き込みitemWriter
 */
@Component
public class NormalPostalItemWriter extends JpaItemWriter<AddressPostalEntity> {
     ...
     */
    public NormalPostalItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
    ...
    public void write(final Chunk<? extends AddressPostalEntity> items) {
        ...
        // 編集済みデータを保存するだけ
        addressPostalRepository.saveAllAndFlush(items);
    }
