...
/**
 * kanrensha_seijidantai_history_27接続用Repository
 */
public interface KanrenshaSeijidantaiHistory27Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory27Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory27Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_27"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory27Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_27 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory27Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory27Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
