...
import net.seijishikin.jp.normalize.manage.kanrensha.service.regist_bulk_master_std.ExecuteBatchMasterStdKigyouDtService;
...
public class ExecuteBatchMasterStdKigyouDtController {

    /** 非同期処理登録専用Service */
    @Autowired
    private ExecuteBatchMasterStdKigyouDtService executeBatchMasterStdKigyouDtService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            ...
            TaskPlanWithUseFileDto planFileDto = copyTempToUseSavedFileService.practice(dateTimeStart,
                    ...
                    TaskInfoConstants.FILE_KIGYOU_STD, mapParam);
            taskPlanCode = planFileDto.getTaskPlanCode();

            executeBatchMasterStdKigyouDtService.practice(year, capsuleDto.getUserDto(), planFileDto);
