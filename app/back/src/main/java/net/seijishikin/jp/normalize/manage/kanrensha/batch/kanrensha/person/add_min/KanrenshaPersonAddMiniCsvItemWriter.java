 ...
 */
@Component
public class KanrenshaPersonAddMiniCsvItemWriter extends JpaItemWriter<WkTblKanrenshaPersonAddMinEntity> {
     ...
     */
    public KanrenshaPersonAddMiniCsvItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
    ...
    public void write(final Chunk<? extends WkTblKanrenshaPersonAddMinEntity> items) {
        ...
        for (WkTblKanrenshaPersonAddMinEntity entity : items) {
            ...
            entity.setWkTblKanrenshaPersonAddMinCode(code);
        }
