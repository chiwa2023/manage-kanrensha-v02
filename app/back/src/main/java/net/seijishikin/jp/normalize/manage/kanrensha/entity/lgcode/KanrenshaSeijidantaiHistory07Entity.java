...
/**
 * kanrensha_seijidantai_history_07接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_07)
public class KanrenshaSeijidantaiHistory07Entity // NOPMD DataClass
