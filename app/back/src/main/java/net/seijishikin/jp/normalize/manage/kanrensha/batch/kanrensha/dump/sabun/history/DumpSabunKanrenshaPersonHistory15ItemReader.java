...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する15
 */
@Component
public class DumpSabunKanrenshaPersonHistory15ItemReader extends RepositoryItemReader<KanrenshaPersonHistory15Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory15Repository 関連者企業履歴15Repository
     */
    public DumpSabunKanrenshaPersonHistory15ItemReader(
            final @Autowired KanrenshaPersonHistory15Repository partnerPersonHistory15Repository) {
        super(partnerPersonHistory15Repository, new HashMap<String, Direction>());
