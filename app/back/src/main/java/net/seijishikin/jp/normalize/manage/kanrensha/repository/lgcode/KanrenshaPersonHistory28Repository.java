...
/**
 * kanrensha_person_history_28接続用Repository
 */
public interface KanrenshaPersonHistory28Repository extends JpaRepository<KanrenshaPersonHistory28Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory28Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_28"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory28Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_28 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory28Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory28Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
