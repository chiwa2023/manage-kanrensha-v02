...
/**
 * kanrensha_kigyou_dt_history_37接続用Repository
 */
public interface KanrenshaKigyouDtHistory37Repository extends JpaRepository<KanrenshaKigyouDtHistory37Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory37Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_37"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory37Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_37 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory37Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory37Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
