...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する47
 */
@Component
public class DumpSabunKanrenshaPersonHistory47ItemReader extends RepositoryItemReader<KanrenshaPersonHistory47Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory47Repository 関連者企業履歴47Repository
     */
    public DumpSabunKanrenshaPersonHistory47ItemReader(
            final @Autowired KanrenshaPersonHistory47Repository partnerPersonHistory47Repository) {

        super(partnerPersonHistory47Repository, new HashMap<String, Direction>());
