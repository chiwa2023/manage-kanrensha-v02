 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory43ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory43Entity> {
     ...
     */
    public DumpKanrenshaKigyouDtHistory43ItemReader(
            final @Autowired KanrenshaKigyouDtHistory43Repository partnerCorpHistory43Repository) {
        super(partnerCorpHistory43Repository, new HashMap<String, Direction>());
