...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する41
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory41ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory41Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory41Repository 関連者企業履歴41Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory41ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory41Repository partnerPoliOrgHistory41Repository) {

        super(partnerPoliOrgHistory41Repository, new HashMap<String, Direction>());
