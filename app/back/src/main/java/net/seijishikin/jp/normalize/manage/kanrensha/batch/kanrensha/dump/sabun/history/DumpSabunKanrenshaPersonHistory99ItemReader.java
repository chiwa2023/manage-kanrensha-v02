...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する99
 */
@Component
public class DumpSabunKanrenshaPersonHistory99ItemReader extends RepositoryItemReader<KanrenshaPersonHistory99Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory99ItemReader(
            final @Autowired KanrenshaPersonHistory99Repository partnerPersonHistory99Repository) {
        super(partnerPersonHistory99Repository, new HashMap<String, Direction>());
