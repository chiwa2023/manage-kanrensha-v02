...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する40
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory40ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory40Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory40Repository 関連者企業履歴40Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory40ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory40Repository partnerPoliOrgHistory40Repository) {
        super(partnerPoliOrgHistory40Repository, new HashMap<String, Direction>());
