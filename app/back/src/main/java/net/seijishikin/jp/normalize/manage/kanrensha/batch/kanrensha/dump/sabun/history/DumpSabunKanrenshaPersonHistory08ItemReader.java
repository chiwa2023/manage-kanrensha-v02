...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する08
 */
@Component
public class DumpSabunKanrenshaPersonHistory08ItemReader extends RepositoryItemReader<KanrenshaPersonHistory08Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory08Repository 関連者企業履歴08Repository
     */
    public DumpSabunKanrenshaPersonHistory08ItemReader(
            final @Autowired KanrenshaPersonHistory08Repository partnerPersonHistory08Repository) {

        super(partnerPersonHistory08Repository, new HashMap<String, Direction>());
