...
/**
 * kanrensha_kigyou_dt_history_42接続用Repository
 */
public interface KanrenshaKigyouDtHistory42Repository extends JpaRepository<KanrenshaKigyouDtHistory42Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory42Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_42"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory42Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_42 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory42Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory42Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
