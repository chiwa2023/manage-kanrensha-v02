...
/**
 * kanrensha_person_history_47接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_47)
public class KanrenshaPersonHistory47Entity // NOPMD DataClass
