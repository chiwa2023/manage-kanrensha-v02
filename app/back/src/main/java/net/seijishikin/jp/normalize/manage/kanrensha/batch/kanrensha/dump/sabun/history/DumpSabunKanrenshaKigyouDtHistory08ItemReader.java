...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する08
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory08ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory08Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory08Repository 関連者企業履歴08Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory08ItemReader(
            final @Autowired KanrenshaKigyouDtHistory08Repository kanrenshaKigyouDtHistory08Repository) {
        super(kanrenshaKigyouDtHistory08Repository, new HashMap<String, Direction>());
