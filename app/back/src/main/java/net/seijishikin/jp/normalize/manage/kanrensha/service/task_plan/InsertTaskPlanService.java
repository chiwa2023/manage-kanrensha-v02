...
public class InsertTaskPlanService {
    ...
    public InsertTaskPlanResultDto practice(final LeastUserDto userDto, final LocalDateTime createDatetime,
        ...
        Integer savedId;
        try {
            resultDto = switchYearInsertTaskPlanInsertService.practice(userDto, createDatetime, taskInfoEntity,
                    mapParam);
        ...
        if (flgSendAlert) {
            ...
            SendMaileResultDto mailResultDto = this.sendAlert(taskInfoEntity, userPersonEntity.getEmail(), savedId);
    ...
    private SendMaileResultDto sendAlert(final TaskInfoEntity taskInfoEntity, final String mailAddress,
        ...
        try {
            ...
            String body = taskInfoEntity.getMessageTemplate();
            body = body.replaceAll("【paramQuery】", taskInfoEntity.getParamQuery());
            body = body.replaceAll("【transferPass】", taskInfoEntity.getTransferPass());
