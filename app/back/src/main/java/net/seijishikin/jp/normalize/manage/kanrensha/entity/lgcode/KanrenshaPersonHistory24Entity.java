...
/**
 * kanrensha_person_history_24接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_24)
public class KanrenshaPersonHistory24Entity // NOPMD DataClass
