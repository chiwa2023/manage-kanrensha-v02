...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する03
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory03ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory03Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory03Repository 関連者企業履歴03Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory03ItemReader(
            final @Autowired KanrenshaKigyouDtHistory03Repository kanrenshaKigyouDtHistory03Repository) {

        super(kanrenshaKigyouDtHistory03Repository, new HashMap<String, Direction>());
