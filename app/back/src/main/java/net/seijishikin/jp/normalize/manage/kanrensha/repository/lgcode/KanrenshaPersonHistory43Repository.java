...
/**
 * kanrensha_person_history_43接続用Repository
 */
public interface KanrenshaPersonHistory43Repository extends JpaRepository<KanrenshaPersonHistory43Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory43Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_43"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory43Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory43Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory43Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
