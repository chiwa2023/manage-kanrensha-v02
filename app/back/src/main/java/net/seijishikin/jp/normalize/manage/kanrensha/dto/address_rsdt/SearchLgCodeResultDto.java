 ...
 * 地方自治体コード検索結果Dto
 */
public class SearchLgCodeResultDto extends FrameworkMessageAndResultDto // NOPMD DataClass
    ...
    /** 地方自治体コードリスト */
    private List<AddressAllCityEntity> listEntity = new ArrayList<>();
     ...
     * @return 地方自治体コードリスト
     */
    public List<AddressAllCityEntity> getListEntity() {
        return listEntity;
    }
     ...
     * 地方自治体コードリストを設定する
     * 
     * @param listEntity 地方自治体コードリスト
     */
    public void setListEntity(final List<AddressAllCityEntity> listEntity) {
