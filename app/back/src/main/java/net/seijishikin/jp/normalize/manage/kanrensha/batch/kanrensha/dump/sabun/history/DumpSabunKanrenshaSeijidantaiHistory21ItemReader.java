...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する21
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory21ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory21Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory21Repository 関連者企業履歴21Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory21ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory21Repository partnerPoliOrgHistory21Repository) {
        super(partnerPoliOrgHistory21Repository, new HashMap<String, Direction>());
