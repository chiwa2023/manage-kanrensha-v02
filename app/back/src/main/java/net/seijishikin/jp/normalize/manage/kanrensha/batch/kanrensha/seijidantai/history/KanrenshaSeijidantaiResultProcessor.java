 ...
 */
@Component
public class KanrenshaSeijidantaiResultProcessor
        implements ItemProcessor<WkTblKanrenshaSeijidantaiHistoryEntity, WkTblKanrenshaSeijidantaiHistoryResultEntity> {
     ...
     */
    @Override
    public WkTblKanrenshaSeijidantaiHistoryResultEntity process(final WkTblKanrenshaSeijidantaiHistoryEntity item)
            throws Exception {
