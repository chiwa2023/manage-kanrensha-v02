...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.dump.all.master.DumpMasterPersonBatchConfiguration;
...
public class ForceDumpMinMasterPersonService {
    ...
    public void practice(final Integer year, final InsertTaskPlanResultDto planDto, final LocalDate endDate,
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, MasterMin.MASTER_MIN_PERSON).toString())
        ...
        try {
            jobOperator.run(dumpMasterPerson, jobParameters);
