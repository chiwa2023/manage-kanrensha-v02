 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory44ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory44Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory44Repository 関連者企業履歴44Repository
     */
    public DumpKanrenshaKigyouDtHistory44ItemReader(
            final @Autowired KanrenshaKigyouDtHistory44Repository partnerCorpHistory44Repository) {
        super(partnerCorpHistory44Repository, new HashMap<String, Direction>());
