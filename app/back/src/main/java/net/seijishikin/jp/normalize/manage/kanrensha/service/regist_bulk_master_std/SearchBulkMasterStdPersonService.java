 ...
 */
@Service
public class SearchBulkMasterStdPersonService {
     ...
     * @return 検索結果
     */
    public SearchWkTblStdPersonPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblKanrenshaPersonMasterRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        SearchWkTblStdPersonPagingResultDto resultDto = new SearchWkTblStdPersonPagingResultDto();
        resultDto.setAllCount(allCount);
        resultDto.setLimit(limit);
        resultDto.setPageNumber(pageNumber);
        resultDto.setListWktblPerson(wkTblKanrenshaPersonMasterRepository
