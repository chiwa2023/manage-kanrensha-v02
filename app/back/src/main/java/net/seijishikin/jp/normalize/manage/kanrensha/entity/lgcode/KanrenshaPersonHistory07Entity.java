...
/**
 * kanrensha_person_history_07接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_07)
public class KanrenshaPersonHistory07Entity // NOPMD DataClass
