...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する23
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory23ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory23Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory23Repository 関連者企業履歴23Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory23ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory23Repository partnerPoliOrgHistory23Repository) {
        super(partnerPoliOrgHistory23Repository, new HashMap<String, Direction>());
