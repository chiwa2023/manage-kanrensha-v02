 ...
 */
@Service
public class SearchBulkMasterStdSeijidantaiService {
     ...
     * @return 検索結果
     */
    public SearchWkTblStdSeijidantaiPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblKanrenshaSeijidantaiMasterRepository.countByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
        ...
        SearchWkTblStdSeijidantaiPagingResultDto resultDto = new SearchWkTblStdSeijidantaiPagingResultDto();
        resultDto.setAllCount(allCount);
        resultDto.setLimit(limit);
        resultDto.setPageNumber(pageNumber);
        resultDto.setListWktblSeijidantai(wkTblKanrenshaSeijidantaiMasterRepository
