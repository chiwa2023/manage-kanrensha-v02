...
/**
 * kanrensha_person_history_01接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_01)
public class KanrenshaPersonHistory01Entity // NOPMD DataClass
