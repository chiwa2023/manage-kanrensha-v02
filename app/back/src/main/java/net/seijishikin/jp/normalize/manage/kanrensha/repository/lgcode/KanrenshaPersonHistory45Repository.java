...
public interface KanrenshaPersonHistory45Repository extends JpaRepository<KanrenshaPersonHistory45Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory45Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory45Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory45Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
