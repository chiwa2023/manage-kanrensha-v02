...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する02
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory02ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory02Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory02Repository 関連者企業履歴02Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory02ItemReader(
            final @Autowired KanrenshaKigyouDtHistory02Repository kanrenshaKigyouDtHistory02Repository) {
        super(kanrenshaKigyouDtHistory02Repository, new HashMap<String, Direction>());
