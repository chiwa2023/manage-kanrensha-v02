 ...
 */
@Component
public class DumpKanrenshaPersonHistory02ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory02Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory02ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory02Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory02Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
