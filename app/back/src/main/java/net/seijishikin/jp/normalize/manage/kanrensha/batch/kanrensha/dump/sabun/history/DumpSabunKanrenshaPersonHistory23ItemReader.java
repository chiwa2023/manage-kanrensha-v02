...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する23
 */
@Component
public class DumpSabunKanrenshaPersonHistory23ItemReader extends RepositoryItemReader<KanrenshaPersonHistory23Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory23ItemReader(
            final @Autowired KanrenshaPersonHistory23Repository partnerPersonHistory23Repository) {
        super(partnerPersonHistory23Repository, new HashMap<String, Direction>());
