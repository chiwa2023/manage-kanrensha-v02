...
/**
 * kanrensha_seijidantai_history_10接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_10)
public class KanrenshaSeijidantaiHistory10Entity // NOPMD DataClass
