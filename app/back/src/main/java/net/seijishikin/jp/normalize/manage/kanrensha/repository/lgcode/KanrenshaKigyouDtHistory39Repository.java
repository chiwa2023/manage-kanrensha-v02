...
public interface KanrenshaKigyouDtHistory39Repository extends JpaRepository<KanrenshaKigyouDtHistory39Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory39Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory39Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
