...
/**
 * kanrensha_seijidantai_history_25接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_25)
public class KanrenshaSeijidantaiHistory25Entity // NOPMD DataClass
