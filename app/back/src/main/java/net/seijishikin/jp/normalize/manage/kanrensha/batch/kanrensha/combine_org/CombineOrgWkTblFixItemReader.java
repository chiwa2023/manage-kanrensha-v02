...
/**
 * 個人団体紐づけワークテーブルフラグ修正ItemReader
 */
@Component
public class CombineOrgWkTblFixItemReader extends RepositoryItemReader<WkTblKanrenshaCombineOrgResultEntity> {

    /**
     * コンストラクタ
     *
     * @param wkCombineOrgResultRepository 個人団体紐づけ判定ワークテーブルRepository
     */
    public CombineOrgWkTblFixItemReader(
            final @Autowired WkTblKanrenshaCombineOrgResultRepository wkCombineOrgResultRepository) {

        super(wkCombineOrgResultRepository, new HashMap<String, Direction>());
