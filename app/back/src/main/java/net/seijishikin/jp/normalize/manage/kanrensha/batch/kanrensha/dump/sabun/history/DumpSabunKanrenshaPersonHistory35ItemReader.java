...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する35
 */
@Component
public class DumpSabunKanrenshaPersonHistory35ItemReader extends RepositoryItemReader<KanrenshaPersonHistory35Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory35Repository 関連者企業履歴35Repository
     */
    public DumpSabunKanrenshaPersonHistory35ItemReader(
            final @Autowired KanrenshaPersonHistory35Repository partnerPersonHistory35Repository) {
        super(partnerPersonHistory35Repository, new HashMap<String, Direction>());
