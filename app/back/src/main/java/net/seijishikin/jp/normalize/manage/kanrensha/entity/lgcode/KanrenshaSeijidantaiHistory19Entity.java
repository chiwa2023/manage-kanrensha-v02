...
/**
 * kanrensha_seijidantai_history_19接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_19)
public class KanrenshaSeijidantaiHistory19Entity // NOPMD DataClass
