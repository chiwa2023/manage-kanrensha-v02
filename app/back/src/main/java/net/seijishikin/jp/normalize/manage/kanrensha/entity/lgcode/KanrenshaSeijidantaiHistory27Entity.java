...
/**
 * kanrensha_seijidantai_history_27接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_27)
public class KanrenshaSeijidantaiHistory27Entity // NOPMD DataClass
