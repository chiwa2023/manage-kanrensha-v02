...
import net.seijishikin.jp.normalize.manage.kanrensha.service.kanrensha.EditKanrenshaSeijidantaiService;
...
public class EditUserKanrenshaSeijidantaiController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            ...
            if (!validateAuthoraizeUserDetailLogic.practiceKanrensha(capsuleDto.getUserDto(),
                    capsuleDto.getKanrenshaSeijidantaiDto().getSeijidantaiKanrenshaCode(),
            ...
            Integer newId = editKanrenshaSeijidantaiService.practice(capsuleDto);
            if (0 == newId) {
            ...
            resultDto.setMessage("他のユーザが先に修正したようです。大変お手数をおかけしますが変更された後のデータを確認して修正作業をしなおしてください");
            resultDto.setIsFailure(true);
