...
/**
 * kanrensha_seijidantai_history_21接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_21)
public class KanrenshaSeijidantaiHistory21Entity // NOPMD DataClass
