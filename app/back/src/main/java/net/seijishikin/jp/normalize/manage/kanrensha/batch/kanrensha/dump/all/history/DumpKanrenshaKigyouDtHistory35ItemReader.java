 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory35ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory35Entity> {
     ...
     */
    public DumpKanrenshaKigyouDtHistory35ItemReader(
            final @Autowired KanrenshaKigyouDtHistory35Repository partnerCorpHistory35Repository) {
        super(partnerCorpHistory35Repository, new HashMap<String, Direction>());
