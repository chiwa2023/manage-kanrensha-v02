...
/**
 * wk_tbl_address_rsdt_file接続用Entity
 */
@Entity
@Table(name = "wk_tbl_address_rsdt_file")
public class WkTblAddressRsdtFileEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "wk_tbl_address_rsdt_file_id")
    private Integer wkTblAddressRsdtFileId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkTblAddressRsdtFileId() {
        return wkTblAddressRsdtFileId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkTblAddressRsdtFileId テーブルId
     */
    public void setWkTblAddressRsdtFileId(final Integer wkTblAddressRsdtFileId) {
        this.wkTblAddressRsdtFileId = wkTblAddressRsdtFileId;
    }
