...
/**
 * kanrensha_person_history_33接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_33)
public class KanrenshaPersonHistory33Entity // NOPMD DataClass
