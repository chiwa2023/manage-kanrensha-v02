 ...
 */
@Service
public class SearchApprovalAddressKigyouDtService {
    ...
    public SearchApprovalAddressResultDto practice(final SearchWorksApprovalCapsuleDto capsuleDto) {
        ...
        if (0 == capsuleDto.getAllCount()) {
            count = kanrenshaKigyouDtAddressRepository.countIsEditData(start, end, listIsEdit);
        }
        ...
        resultDto.setListAddress(
                kanrenshaKigyouDtAddressRepository.findIsEditData(start, end, listIsEdit, pageable));
