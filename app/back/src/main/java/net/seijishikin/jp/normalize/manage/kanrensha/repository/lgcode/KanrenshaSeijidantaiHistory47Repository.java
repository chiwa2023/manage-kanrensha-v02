...
/**
 * kanrensha_seijidantai_history_47接続用Repository
 */
public interface KanrenshaSeijidantaiHistory47Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory47Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory47Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_47"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory47Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_47 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory47Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory47Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
