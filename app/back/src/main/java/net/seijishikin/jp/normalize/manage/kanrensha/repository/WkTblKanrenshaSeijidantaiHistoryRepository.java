...
public interface WkTblKanrenshaSeijidantaiHistoryRepository
        ...
        PagingAndSortingRepository<WkTblKanrenshaSeijidantaiHistoryEntity, Integer> {
     ...
     * @return 検索結果
     */
    List<WkTblKanrenshaSeijidantaiHistoryEntity> findByInsertUserCodeAndIsLatestInAndIsAffectedInAndIsFinishIn(
