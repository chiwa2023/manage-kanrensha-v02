...
/**
 * kanrensha_seijidantai_history_18接続用Repository
 */
public interface KanrenshaSeijidantaiHistory18Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory18Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory18Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_18"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory18Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_18 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory18Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory18Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
