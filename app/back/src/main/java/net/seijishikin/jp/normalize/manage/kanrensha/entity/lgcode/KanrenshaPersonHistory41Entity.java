...
/**
 * kanrensha_person_history_41接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_41)
public class KanrenshaPersonHistory41Entity // NOPMD DataClass
