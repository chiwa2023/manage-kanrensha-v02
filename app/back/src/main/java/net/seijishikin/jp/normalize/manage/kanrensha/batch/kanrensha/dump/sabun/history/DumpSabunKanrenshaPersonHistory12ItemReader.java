...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する12
 */
@Component
public class DumpSabunKanrenshaPersonHistory12ItemReader extends RepositoryItemReader<KanrenshaPersonHistory12Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory12Repository 関連者企業履歴12Repository
     */
    public DumpSabunKanrenshaPersonHistory12ItemReader(
            final @Autowired KanrenshaPersonHistory12Repository partnerPersonHistory12Repository) {
        super(partnerPersonHistory12Repository, new HashMap<String, Direction>());
