...
/**
 * kanrensha_seijidantai_history_09接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_09)
public class KanrenshaSeijidantaiHistory09Entity // NOPMD DataClass
