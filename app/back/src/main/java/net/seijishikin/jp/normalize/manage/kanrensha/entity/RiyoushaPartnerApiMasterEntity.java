...
/**
 * riyousha_partner_api_master接続用Entity
 */
@Entity
@Table(name = "riyousha_partner_api_master")
public class RiyoushaPartnerApiMasterEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "riyousha_partner_api_master_id")
    ...
    /** 利用者運営者コード */
    @Column(name = "riyousha_partner_api_master_code")
