...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する44
 */
@Component
public class DumpSabunKanrenshaPersonHistory44ItemReader extends RepositoryItemReader<KanrenshaPersonHistory44Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory44Repository 関連者企業履歴44Repository
     */
    public DumpSabunKanrenshaPersonHistory44ItemReader(
            final @Autowired KanrenshaPersonHistory44Repository partnerPersonHistory44Repository) {
        super(partnerPersonHistory44Repository, new HashMap<String, Direction>());
