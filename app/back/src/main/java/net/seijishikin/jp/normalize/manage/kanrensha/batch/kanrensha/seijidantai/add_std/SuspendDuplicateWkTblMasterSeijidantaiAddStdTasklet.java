 ...
 */
@Component
public class SuspendDuplicateWkTblMasterSeijidantaiAddStdTasklet implements Tasklet, StepExecutionListener {

    /** 関連者個人マスタ標準ワークテーブル */
    @Autowired
    private WkTblKanrenshaSeijidantaiMasterRepository wkTblMasterSeijidantaiRepository;
