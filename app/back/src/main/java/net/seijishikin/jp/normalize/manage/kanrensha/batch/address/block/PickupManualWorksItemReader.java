 ...
 */
@Component
public class PickupManualWorksItemReader extends RepositoryItemReader<AddressPostalEntity> {
     ...
     */
    public PickupManualWorksItemReader(final @Autowired AddressPostalRepository addressPostalRepository) {
        super(addressPostalRepository, new HashMap<>());
        super.setMethodName("findRepairLog");
