...
/**
 * kanrensha_kigyou_dt_history_44接続用Repository
 */
public interface KanrenshaKigyouDtHistory44Repository extends JpaRepository<KanrenshaKigyouDtHistory44Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory44Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_44"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory44Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_44 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory44Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory44Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
