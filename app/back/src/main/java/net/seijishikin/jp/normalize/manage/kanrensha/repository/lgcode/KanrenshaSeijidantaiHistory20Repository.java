...
/**
 * kanrensha_seijidantai_history_20接続用Repository
 */
public interface KanrenshaSeijidantaiHistory20Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory20Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory20Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_20"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory20Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_20 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory20Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory20Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
