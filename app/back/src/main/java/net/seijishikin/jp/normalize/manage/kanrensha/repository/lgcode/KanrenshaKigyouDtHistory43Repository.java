...
/**
 * kanrensha_kigyou_dt_history_43接続用Repository
 */
public interface KanrenshaKigyouDtHistory43Repository extends JpaRepository<KanrenshaKigyouDtHistory43Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory43Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_43"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory43Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_43 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory43Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory43Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
