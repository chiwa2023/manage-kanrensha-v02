...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する12
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory12ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory12Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory12Repository 関連者企業履歴12Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory12ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory12Repository partnerPoliOrgHistory12Repository) {

        super(partnerPoliOrgHistory12Repository, new HashMap<String, Direction>());
