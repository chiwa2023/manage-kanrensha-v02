...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する21
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory21ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory21Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory21Repository 関連者企業履歴21Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory21ItemReader(
            final @Autowired KanrenshaKigyouDtHistory21Repository kanrenshaKigyouDtHistory21Repository) {
        super(kanrenshaKigyouDtHistory21Repository, new HashMap<String, Direction>());
