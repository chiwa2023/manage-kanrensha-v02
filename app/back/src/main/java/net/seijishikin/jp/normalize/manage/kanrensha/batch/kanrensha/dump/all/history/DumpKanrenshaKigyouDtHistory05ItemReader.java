 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory05ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory05Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory05Repository 関連者企業履歴05Repository
     */
    public DumpKanrenshaKigyouDtHistory05ItemReader(
            final @Autowired KanrenshaKigyouDtHistory05Repository partnerCorpHistory05Repository) {
        super(partnerCorpHistory05Repository, new HashMap<String, Direction>());
