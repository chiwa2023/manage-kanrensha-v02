...
/**
 * kanrensha_person_history_32接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_32)
public class KanrenshaPersonHistory32Entity // NOPMD DataClass
