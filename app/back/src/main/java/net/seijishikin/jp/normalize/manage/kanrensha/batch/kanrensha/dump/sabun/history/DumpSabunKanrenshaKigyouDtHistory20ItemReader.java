...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する20
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory20ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory20Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory20Repository 関連者企業履歴20Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory20ItemReader(
            final @Autowired KanrenshaKigyouDtHistory20Repository kanrenshaKigyouDtHistory20Repository) {
        super(kanrenshaKigyouDtHistory20Repository, new HashMap<String, Direction>());
