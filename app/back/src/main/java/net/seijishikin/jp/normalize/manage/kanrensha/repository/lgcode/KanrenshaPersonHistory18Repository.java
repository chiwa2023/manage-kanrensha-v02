...
public interface KanrenshaPersonHistory18Repository extends JpaRepository<KanrenshaPersonHistory18Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory18Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_18 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory18Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory18Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
