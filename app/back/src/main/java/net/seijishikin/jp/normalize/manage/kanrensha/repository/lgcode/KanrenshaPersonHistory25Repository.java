...
/**
 * kanrensha_person_history_25接続用Repository
 */
public interface KanrenshaPersonHistory25Repository extends JpaRepository<KanrenshaPersonHistory25Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory25Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_25"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory25Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_25 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory25Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory25Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
