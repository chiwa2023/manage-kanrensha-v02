...
public interface KanrenshaPersonHistory36Repository extends JpaRepository<KanrenshaPersonHistory36Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory36Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_36 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory36Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory36Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
