...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する31
 */
@Component
public class DumpSabunKanrenshaPersonHistory31ItemReader extends RepositoryItemReader<KanrenshaPersonHistory31Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory31Repository 関連者企業履歴31Repository
     */
    public DumpSabunKanrenshaPersonHistory31ItemReader(
            final @Autowired KanrenshaPersonHistory31Repository partnerPersonHistory31Repository) {
        super(partnerPersonHistory31Repository, new HashMap<String, Direction>());
