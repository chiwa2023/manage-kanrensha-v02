...
public interface KanrenshaPersonHistory14Repository extends JpaRepository<KanrenshaPersonHistory14Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory14Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_14 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory14Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory14Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
