...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.dump.all.master.DumpMasterSeijidantaiBatchConfiguration;
...
/**
 * 政治団体マスタ標準データをダンプする非同期Service
 */
@Service
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
public class ForceDumpStdMasterSeijidantaiService {
    ...
    public void practice(final Integer year, final InsertTaskPlanResultDto planDto, final LocalDate endDate,
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, MasterStd.MASTER_STD_SEIJIDANTAI).toString())
        ...
        try {
            jobOperator.run(dumpMasterPoliticalOrganization, jobParameters);
