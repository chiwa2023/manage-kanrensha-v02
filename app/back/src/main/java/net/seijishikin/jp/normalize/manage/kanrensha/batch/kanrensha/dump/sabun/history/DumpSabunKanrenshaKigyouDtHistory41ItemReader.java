...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する41
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory41ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory41Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory41Repository 関連者企業履歴41Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory41ItemReader(
            final @Autowired KanrenshaKigyouDtHistory41Repository kanrenshaKigyouDtHistory41Repository) {
        super(kanrenshaKigyouDtHistory41Repository, new HashMap<String, Direction>());
