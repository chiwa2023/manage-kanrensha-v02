...
/**
 * kanrensha_kigyou_dt_access接続用Entity
 */
@Entity
@Table(name = "kanrensha_kigyou_dt_access")
public class KanrenshaKigyouDtAccessEntity // NOPMD DataClass
    ...
    @Column(name = "kanrensha_kigyou_dt_access_id")
    private Integer kanrenshaKigyouDtAccessId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getKanrenshaKigyouDtAccessId() {
        return kanrenshaKigyouDtAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param kanrenshaKigyouDtAccessId テーブルId
     */
    public void setKanrenshaKigyouDtAccessId(final Integer kanrenshaKigyouDtAccessId) {
        this.kanrenshaKigyouDtAccessId = kanrenshaKigyouDtAccessId;
    }
