 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory10ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory10Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory10Repository 関連者企業履歴10Repository
     */
    public DumpKanrenshaKigyouDtHistory10ItemReader(
            final @Autowired KanrenshaKigyouDtHistory10Repository partnerCorpHistory10Repository) {
        super(partnerCorpHistory10Repository, new HashMap<String, Direction>());
