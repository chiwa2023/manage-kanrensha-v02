...
/**
 * kanrensha_person_history_44接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_44)
public class KanrenshaPersonHistory44Entity // NOPMD DataClass
