...
/**
 * 関連者企業・団体マスタ標準登録処理結果登録ItemWriter
 */
@Component
public class MasterKigyouDtAddStdWkTblFixItemWriter extends JpaItemWriter<WkTblKanrenshaKigyouDtMasterEntity> {

    /** 関連者企業・団体マスタ標準ワークテーブルRepository */
    @Autowired
