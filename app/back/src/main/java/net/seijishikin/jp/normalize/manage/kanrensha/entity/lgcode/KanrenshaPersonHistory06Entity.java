...
/**
 * kanrensha_person_history_06接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_06)
public class KanrenshaPersonHistory06Entity // NOPMD DataClass
