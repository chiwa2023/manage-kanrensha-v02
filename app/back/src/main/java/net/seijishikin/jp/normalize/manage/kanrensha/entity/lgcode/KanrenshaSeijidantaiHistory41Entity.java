...
/**
 * kanrensha_seijidantai_history_41接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_41)
public class KanrenshaSeijidantaiHistory41Entity // NOPMD DataClass
