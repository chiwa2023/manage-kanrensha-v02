...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する14
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory14ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory14Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory14Repository 関連者企業履歴14Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory14ItemReader(
            final @Autowired KanrenshaKigyouDtHistory14Repository kanrenshaKigyouDtHistory14Repository) {
        super(kanrenshaKigyouDtHistory14Repository, new HashMap<String, Direction>());
