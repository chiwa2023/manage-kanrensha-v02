...
/**
 * kanrensha_kigyou_dt_history_47接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_47)
public class KanrenshaKigyouDtHistory47Entity // NOPMD DataClass
