...
import net.seijishikin.jp.normalize.manage.kanrensha.service.regist_bulk_master_min.RetryBatchMasterMinKigyouDtService;
...
public class RetryBatchMasterMinKigyouDtController {

    /** 非同期処理登録専用Service */
    @Autowired
    private RetryBatchMasterMinKigyouDtService retryBatchMasterMinKigyouDtService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            ...
            InsertTaskPlanResultDto planDto = switchYearInsertTaskPlanService.practice(userDto, dateTimeStart,
                    TaskInfoConstants.RETRY_KIGYOU_MIN, new TreeMap<String, String>());
            taskPlanCode = planDto.getTaskPlanCode();

            retryBatchMasterMinKigyouDtService.practice(capsuleDto.getUserDto(), year, planDto);
