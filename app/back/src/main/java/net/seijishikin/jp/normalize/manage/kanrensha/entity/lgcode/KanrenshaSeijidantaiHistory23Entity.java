...
/**
 * kanrensha_seijidantai_history_23接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_23)
public class KanrenshaSeijidantaiHistory23Entity // NOPMD DataClass
