...
/**
 * kanrensha_seijidantai_history_05接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_05)
public class KanrenshaSeijidantaiHistory05Entity // NOPMD DataClass
