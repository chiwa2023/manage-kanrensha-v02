 ...
 */
@Component
public class DumpKanrenshaPersonHistory37ItemReader extends RepositoryItemReader<KanrenshaPersonHistory37Entity> {
     ...
     */
    public DumpKanrenshaPersonHistory37ItemReader(
            final @Autowired KanrenshaPersonHistory37Repository partnerPersonHistory37Repository) {
        super(partnerPersonHistory37Repository, new HashMap<String, Direction>());
