...
/**
 * kanrensha_kigyou_dt_history_35接続用Repository
 */
public interface KanrenshaKigyouDtHistory35Repository extends JpaRepository<KanrenshaKigyouDtHistory35Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory35Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_35"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory35Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_35 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory35Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory35Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
