...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.seijidantai.history.RetryKanrenshaSeijidantaiHistoryBatchConfiguration;
 ...
 */
@Service
public class RetryBatchHistorySeijidantaiService {

    /** 起動をするJob */
    @Qualifier(RetryKanrenshaSeijidantaiHistoryBatchConfiguration.JOB_NAME)
    @Autowired
    private Job retryKanrenshaSeijidantaiHistory;
    ...
    public void practice(final LeastUserDto userDto, final Integer year, final TaskPlanInfoDto planDto) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                retryKanrenshaSeijidantaiHistory.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
        ...
        try {
            jobLauncher.run(retryKanrenshaSeijidantaiHistory, jobParameters);
