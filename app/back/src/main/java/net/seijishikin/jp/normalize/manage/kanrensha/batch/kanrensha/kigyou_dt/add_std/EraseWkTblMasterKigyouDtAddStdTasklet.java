 ...
 */
@Component
public class EraseWkTblMasterKigyouDtAddStdTasklet implements Tasklet, StepExecutionListener {
    ...
    public RepeatStatus execute(final StepContribution contribution, final ChunkContext chunkContext) throws Exception {
        ...
        wkTblKanrenshaKigyouDtMasterRepository.deleteByInsertUserCode(userCode);
        wkTblKanrenshaKigyouDtMasterResultRepository.deleteByInsertUserCode(userCode);
