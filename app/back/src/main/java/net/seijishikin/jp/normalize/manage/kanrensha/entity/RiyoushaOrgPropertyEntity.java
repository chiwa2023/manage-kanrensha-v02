...
/**
 * riyousha_org_property接続用Entity
 */
@Entity
@Table(name = "riyousha_org_property")
public class RiyoushaOrgPropertyEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param riyoushaOrgPropertyId テーブルId
     */
     ...
     * 利用者個人属性コードを設定する
     *
     * @param riyoushaOrgPropertyCode 利用者個人属性コード
     */
