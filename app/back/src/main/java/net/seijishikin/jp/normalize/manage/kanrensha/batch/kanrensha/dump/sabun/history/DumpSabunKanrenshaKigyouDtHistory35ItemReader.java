 ...
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory35ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory35Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory35Repository 関連者企業履歴35Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory35ItemReader(
            final @Autowired KanrenshaKigyouDtHistory35Repository kanrenshaKigyouDtHistory35Repository) {
        super(kanrenshaKigyouDtHistory35Repository, new HashMap<String, Direction>());
