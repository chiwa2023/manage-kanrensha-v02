...
/**
 * 個人政治団体差分データをダンプする非同期Service
 */
@Service
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
public class ForceSabunDumpStdMasterPersonService {
    ...
    public void practice(final Integer year, final InsertTaskPlanResultDto planDto, final LocalDate startDate,
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, SabunMasterStd.SABUN_STD_PERSON).toString())
