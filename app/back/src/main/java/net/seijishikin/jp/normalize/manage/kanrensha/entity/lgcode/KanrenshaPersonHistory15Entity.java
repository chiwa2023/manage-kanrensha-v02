...
/**
 * kanrensha_person_history_15接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_15)
public class KanrenshaPersonHistory15Entity // NOPMD DataClass
