...
/**
 * kanrensha_kigyou_dt_history_20接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_20)
public class KanrenshaKigyouDtHistory20Entity // NOPMD DataClass
