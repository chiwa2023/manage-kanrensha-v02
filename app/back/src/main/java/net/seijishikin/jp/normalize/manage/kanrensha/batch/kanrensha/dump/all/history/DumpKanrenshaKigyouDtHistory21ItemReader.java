 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory21ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory21Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory21Repository 関連者企業履歴21Repository
     */
    public DumpKanrenshaKigyouDtHistory21ItemReader(
            final @Autowired KanrenshaKigyouDtHistory21Repository partnerCorpHistory21Repository) {
        super(partnerCorpHistory21Repository, new HashMap<String, Direction>());
