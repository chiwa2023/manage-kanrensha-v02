...
public interface KanrenshaKigyouDtHistory99Repository extends JpaRepository<KanrenshaKigyouDtHistory99Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory99Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_99 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory99Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory99Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
