...
/**
 * kanrensha_person_history_23接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_23)
public class KanrenshaPersonHistory23Entity // NOPMD DataClass
