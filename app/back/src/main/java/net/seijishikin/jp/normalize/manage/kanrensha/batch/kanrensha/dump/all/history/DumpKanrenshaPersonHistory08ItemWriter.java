 ...
 */
@Component
public class DumpKanrenshaPersonHistory08ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory08Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory08ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory08Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory08Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
