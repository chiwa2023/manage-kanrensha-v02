...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する99
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory99ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory99Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory99Repository 関連者企業履歴99Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory99ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory99Repository partnerPoliOrgHistory99Repository) {

        super(partnerPoliOrgHistory99Repository, new HashMap<String, Direction>());
