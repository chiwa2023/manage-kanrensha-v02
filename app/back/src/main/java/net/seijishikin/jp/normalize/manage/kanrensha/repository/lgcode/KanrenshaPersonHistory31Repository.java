...
/**
 * kanrensha_person_history_31接続用Repository
 */
public interface KanrenshaPersonHistory31Repository extends JpaRepository<KanrenshaPersonHistory31Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory31Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_31"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory31Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_31 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory31Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory31Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
