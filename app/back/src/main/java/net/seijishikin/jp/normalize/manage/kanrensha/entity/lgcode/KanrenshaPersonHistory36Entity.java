...
/**
 * kanrensha_person_history_36接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_36)
public class KanrenshaPersonHistory36Entity // NOPMD DataClass
