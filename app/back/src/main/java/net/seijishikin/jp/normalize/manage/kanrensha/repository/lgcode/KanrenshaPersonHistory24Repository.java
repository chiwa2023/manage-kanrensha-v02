...
public interface KanrenshaPersonHistory24Repository extends JpaRepository<KanrenshaPersonHistory24Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory24Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_24 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory24Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory24Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
