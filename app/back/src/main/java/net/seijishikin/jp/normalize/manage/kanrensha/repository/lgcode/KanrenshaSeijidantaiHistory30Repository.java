...
/**
 * kanrensha_seijidantai_history_30接続用Repository
 */
public interface KanrenshaSeijidantaiHistory30Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory30Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory30Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_30"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory30Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_30 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory30Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory30Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
