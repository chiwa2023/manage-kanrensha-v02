...
/**
 * kanrensha_kigyou_dt_history_14接続用Repository
 */
public interface KanrenshaKigyouDtHistory14Repository extends JpaRepository<KanrenshaKigyouDtHistory14Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory14Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_14"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory14Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_14 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory14Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory14Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
