...
/**
 * kanrensha_seijidantai_history_24接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_24)
public class KanrenshaSeijidantaiHistory24Entity // NOPMD DataClass
