...
/**
 * kanrensha_kigyou_dt_history_41接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_41)
public class KanrenshaKigyouDtHistory41Entity // NOPMD DataClass
