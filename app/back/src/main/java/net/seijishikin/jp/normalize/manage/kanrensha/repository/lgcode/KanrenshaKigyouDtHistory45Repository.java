...
public interface KanrenshaKigyouDtHistory45Repository extends JpaRepository<KanrenshaKigyouDtHistory45Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory45Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory45Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory45Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
