...
/**
 * kanrensha_seijidantai_history_07接続用Repository
 */
public interface KanrenshaSeijidantaiHistory07Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory07Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory07Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_07"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory07Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_07 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory07Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory07Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
