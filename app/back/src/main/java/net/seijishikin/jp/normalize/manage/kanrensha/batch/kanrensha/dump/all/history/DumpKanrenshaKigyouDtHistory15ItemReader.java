 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory15ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory15Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory15Repository 関連者企業履歴15Repository
     */
    public DumpKanrenshaKigyouDtHistory15ItemReader(
            final @Autowired KanrenshaKigyouDtHistory15Repository partnerCorpHistory15Repository) {
        super(partnerCorpHistory15Repository, new HashMap<String, Direction>());
