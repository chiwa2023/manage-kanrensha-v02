 ...
 */
@Configuration
public class AddStdKanrenshaSeijidantaiMasterBatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "addStdKanrenshaSeijidantaiMaster";
    ...
    protected Step getStepErase(final JobRepository jobRepository,
        ...
        return new StepBuilder(STEP_ERASE, jobRepository)
                .tasklet(eraseWkTblMasterSeijidantaiAddStdTasklet, transactionManager).build();
    }
    ...
    protected Step getStepSuspend(final JobRepository jobRepository,
        ...
        return new StepBuilder(STEP_SUSPEND, jobRepository)
                .tasklet(suspendDuplicateWkTblMasterSeijidantaiAddStdTasklet, transactionManager).build();
    }
