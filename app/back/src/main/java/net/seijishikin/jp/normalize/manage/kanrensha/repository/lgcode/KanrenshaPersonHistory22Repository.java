...
/**
 * kanrensha_person_history_22接続用Repository
 */
public interface KanrenshaPersonHistory22Repository extends JpaRepository<KanrenshaPersonHistory22Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory22Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_22 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory22Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory22Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
