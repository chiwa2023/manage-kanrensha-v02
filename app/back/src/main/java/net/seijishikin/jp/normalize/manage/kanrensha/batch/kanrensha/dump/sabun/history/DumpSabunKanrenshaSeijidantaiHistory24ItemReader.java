...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する24
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory24ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory24Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory24Repository 関連者企業履歴24Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory24ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory24Repository partnerPoliOrgHistory24Repository) {

        super(partnerPoliOrgHistory24Repository, new HashMap<String, Direction>());
