...
/**
 * kanrensha_kigyou_dt_history_29接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_29)
public class KanrenshaKigyouDtHistory29Entity // NOPMD DataClass
