...
/**
 * kanrensha_kigyou_dt_history_45接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_45)
public class KanrenshaKigyouDtHistory45Entity // NOPMD DataClass
