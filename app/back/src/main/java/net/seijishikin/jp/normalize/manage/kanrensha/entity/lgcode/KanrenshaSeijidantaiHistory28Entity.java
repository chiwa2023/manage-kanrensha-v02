...
/**
 * kanrensha_seijidantai_history_28接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_28)
public class KanrenshaSeijidantaiHistory28Entity // NOPMD DataClass
