...
/**
 * kanrensha_person_history_16接続用Repository
 */
public interface KanrenshaPersonHistory16Repository extends JpaRepository<KanrenshaPersonHistory16Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory16Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_16"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory16Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_16 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory16Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory16Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
