 ...
 */
@Component
public class MasterKigyouDtAddStdRecordItemReader extends RepositoryItemReader<WkTblKanrenshaKigyouDtMasterEntity> {
    ...
    public MasterKigyouDtAddStdRecordItemReader(
        ...
        super(wkTblKanrenshaKigyouDtMasterRepository, new HashMap<String, Direction>());
