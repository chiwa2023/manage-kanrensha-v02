...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する24
 */
@Component
public class DumpSabunKanrenshaPersonHistory24ItemReader extends RepositoryItemReader<KanrenshaPersonHistory24Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory24Repository 関連者企業履歴24Repository
     */
    public DumpSabunKanrenshaPersonHistory24ItemReader(
            final @Autowired KanrenshaPersonHistory24Repository partnerPersonHistory24Repository) {
        super(partnerPersonHistory24Repository, new HashMap<String, Direction>());
