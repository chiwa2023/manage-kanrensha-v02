...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する36
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory36ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory36Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory36Repository 関連者企業履歴36Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory36ItemReader(
            final @Autowired KanrenshaKigyouDtHistory36Repository kanrenshaKigyouDtHistory36Repository) {
        super(kanrenshaKigyouDtHistory36Repository, new HashMap<String, Direction>());
