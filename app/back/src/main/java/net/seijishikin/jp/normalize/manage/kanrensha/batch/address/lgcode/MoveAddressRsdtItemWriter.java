 ...
 */
@Component
public class MoveAddressRsdtItemWriter extends JpaItemWriter<AddressRsdtTemplateEntity> {
    ...
    @Override
    @Transactional
    public void write(final Chunk<? extends AddressRsdtTemplateEntity> items) {
        ...
        for (AddressRsdtTemplateEntity entity : items) {

            Query query = entityManager
                    .createNativeQuery(createSqlInsertAddressRsdtLogic.practice(userDto, entity, timestampString));
            query.executeUpdate();
        }
