...
import net.seijishikin.jp.normalize.manage.kanrensha.service.address_rsdt.DeleteAddressRsdtService;
import net.seijishikin.jp.normalize.manage.kanrensha.service.util.SaveStackTraceService;

/**
 * アドレス・ベース・レジストリ削除Controller
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/address-rsdt")
public class DeleteAddressRsdtController {

    /** アドレス・ベース・レジストリ削除Service */
    @Autowired
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            int deleteCount = deleteAddressRsdtService.practice(capsuleDto);
