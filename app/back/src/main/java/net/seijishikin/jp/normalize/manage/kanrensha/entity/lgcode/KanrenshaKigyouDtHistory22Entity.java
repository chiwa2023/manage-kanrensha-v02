...
/**
 * kanrensha_kigyou_dt_history_22接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_22)
public class KanrenshaKigyouDtHistory22Entity // NOPMD DataClass
