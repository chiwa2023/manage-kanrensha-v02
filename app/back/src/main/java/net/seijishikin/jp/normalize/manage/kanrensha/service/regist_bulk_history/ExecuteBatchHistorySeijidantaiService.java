...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.seijidantai.history.InsertKanrenshaSeijidantaiHistoryBatchConfiguration;
...
public class ExecuteBatchHistorySeijidantaiService {

    /** 起動をするJob */
    @Qualifier(InsertKanrenshaSeijidantaiHistoryBatchConfiguration.JOB_NAME)
    @Autowired
    private Job insertKanrenshaSeijidantaiHistory;
    ...
    public void practice(final Integer year, final LeastUserDto userDto, final TaskPlanWithUseFileDto planFileDto) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                insertKanrenshaSeijidantaiHistory.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
        ...
        try {
            jobLauncher.run(insertKanrenshaSeijidantaiHistory, jobParameters);
