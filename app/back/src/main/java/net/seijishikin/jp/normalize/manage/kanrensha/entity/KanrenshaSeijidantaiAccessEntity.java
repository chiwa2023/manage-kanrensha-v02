...
/**
 * kanrensha_seijidantai_access接続用Entity
 */
@Entity
@Table(name = "kanrensha_seijidantai_access")
public class KanrenshaSeijidantaiAccessEntity // NOPMD DataClass
    ...
    @Column(name = "kanrensha_seijidantai_access_id")
    private Integer kanrenshaSeijidantaiAccessId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getKanrenshaSeijidantaiAccessId() {
        return kanrenshaSeijidantaiAccessId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param kanrenshaSeijidantaiAccessId テーブルId
     */
    public void setKanrenshaSeijidantaiAccessId(final Integer kanrenshaSeijidantaiAccessId) {
        this.kanrenshaSeijidantaiAccessId = kanrenshaSeijidantaiAccessId;
    }
