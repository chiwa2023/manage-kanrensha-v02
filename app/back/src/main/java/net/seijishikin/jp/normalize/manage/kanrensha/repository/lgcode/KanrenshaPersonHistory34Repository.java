...
public interface KanrenshaPersonHistory34Repository extends JpaRepository<KanrenshaPersonHistory34Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory34Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_34 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory34Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory34Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
