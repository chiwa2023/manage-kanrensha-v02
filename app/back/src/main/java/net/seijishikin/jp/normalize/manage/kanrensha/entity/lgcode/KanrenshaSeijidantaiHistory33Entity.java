...
/**
 * kanrensha_seijidantai_history_33接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_33)
public class KanrenshaSeijidantaiHistory33Entity // NOPMD DataClass
