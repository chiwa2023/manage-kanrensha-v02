...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.seijidantai.add_min.RetryMinKanrenshaSeijidantaiMasterBatchConfiguration;
 ...
 */
@Service
public class RetryBatchMasterMinSeijidantaiService {

    /** 起動をするJob */
    @Qualifier(RetryMinKanrenshaSeijidantaiMasterBatchConfiguration.JOB_NAME)
    @Autowired
    private Job retryMinKanrenshaSeijidantaiMaster;
    ...
    public void practice(final LeastUserDto userDto, final Integer year, final TaskPlanInfoDto planDto) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                retryMinKanrenshaSeijidantaiMaster.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
        ...
        try {
            jobLauncher.run(retryMinKanrenshaSeijidantaiMaster, jobParameters);
