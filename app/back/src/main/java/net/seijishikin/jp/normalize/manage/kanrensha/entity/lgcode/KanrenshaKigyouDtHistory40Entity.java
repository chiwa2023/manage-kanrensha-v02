...
/**
 * kanrensha_kigyou_dt_history_40接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_40)
public class KanrenshaKigyouDtHistory40Entity // NOPMD DataClass
