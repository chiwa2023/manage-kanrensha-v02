...
/**
 * kanrensha_person_history_20接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_20)
public class KanrenshaPersonHistory20Entity // NOPMD DataClass
