...
/**
 * kanrensha_seijidantai_history_03接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_03)
public class KanrenshaSeijidantaiHistory03Entity // NOPMD DataClass
