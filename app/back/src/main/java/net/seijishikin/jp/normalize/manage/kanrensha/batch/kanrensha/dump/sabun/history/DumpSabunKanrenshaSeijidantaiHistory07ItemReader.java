...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する07
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory07ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory07Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory07Repository 関連者企業履歴07Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory07ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory07Repository partnerPoliOrgHistory07Repository) {
        super(partnerPoliOrgHistory07Repository, new HashMap<String, Direction>());
