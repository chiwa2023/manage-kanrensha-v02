...
import net.seijishikin.jp.normalize.manage.kanrensha.service.z_force.AsyncForceDumpMinMasterSabunService;
import net.seijishikin.jp.normalize.manage.kanrensha.constants.TaskInfoConstants;
import net.seijishikin.jp.normalize.manage.kanrensha.controller.PathRouteConstants;

/**
 * マスタ最小差分ダンプController
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/dump-master-min-sabun")
public class ForceDumpMinMasterSabunController {

    /** 非同期処理専用Service */
    @Autowired
    private AsyncForceDumpMinMasterSabunService asyncForceDumpMinMasterSabunService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody ForceDumpCapsuleDto capsuleDto) {
        ...
        try {
            ...
            InsertTaskPlanResultDto planDto1 = switchYearInsertTaskPlanService.practice(null, userDto, dateTimeStart,
                    TaskInfoConstants.DUMP_MIN_SABUN_PERSON, mapParam);
            ...
            InsertTaskPlanResultDto planDto2 = switchYearInsertTaskPlanService.practice(null, userDto, dateTimeStart,
                    TaskInfoConstants.DUMP_MIN_SABUN_KIGYOU, mapParam);

            InsertTaskPlanResultDto planDto3 = switchYearInsertTaskPlanService.practice(null, userDto, dateTimeStart,
                    TaskInfoConstants.DUMP_MIN_SABUN_SEIJIDANTAI, mapParam);

            asyncForceDumpMinMasterSabunService.practice(year, planDto1, planDto2, planDto3, capsuleDto);
