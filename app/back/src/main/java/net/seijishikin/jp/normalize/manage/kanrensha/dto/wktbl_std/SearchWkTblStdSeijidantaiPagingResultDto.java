...
/**
 * 政治団体一括登録マスタ最小ワークテーブル検索ページングDto
 */
public class SearchWkTblStdSeijidantaiPagingResultDto // NOPMD DataClass
    ...
    /** 政治団体登録候補リスト */
    private List<WkTblKanrenshaSeijidantaiMasterEntity> listWktblSeijidantai = new ArrayList<>();
     ...
     * @return 政治団体登録候補リスト
     */
    public List<WkTblKanrenshaSeijidantaiMasterEntity> getListWktblSeijidantai() {
     ...
     */
    public void setListWktblSeijidantai(final List<WkTblKanrenshaSeijidantaiMasterEntity> listWktblSeijidantai) {
