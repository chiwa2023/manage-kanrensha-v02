...
/**
 * kanrensha_seijidantai_history_30接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_30)
public class KanrenshaSeijidantaiHistory30Entity // NOPMD DataClass
