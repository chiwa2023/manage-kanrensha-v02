...
/**
 * kanrensha_seijidantai_history_29接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_29)
public class KanrenshaSeijidantaiHistory29Entity // NOPMD DataClass
