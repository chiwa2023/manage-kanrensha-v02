...
public interface KanrenshaKigyouDtHistory20Repository extends JpaRepository<KanrenshaKigyouDtHistory20Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory20Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_20 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory20Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory20Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
