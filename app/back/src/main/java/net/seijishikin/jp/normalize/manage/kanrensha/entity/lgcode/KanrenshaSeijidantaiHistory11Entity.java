...
/**
 * kanrensha_seijidantai_history_11接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_11)
public class KanrenshaSeijidantaiHistory11Entity // NOPMD DataClass
