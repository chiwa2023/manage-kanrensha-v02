...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.dump.sabun.master.DumpSabunMasterKigyouDtBatchConfiguration;
...
public class ForceSabunDumpMinMasterKigyouDtService {
    ...
    @Autowired
    private Job dumpSabunMasterKigyouDtoration;
    ...
    public void practice(final Integer year, final TaskPlanInfoDto planDto, final LocalDate startDate,
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                dumpSabunMasterKigyouDtoration.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, SabunMasterMin.SABUN_MIN_KIGYOU).toString())
        ...
        try {
            jobLauncher.run(dumpSabunMasterKigyouDtoration, jobParameters);
