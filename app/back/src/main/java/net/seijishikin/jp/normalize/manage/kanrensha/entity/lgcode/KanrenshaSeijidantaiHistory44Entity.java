...
/**
 * kanrensha_seijidantai_history_44接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_44)
public class KanrenshaSeijidantaiHistory44Entity // NOPMD DataClass
