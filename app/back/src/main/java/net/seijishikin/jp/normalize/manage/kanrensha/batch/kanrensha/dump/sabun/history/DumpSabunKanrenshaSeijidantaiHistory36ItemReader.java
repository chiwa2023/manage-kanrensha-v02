...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する36
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory36ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory36Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory36Repository 関連者企業履歴36Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory36ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory36Repository partnerPoliOrgHistory36Repository) {
        super();
        super.setRepository(partnerPoliOrgHistory36Repository);
