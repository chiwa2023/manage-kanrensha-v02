...
/**
 * kanrensha_seijidantai_history_45接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_45)
public class KanrenshaSeijidantaiHistory45Entity // NOPMD DataClass
