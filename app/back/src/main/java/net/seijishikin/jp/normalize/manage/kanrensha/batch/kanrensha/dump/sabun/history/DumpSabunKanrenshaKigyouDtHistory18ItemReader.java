...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する18
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory18ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory18Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory18Repository 関連者企業履歴18Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory18ItemReader(
            final @Autowired KanrenshaKigyouDtHistory18Repository kanrenshaKigyouDtHistory18Repository) {
        super(kanrenshaKigyouDtHistory18Repository, new HashMap<String, Direction>());
