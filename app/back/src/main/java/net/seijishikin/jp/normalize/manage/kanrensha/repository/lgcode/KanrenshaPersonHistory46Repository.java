...
/**
 * kanrensha_person_history_46接続用Repository
 */
public interface KanrenshaPersonHistory46Repository extends JpaRepository<KanrenshaPersonHistory46Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory46Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_46"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory46Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_46 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory46Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory46Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
