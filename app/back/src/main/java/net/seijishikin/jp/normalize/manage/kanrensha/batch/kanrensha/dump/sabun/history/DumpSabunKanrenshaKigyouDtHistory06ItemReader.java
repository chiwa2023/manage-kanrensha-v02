...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する06
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory06ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory06Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory06Repository 関連者企業履歴06Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory06ItemReader(
            final @Autowired KanrenshaKigyouDtHistory06Repository kanrenshaKigyouDtHistory06Repository) {
        super(kanrenshaKigyouDtHistory06Repository,new HashMap<String, Direction>());
