 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory17ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory17Entity> {
     ...
     */
    public DumpKanrenshaKigyouDtHistory17ItemReader(
            final @Autowired KanrenshaKigyouDtHistory17Repository partnerCorpHistory17Repository) {

        super(partnerCorpHistory17Repository, new HashMap<String, Direction>());
