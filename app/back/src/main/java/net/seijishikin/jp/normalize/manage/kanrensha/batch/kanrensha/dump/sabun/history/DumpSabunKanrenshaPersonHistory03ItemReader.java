...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する03
 */
@Component
public class DumpSabunKanrenshaPersonHistory03ItemReader extends RepositoryItemReader<KanrenshaPersonHistory03Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory03Repository 関連者企業履歴03Repository
     */
    public DumpSabunKanrenshaPersonHistory03ItemReader(
            final @Autowired KanrenshaPersonHistory03Repository partnerPersonHistory03Repository) {
        super(partnerPersonHistory03Repository, new HashMap<String, Direction>());
