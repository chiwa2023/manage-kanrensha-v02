 ...
 */
public class SearchWkTblStdPersonPagingResultDto // NOPMD DataClass
    ...
    /** 個人登録候補リスト */
    private List<WkTblKanrenshaPersonMasterEntity> listWktblPerson = new ArrayList<>();
     ...
     * @return 個人登録候補リスト
     */
    public List<WkTblKanrenshaPersonMasterEntity> getListWktblPerson() {
     ...
     */
    public void setListWktblPerson(final List<WkTblKanrenshaPersonMasterEntity> listWktblPerson) {
