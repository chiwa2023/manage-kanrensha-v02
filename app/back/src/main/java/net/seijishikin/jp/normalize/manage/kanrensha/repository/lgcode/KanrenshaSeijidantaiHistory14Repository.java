...
/**
 * kanrensha_seijidantai_history_14接続用Repository
 */
public interface KanrenshaSeijidantaiHistory14Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory14Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory14Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_14"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory14Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_14 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory14Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory14Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
