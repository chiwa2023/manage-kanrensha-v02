 ...
 */
@Service
public class ExecuteBatchMasterMinSeijidantaiService {

    /** 起動をするJob */
    @Qualifier(AddMinKanrenshaSeijidantaiMasterBatchConfiguration.JOB_NAME)
    @Autowired
    private Job addMinKanrenshaSeijidantaiMaster;
    ...
    public void practice(final Integer year, final LeastUserDto userDto, final TaskPlanWithUseFileDto planFileDto) {
        ...
        try {
            jobOperator.run(addMinKanrenshaSeijidantaiMaster, jobParameters);
