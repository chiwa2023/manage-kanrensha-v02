 ...
 */
@Component
public class DumpSabunKanrenshaPersonHistory16ItemReader extends RepositoryItemReader<KanrenshaPersonHistory16Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory16ItemReader(
            final @Autowired KanrenshaPersonHistory16Repository partnerPersonHistory16Repository) {
        super(partnerPersonHistory16Repository, new HashMap<String, Direction>());
