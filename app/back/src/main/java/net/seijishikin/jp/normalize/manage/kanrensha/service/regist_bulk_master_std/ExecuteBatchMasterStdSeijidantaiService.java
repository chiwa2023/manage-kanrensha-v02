...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.seijidantai.add_std.AddStdKanrenshaSeijidantaiMasterBatchConfiguration;
 ...
 */
@Service
public class ExecuteBatchMasterStdSeijidantaiService {

    /** 起動をするJob */
    @Qualifier(AddStdKanrenshaSeijidantaiMasterBatchConfiguration.JOB_NAME)
    @Autowired
    private Job addStdKanrenshaPoliticalOrganizationMaster;
    ...
    public void practice(final Integer year, final LeastUserDto userDto, final TaskPlanWithUseFileDto planFileDto) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                addStdKanrenshaPoliticalOrganizationMaster.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
        ...
        try {
            jobLauncher.run(addStdKanrenshaPoliticalOrganizationMaster, jobParameters);
