...
/**
 * kanrensha_person_history_25接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_25)
public class KanrenshaPersonHistory25Entity // NOPMD DataClass
