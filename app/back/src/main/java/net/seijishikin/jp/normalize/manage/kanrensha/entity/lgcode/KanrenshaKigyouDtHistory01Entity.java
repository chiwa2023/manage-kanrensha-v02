...
/**
 * kanrensha_kigyou_dt_history_01接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_01)
public class KanrenshaKigyouDtHistory01Entity // NOPMD DataClass
