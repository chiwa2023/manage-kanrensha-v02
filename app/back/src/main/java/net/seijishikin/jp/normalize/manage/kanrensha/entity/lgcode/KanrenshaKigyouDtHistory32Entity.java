...
/**
 * kanrensha_kigyou_dt_history_32接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_32)
public class KanrenshaKigyouDtHistory32Entity // NOPMD DataClass
