 ...
 */
@Component
public class DumpKanrenshaPersonHistory06ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory06Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory06ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory06Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory06Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
