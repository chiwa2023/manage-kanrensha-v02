...
public interface KanrenshaPersonHistory27Repository extends JpaRepository<KanrenshaPersonHistory27Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory27Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_27 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory27Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory27Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
