...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する22
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory22ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory22Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory22Repository 関連者企業履歴22Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory22ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory22Repository partnerPoliOrgHistory22Repository) {
        super(partnerPoliOrgHistory22Repository, new HashMap<String, Direction>());
