...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する11
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory11ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory11Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory11Repository 関連者企業履歴11Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory11ItemReader(
            final @Autowired KanrenshaKigyouDtHistory11Repository kanrenshaKigyouDtHistory11Repository) {
        super(kanrenshaKigyouDtHistory11Repository, new HashMap<String, Direction>());
