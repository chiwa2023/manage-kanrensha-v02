...
/**
 * kanrensha_seijidantai_history_06接続用Repository
 */
public interface KanrenshaSeijidantaiHistory06Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory06Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory06Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_06"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory06Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_06 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory06Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory06Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
