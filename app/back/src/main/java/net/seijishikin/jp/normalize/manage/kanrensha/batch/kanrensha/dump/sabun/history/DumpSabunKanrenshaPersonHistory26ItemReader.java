...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する26
 */
@Component
public class DumpSabunKanrenshaPersonHistory26ItemReader extends RepositoryItemReader<KanrenshaPersonHistory26Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory26Repository 関連者企業履歴26Repository
     */
    public DumpSabunKanrenshaPersonHistory26ItemReader(
            final @Autowired KanrenshaPersonHistory26Repository partnerPersonHistory26Repository) {
        super(partnerPersonHistory26Repository, new HashMap<String, Direction>());
