...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する33
 */
@Component
public class DumpSabunKanrenshaPersonHistory33ItemReader extends RepositoryItemReader<KanrenshaPersonHistory33Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory33Repository 関連者企業履歴33Repository
     */
    public DumpSabunKanrenshaPersonHistory33ItemReader(
            final @Autowired KanrenshaPersonHistory33Repository partnerPersonHistory33Repository) {
        super(partnerPersonHistory33Repository, new HashMap<String, Direction>());
