...
/**
 * kanrensha_kigyou_dt_history_31接続用Repository
 */
public interface KanrenshaKigyouDtHistory31Repository extends JpaRepository<KanrenshaKigyouDtHistory31Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory31Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_31"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory31Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_31 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory31Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory31Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
