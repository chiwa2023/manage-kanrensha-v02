...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する44
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory44ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory44Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory44Repository 関連者企業履歴44Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory44ItemReader(
            final @Autowired KanrenshaKigyouDtHistory44Repository kanrenshaKigyouDtHistory44Repository) {

        super(kanrenshaKigyouDtHistory44Repository, new HashMap<String, Direction>());
