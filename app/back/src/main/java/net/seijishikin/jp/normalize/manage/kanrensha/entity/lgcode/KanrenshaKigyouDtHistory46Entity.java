...
/**
 * kanrensha_kigyou_dt_history_46接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_46)
public class KanrenshaKigyouDtHistory46Entity // NOPMD DataClass
