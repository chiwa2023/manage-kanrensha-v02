 ...
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory43ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory43Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory43Repository 関連者企業履歴43Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory43ItemReader(
            final @Autowired KanrenshaKigyouDtHistory43Repository kanrenshaKigyouDtHistory43Repository) {
        super(kanrenshaKigyouDtHistory43Repository, new HashMap<String, Direction>());
