...
/**
 * kanrensha_kigyou_dt_history_05接続用Repository
 */
public interface KanrenshaKigyouDtHistory05Repository extends JpaRepository<KanrenshaKigyouDtHistory05Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory05Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_05"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory05Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_05 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory05Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory05Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
