...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.kigyou_dt.add_std.RetryStdKanrenshaKigyouDtMasterBatchConfiguration;
 ...
 */
@Service
public class RetryBatchMasterStdKigyouDtService {

    /** 起動をするJob */
    @Qualifier(RetryStdKanrenshaKigyouDtMasterBatchConfiguration.JOB_NAME)
    @Autowired
    private Job retryStdKanrenshaKigyouDtorationMaster;
    ...
    public void practice(final LeastUserDto userDto, final Integer year, final InsertTaskPlanResultDto planDto) {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                retryStdKanrenshaKigyouDtorationMaster.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
        ...
        try {
            jobOperator.run(retryStdKanrenshaKigyouDtorationMaster, jobParameters);
