...
import net.seijishikin.jp.normalize.manage.kanrensha.batch.kanrensha.dump.sabun.master.DumpSabunMasterPersonBatchConfiguration;
...
/**
 * 個人マスタ最小差分データをダンプする非同期Service
 */
@Service
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
public class ForceSabunDumpMinMasterPersonService {
    ...
    @Autowired
    private Job dumpSabunMasterPerson;
    ...
    public void practice(final Integer year, final InsertTaskPlanResultDto planDto, final LocalDate startDate,
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                dumpSabunMasterPerson.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
                ...
                .addString("writeFilePath", Paths.get(pathSaved, folder, SabunMasterMin.SABUN_MIN_PERSON).toString())
        ...
        try {
            jobLauncher.run(dumpSabunMasterPerson, jobParameters);
