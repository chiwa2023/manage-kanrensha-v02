...
/**
 * kanrensha_person_history_09接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_09)
public class KanrenshaPersonHistory09Entity // NOPMD DataClass
