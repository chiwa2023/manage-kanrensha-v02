...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する10
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory10ItemReader
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory10ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory10Repository partnerPoliOrgHistory10Repository) {
        super(partnerPoliOrgHistory10Repository, new HashMap<String, Direction>());
