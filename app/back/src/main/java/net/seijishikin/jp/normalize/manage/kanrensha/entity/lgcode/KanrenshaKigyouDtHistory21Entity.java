...
/**
 * kanrensha_kigyou_dt_history_21接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_21)
public class KanrenshaKigyouDtHistory21Entity // NOPMD DataClass
