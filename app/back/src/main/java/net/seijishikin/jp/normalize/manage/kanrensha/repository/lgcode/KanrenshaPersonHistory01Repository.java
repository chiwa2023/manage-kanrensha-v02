...
public interface KanrenshaPersonHistory01Repository extends JpaRepository<KanrenshaPersonHistory01Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory01Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory01Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
