 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory29ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory29Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory29Repository 関連者企業履歴29Repository
     */
    public DumpKanrenshaKigyouDtHistory29ItemReader(
            final @Autowired KanrenshaKigyouDtHistory29Repository partnerCorpHistory29Repository) {

        super(partnerCorpHistory29Repository, new HashMap<String, Direction>());
