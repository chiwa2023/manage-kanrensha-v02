 ...
 */
@Component
public class KanrenshaPersonAddMiniWkTblFixItemReader extends RepositoryItemReader<WkTblKanrenshaPersonAddMinResultEntity> {
    ...
    public KanrenshaPersonAddMiniWkTblFixItemReader(
        ...
        super();
        super.setRepository(wkTblKanrenshaPersonAddMinResultRepository);
