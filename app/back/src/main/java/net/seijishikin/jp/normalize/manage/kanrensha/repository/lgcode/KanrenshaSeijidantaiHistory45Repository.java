...
/**
 * kanrensha_seijidantai_history_45接続用Repository
 */
public interface KanrenshaSeijidantaiHistory45Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory45Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory45Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_45"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory45Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_45 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory45Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory45Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
