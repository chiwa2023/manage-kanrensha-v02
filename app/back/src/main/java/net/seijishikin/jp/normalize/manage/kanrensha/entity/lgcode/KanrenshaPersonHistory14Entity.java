...
/**
 * kanrensha_person_history_14接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_14)
public class KanrenshaPersonHistory14Entity // NOPMD DataClass
