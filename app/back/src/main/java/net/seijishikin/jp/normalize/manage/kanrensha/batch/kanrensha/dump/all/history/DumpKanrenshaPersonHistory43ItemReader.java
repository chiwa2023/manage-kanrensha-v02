 ...
 */
@Component
public class DumpKanrenshaPersonHistory43ItemReader extends RepositoryItemReader<KanrenshaPersonHistory43Entity> {
     ...
     */
    public DumpKanrenshaPersonHistory43ItemReader(
            final @Autowired KanrenshaPersonHistory43Repository partnerPersonHistory43Repository) {
        super(partnerPersonHistory43Repository, new HashMap<String, Direction>());
