...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する16
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory16ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory16Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory16Repository 関連者企業履歴16Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory16ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory16Repository partnerPoliOrgHistory16Repository) {
        super(partnerPoliOrgHistory16Repository, new HashMap<String, Direction>());
