...
/**
 * kanrensha_person_history_08接続用Repository
 */
public interface KanrenshaPersonHistory08Repository extends JpaRepository<KanrenshaPersonHistory08Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory08Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_08"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory08Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_08 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory08Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory08Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
