...
/**
 * kanrensha_seijidantai_history_11接続用Repository
 */
public interface KanrenshaSeijidantaiHistory11Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory11Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory11Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_11"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory11Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory11Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory11Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
