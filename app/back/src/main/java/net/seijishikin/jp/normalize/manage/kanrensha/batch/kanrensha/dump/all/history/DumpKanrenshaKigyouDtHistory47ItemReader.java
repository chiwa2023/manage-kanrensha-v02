 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory47ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory47Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory47Repository 関連者企業履歴47Repository
     */
    public DumpKanrenshaKigyouDtHistory47ItemReader(
            final @Autowired KanrenshaKigyouDtHistory47Repository partnerCorpHistory47Repository) {
        super(partnerCorpHistory47Repository, new HashMap<String, Direction>());
