...
/**
 * kanrensha_seijidantai_history_33接続用Repository
 */
public interface KanrenshaSeijidantaiHistory33Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory33Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory33Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_33"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory33Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_33 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory33Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory33Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
