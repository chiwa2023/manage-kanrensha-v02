 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory26ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory26Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory26Repository 関連者企業履歴26Repository
     */
    public DumpKanrenshaKigyouDtHistory26ItemReader(
            final @Autowired KanrenshaKigyouDtHistory26Repository partnerCorpHistory26Repository) {
        super(partnerCorpHistory26Repository, new HashMap<String, Direction>());
