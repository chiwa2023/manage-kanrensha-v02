...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する01
 */
@Component
public class DumpSabunKanrenshaPersonHistory01ItemReader extends RepositoryItemReader<KanrenshaPersonHistory01Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory01Repository 関連者企業履歴01Repository
     */
    public DumpSabunKanrenshaPersonHistory01ItemReader(
            final @Autowired KanrenshaPersonHistory01Repository partnerPersonHistory01Repository) {
        super(partnerPersonHistory01Repository, new HashMap<String, Direction>());
