...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する42
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory42ItemReader
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory42ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory42Repository partnerPoliOrgHistory42Repository) {
        super(partnerPoliOrgHistory42Repository, new HashMap<String, Direction>());
