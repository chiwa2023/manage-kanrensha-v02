 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory24ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory24Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory24Repository 関連者企業履歴24Repository
     */
    public DumpKanrenshaKigyouDtHistory24ItemReader(
            final @Autowired KanrenshaKigyouDtHistory24Repository partnerCorpHistory24Repository) {
        super(partnerCorpHistory24Repository, new HashMap<String, Direction>());
