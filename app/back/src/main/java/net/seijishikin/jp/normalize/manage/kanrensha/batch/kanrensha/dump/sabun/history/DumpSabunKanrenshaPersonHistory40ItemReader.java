...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する40
 */
@Component
public class DumpSabunKanrenshaPersonHistory40ItemReader extends RepositoryItemReader<KanrenshaPersonHistory40Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory40Repository 関連者企業履歴40Repository
     */
    public DumpSabunKanrenshaPersonHistory40ItemReader(
            final @Autowired KanrenshaPersonHistory40Repository partnerPersonHistory40Repository) {

        super(partnerPersonHistory40Repository, new HashMap<String, Direction>());
