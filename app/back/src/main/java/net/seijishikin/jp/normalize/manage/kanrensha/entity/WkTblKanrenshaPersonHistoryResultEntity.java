...
/**
 * wk_tbl_kanrensha_person_history_result接続用Entity
 */
@Entity
@Table(name = "wk_tbl_kanrensha_person_history_result")
public class WkTblKanrenshaPersonHistoryResultEntity // NOPMD DataClass
    ...
    @Column(name = "wk_kanrensha_person_history_result_id")
    private Integer wkKanrenshaPersonHistoryResultId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkKanrenshaPersonHistoryResultId() {
        return wkKanrenshaPersonHistoryResultId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkKanrenshaPersonHistoryResultId テーブルId
     */
    public void setWkKanrenshaPersonHistoryResultId(final Integer wkKanrenshaPersonHistoryResultId) {
        this.wkKanrenshaPersonHistoryResultId = wkKanrenshaPersonHistoryResultId;
    }
     ...
     * 関連者企業・団体履歴Idを設定する
     *
     * @param wkKanrenshaPersonHistoryId 関連者企業・団体履歴Id
     */
