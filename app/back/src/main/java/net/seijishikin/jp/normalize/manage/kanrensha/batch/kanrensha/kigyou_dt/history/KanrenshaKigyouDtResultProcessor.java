 ...
 */
@Component
public class KanrenshaKigyouDtResultProcessor
        implements ItemProcessor<WkTblKanrenshaKigyouDtHistoryEntity, WkTblKanrenshaKigyouDtHistoryResultEntity> {
     ...
     */
    @Override
    public WkTblKanrenshaKigyouDtHistoryResultEntity process(final WkTblKanrenshaKigyouDtHistoryEntity item) throws Exception {
