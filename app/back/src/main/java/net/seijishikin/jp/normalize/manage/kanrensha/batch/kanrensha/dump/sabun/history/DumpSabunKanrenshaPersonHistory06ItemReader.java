...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する06
 */
@Component
public class DumpSabunKanrenshaPersonHistory06ItemReader extends RepositoryItemReader<KanrenshaPersonHistory06Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory06Repository 関連者企業履歴06Repository
     */
    public DumpSabunKanrenshaPersonHistory06ItemReader(
            final @Autowired KanrenshaPersonHistory06Repository partnerPersonHistory06Repository) {
        super(partnerPersonHistory06Repository, new HashMap<String, Direction>());
