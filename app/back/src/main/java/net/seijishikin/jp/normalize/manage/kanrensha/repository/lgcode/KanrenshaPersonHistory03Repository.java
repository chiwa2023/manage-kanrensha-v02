...
public interface KanrenshaPersonHistory03Repository extends JpaRepository<KanrenshaPersonHistory03Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory03Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory03Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
