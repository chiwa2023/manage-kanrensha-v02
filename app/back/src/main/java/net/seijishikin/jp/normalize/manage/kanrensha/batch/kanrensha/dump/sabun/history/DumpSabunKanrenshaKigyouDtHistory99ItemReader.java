...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する99
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory99ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory99Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory99Repository 関連者企業履歴99Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory99ItemReader(
            final @Autowired KanrenshaKigyouDtHistory99Repository kanrenshaKigyouDtHistory99Repository) {
        super(kanrenshaKigyouDtHistory99Repository, new HashMap<String, Direction>());
