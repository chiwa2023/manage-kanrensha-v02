...
/**
 * kanrensha_seijidantai_history_22接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_22)
public class KanrenshaSeijidantaiHistory22Entity // NOPMD DataClass
