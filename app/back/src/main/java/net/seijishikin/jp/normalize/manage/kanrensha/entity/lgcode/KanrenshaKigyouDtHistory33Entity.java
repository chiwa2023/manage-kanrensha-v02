...
/**
 * kanrensha_kigyou_dt_history_33接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_33)
public class KanrenshaKigyouDtHistory33Entity // NOPMD DataClass
