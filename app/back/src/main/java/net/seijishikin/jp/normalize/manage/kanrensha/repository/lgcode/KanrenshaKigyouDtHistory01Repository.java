...
public interface KanrenshaKigyouDtHistory01Repository extends JpaRepository<KanrenshaKigyouDtHistory01Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory01Entity, Integer> {
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory01Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
