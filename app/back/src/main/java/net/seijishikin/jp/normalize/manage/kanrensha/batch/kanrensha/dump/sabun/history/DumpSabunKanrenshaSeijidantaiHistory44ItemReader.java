...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する44
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory44ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory44Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory44Repository 関連者企業履歴44Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory44ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory44Repository partnerPoliOrgHistory44Repository) {
        super(partnerPoliOrgHistory44Repository, new HashMap<String, Direction>());
