...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する07
 */
@Component
public class DumpSabunKanrenshaPersonHistory07ItemReader extends RepositoryItemReader<KanrenshaPersonHistory07Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory07Repository 関連者企業履歴07Repository
     */
    public DumpSabunKanrenshaPersonHistory07ItemReader(
            final @Autowired KanrenshaPersonHistory07Repository partnerPersonHistory07Repository) {
        super(partnerPersonHistory07Repository, new HashMap<String, Direction>());
