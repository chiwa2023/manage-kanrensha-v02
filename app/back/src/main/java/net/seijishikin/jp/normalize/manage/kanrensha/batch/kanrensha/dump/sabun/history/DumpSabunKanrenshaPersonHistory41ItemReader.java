...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する41
 */
@Component
public class DumpSabunKanrenshaPersonHistory41ItemReader extends RepositoryItemReader<KanrenshaPersonHistory41Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory41Repository 関連者企業履歴41Repository
     */
    public DumpSabunKanrenshaPersonHistory41ItemReader(
            final @Autowired KanrenshaPersonHistory41Repository partnerPersonHistory41Repository) {
        super(partnerPersonHistory41Repository, new HashMap<String, Direction>());
