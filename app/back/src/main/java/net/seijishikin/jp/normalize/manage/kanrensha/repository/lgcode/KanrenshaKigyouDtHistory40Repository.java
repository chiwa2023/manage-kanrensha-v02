...
/**
 * kanrensha_kigyou_dt_history_40接続用Repository
 */
public interface KanrenshaKigyouDtHistory40Repository extends JpaRepository<KanrenshaKigyouDtHistory40Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory40Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_40"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory40Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_40 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory40Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory40Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
