...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する45
 */
@Component
public class DumpSabunKanrenshaPersonHistory45ItemReader extends RepositoryItemReader<KanrenshaPersonHistory45Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory45Repository 関連者企業履歴45Repository
     */
    public DumpSabunKanrenshaPersonHistory45ItemReader(
            final @Autowired KanrenshaPersonHistory45Repository partnerPersonHistory45Repository) {
        super(partnerPersonHistory45Repository, new HashMap<String, Direction>());
