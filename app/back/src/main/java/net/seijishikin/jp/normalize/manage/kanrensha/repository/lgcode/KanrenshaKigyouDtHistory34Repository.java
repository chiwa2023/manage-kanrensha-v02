...
/**
 * kanrensha_kigyou_dt_history_34接続用Repository
 */
public interface KanrenshaKigyouDtHistory34Repository extends JpaRepository<KanrenshaKigyouDtHistory34Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory34Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_34"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory34Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_34 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory34Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory34Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
