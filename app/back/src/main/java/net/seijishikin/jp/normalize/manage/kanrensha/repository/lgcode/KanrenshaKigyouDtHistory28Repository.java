...
/**
 * kanrensha_kigyou_dt_history_28接続用Repository
 */
public interface KanrenshaKigyouDtHistory28Repository extends JpaRepository<KanrenshaKigyouDtHistory28Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory28Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_28"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory28Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_28 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory28Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory28Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
