...
/**
 * kanrensha_seijidantai_history_43接続用Repository
 */
public interface KanrenshaSeijidantaiHistory43Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory43Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory43Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_43"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory43Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_43 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory43Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory43Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
