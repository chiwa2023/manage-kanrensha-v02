...
/**
 * kanrensha_person_history_32接続用Repository
 */
public interface KanrenshaPersonHistory32Repository extends JpaRepository<KanrenshaPersonHistory32Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory32Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_32"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory32Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_32 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory32Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory32Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
