...
/**
 * kanrensha_seijidantai_history_08接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_08)
public class KanrenshaSeijidantaiHistory08Entity // NOPMD DataClass
