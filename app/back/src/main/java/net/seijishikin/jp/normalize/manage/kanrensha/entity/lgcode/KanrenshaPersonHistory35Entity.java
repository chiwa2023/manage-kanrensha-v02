...
/**
 * kanrensha_person_history_35接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_35)
public class KanrenshaPersonHistory35Entity // NOPMD DataClass
