...
/**
 * kanrensha_person_history_47接続用Repository
 */
public interface KanrenshaPersonHistory47Repository extends JpaRepository<KanrenshaPersonHistory47Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory47Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_47"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory47Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_47 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory47Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory47Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
