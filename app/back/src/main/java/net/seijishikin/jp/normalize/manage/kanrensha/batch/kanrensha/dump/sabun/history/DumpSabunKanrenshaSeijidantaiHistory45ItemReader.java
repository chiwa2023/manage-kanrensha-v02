 ...
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory45ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory45Entity> {
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory45ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory45Repository partnerPoliOrgHistory45Repository) {
        super(partnerPoliOrgHistory45Repository, new HashMap<String, Direction>());
