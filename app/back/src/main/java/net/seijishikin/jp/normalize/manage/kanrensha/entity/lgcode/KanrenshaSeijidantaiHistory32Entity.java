...
/**
 * kanrensha_seijidantai_history_32接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_32)
public class KanrenshaSeijidantaiHistory32Entity // NOPMD DataClass
