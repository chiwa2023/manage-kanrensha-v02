...
import net.seijishikin.jp.normalize.manage.kanrensha.service.address_rsdt.EditWkTblRsdtDeleteService;
import net.seijishikin.jp.normalize.manage.kanrensha.service.util.SaveStackTraceService;

/**
 * 住居差分ワークテーブル削除編集Controller
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/wktbl-address-rsdt")
public class EditWkTblRsdtDeleteController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            ...
            int deleteCount = editWkTblRsdtDeleteService.practice(capsuleDto);
