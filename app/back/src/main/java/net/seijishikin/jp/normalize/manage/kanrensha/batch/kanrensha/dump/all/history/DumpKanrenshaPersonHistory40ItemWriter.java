 ...
 */
@Component
public class DumpKanrenshaPersonHistory40ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory40Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory40ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory40Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory40Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
