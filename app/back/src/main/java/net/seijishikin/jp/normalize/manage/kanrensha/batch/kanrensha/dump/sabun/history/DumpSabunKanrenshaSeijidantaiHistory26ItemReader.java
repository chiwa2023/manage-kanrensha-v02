...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する26
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory26ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory26Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory26Repository 関連者企業履歴26Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory26ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory26Repository partnerPoliOrgHistory26Repository) {
        super(partnerPoliOrgHistory26Repository, new HashMap<String, Direction>());
