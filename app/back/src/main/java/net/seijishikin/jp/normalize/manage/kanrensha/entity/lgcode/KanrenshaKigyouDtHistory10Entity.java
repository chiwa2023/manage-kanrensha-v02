...
/**
 * kanrensha_kigyou_dt_history_10接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_10)
public class KanrenshaKigyouDtHistory10Entity // NOPMD DataClass
