...
/**
 * kanrensha_person_history_11接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_11)
public class KanrenshaPersonHistory11Entity // NOPMD DataClass
