...
/**
 * kanrensha_person_history_43接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_43)
public class KanrenshaPersonHistory43Entity // NOPMD DataClass
