...
/**
 * kanrensha_seijidantai_history_14接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_14)
public class KanrenshaSeijidantaiHistory14Entity // NOPMD DataClass
