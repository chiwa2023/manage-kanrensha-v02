...
/**
 * kanrensha_seijidantai_history_18接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_18)
public class KanrenshaSeijidantaiHistory18Entity // NOPMD DataClass
