...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する38
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory38ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory38Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory38Repository 関連者企業履歴38Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory38ItemReader(
            final @Autowired KanrenshaKigyouDtHistory38Repository kanrenshaKigyouDtHistory38Repository) {
        super(kanrenshaKigyouDtHistory38Repository, new HashMap<String, Direction>());
