...
/**
 * kanrensha_seijidantai_history_43接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_43)
public class KanrenshaSeijidantaiHistory43Entity // NOPMD DataClass
