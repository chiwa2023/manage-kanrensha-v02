...
/**
 * kanrensha_person_history_37接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_37)
public class KanrenshaPersonHistory37Entity // NOPMD DataClass
