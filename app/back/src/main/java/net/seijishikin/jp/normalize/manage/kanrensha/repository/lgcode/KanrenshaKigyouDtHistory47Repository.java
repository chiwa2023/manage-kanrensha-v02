...
/**
 * kanrensha_kigyou_dt_history_47接続用Repository
 */
public interface KanrenshaKigyouDtHistory47Repository extends JpaRepository<KanrenshaKigyouDtHistory47Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory47Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_47"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory47Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_47 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory47Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory47Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
