...
/**
 * kanrensha_seijidantai_history_17接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_17)
public class KanrenshaSeijidantaiHistory17Entity // NOPMD DataClass
