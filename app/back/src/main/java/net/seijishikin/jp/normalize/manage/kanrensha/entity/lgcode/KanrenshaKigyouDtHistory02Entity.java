...
/**
 * kanrensha_kigyou_dt_history_02接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_02)
public class KanrenshaKigyouDtHistory02Entity // NOPMD DataClass
