...
/**
 * kanrensha_person_history_30接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_30)
public class KanrenshaPersonHistory30Entity // NOPMD DataClass
