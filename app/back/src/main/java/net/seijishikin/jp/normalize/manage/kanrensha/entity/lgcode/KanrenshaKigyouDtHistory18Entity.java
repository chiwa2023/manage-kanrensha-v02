...
/**
 * kanrensha_kigyou_dt_history_18接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_18)
public class KanrenshaKigyouDtHistory18Entity // NOPMD DataClass
