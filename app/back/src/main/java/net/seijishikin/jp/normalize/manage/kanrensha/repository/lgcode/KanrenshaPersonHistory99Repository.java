...
/**
 * kanrensha_person_history_99接続用Repository
 */
public interface KanrenshaPersonHistory99Repository extends JpaRepository<KanrenshaPersonHistory99Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory99Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_99"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory99Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_99 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory99Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory99Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
