 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory02ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory02Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory02Repository 関連者企業履歴02Repository
     */
    public DumpKanrenshaKigyouDtHistory02ItemReader(
            final @Autowired KanrenshaKigyouDtHistory02Repository partnerCorpHistory02Repository) {
        super(partnerCorpHistory02Repository, new HashMap<String, Direction>());
