...
public interface KanrenshaPersonHistory33Repository extends JpaRepository<KanrenshaPersonHistory33Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory33Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_33 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory33Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory33Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
