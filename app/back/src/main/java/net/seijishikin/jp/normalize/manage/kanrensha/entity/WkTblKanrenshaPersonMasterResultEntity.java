...
/**
 * wk_tbl_kanrensha_person_master_result接続用Entity
 */
@Entity
@Table(name = "wk_tbl_kanrensha_person_master_result")
public class WkTblKanrenshaPersonMasterResultEntity // NOPMD DataClass
    ...
    @Column(name = "wk_tbl_kanrensha_person_master_result_id")
    private Integer wkTblKanrenshaPersonMasterResultId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkTblKanrenshaPersonMasterResultId() {
        return wkTblKanrenshaPersonMasterResultId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkTblKanrenshaPersonMasterResultId テーブルId
     */
    public void setWkTblKanrenshaPersonMasterResultId(final Integer wkTblKanrenshaPersonMasterResultId) {
        this.wkTblKanrenshaPersonMasterResultId = wkTblKanrenshaPersonMasterResultId;
    }
     ...
     * ワークテーブルマスタIdを設定する
     *
     * @param wkTblKanrenshaPersonMasterId ワークテーブルマスタId
     */
