...
/**
 * kanrensha_seijidantai_history_31接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_31)
public class KanrenshaSeijidantaiHistory31Entity // NOPMD DataClass
