...
/**
 * kanrensha_seijidantai_history_36接続用Repository
 */
public interface KanrenshaSeijidantaiHistory36Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory36Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory36Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_36"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory36Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_36 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory36Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory36Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
