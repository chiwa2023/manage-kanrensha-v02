...
public interface KanrenshaPersonHistory42Repository extends JpaRepository<KanrenshaPersonHistory42Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory42Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_42 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory42Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory42Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
