...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する35
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory35ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory35Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory35Repository 関連者企業履歴35Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory35ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory35Repository partnerPoliOrgHistory35Repository) {
        super(partnerPoliOrgHistory35Repository, new HashMap<String, Direction>());
