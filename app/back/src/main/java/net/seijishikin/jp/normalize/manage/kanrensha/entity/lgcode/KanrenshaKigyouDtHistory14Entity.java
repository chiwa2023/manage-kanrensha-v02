...
/**
 * kanrensha_kigyou_dt_history_14接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_14)
public class KanrenshaKigyouDtHistory14Entity // NOPMD DataClass
