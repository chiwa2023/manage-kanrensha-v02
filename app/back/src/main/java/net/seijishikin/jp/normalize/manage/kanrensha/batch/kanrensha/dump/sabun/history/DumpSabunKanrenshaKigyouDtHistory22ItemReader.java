...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する22
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory22ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory22Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory22Repository 関連者企業履歴22Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory22ItemReader(
            final @Autowired KanrenshaKigyouDtHistory22Repository kanrenshaKigyouDtHistory22Repository) {
        super(kanrenshaKigyouDtHistory22Repository, new HashMap<String, Direction>());
