 ...
 */
@Component
public class DumpKanrenshaSeijidantaiHistory34ItemReader
     ...
     */
    public DumpKanrenshaSeijidantaiHistory34ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory34Repository partnerPoliOrgHistory34Repository) {
        super(partnerPoliOrgHistory34Repository, new HashMap<String, Direction>());
