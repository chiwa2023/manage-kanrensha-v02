...
/**
 * kanrensha_seijidantai_history_32接続用Repository
 */
public interface KanrenshaSeijidantaiHistory32Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory32Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory32Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_32"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory32Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_32 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory32Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory32Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
