...
/**
 * kanrensha_seijidantai_history_02接続用Repository
 */
public interface KanrenshaSeijidantaiHistory02Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory02Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory02Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_02"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory02Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_02 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory02Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
