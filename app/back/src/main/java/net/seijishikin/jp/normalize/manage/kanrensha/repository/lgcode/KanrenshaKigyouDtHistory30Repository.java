...
public interface KanrenshaKigyouDtHistory30Repository extends JpaRepository<KanrenshaKigyouDtHistory30Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory30Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_30 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory30Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory30Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
