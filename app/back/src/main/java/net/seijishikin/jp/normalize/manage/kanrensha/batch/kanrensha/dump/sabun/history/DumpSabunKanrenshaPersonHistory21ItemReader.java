...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する21
 */
@Component
public class DumpSabunKanrenshaPersonHistory21ItemReader extends RepositoryItemReader<KanrenshaPersonHistory21Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory21ItemReader(
            final @Autowired KanrenshaPersonHistory21Repository partnerPersonHistory21Repository) {
        super(partnerPersonHistory21Repository, new HashMap<String, Direction>());
