...
public interface KanrenshaKigyouDtHistory03Repository extends JpaRepository<KanrenshaKigyouDtHistory03Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory03Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_03 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory03Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory03Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
