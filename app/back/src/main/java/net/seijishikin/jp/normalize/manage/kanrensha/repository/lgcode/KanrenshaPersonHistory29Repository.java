...
public interface KanrenshaPersonHistory29Repository extends JpaRepository<KanrenshaPersonHistory29Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory29Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_29 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory29Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory29Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
