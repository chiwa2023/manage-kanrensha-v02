...
public interface KanrenshaPersonHistory20Repository extends JpaRepository<KanrenshaPersonHistory20Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory20Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_20 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory20Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory20Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
