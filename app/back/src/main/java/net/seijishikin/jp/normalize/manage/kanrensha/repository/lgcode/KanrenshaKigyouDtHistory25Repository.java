...
public interface KanrenshaKigyouDtHistory25Repository extends JpaRepository<KanrenshaKigyouDtHistory25Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory25Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_25 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory25Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory25Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
