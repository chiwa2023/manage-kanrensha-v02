...
/**
 * kanrensha_person_address接続用Entity
 */
@Entity
@Table(name = "kanrensha_person_address")
public class KanrenshaPersonAddressEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "kanrensha_person_address_id")
    private Integer kanrenshaPersonAddressId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getKanrenshaPersonAddressId() {
        return kanrenshaPersonAddressId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param kanrenshaPersonAddressId テーブルId
     */
    public void setKanrenshaPersonAddressId(final Integer kanrenshaPersonAddressId) {
        this.kanrenshaPersonAddressId = kanrenshaPersonAddressId;
    }
