...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する20
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory20ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory20Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory20Repository 関連者企業履歴20Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory20ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory20Repository partnerPoliOrgHistory20Repository) {
        super(partnerPoliOrgHistory20Repository, new HashMap<String, Direction>());
