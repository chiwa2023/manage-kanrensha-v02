 ...
 */
@Component
public class DumpKanrenshaPersonHistory26ItemWriter extends FlatFileItemWriter<KanrenshaPersonHistory26Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaPersonHistory26ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaPersonHistory26Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaPersonHistory26Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
