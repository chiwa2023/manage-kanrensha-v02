 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory40ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory40Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory40Repository 関連者企業履歴40Repository
     */
    public DumpKanrenshaKigyouDtHistory40ItemReader(
            final @Autowired KanrenshaKigyouDtHistory40Repository partnerCorpHistory40Repository) {
        super(partnerCorpHistory40Repository, new HashMap<String, Direction>());
