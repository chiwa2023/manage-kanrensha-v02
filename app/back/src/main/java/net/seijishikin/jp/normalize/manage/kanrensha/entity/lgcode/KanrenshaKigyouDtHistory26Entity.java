...
/**
 * kanrensha_kigyou_dt_history_26接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_26)
public class KanrenshaKigyouDtHistory26Entity // NOPMD DataClass
