...
/**
 * kanrensha_person_history_15接続用Repository
 */
public interface KanrenshaPersonHistory15Repository extends JpaRepository<KanrenshaPersonHistory15Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory15Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_15"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory15Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_15 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory15Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory15Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
