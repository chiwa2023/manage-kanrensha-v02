...
import net.seijishikin.jp.normalize.manage.kanrensha.service.regist_bulk_master_std.ExecuteBatchMasterStdSeijidantaiService;
...
public class ExecuteBatchMasterStdSeijidantaiController {

    /** 非同期処理登録専用Service */
    @Autowired
    private ExecuteBatchMasterStdSeijidantaiService executeBatchMasterStdSeijidantaiService;
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            ...
            TaskPlanWithUseFileDto planFileDto = copyTempToUseSavedFileService.practice(dateTimeStart,
                    ...
                    TaskInfoConstants.FILE_SEIJIDANTAI_STD, mapParam);
            taskPlanCode = planFileDto.getTaskPlanCode();

            executeBatchMasterStdSeijidantaiService.practice(year, capsuleDto.getUserDto(), planFileDto);
