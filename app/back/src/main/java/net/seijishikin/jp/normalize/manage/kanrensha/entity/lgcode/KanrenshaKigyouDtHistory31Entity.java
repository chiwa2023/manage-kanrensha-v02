...
/**
 * kanrensha_kigyou_dt_history_31接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_31)
public class KanrenshaKigyouDtHistory31Entity // NOPMD DataClass
