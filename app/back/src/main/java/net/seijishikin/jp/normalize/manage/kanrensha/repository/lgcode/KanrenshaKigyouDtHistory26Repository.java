...
/**
 * kanrensha_kigyou_dt_history_26接続用Repository
 */
public interface KanrenshaKigyouDtHistory26Repository extends JpaRepository<KanrenshaKigyouDtHistory26Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory26Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_26"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory26Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_26 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory26Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory26Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
