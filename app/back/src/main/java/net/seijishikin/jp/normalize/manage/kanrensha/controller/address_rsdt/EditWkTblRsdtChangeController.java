...
import net.seijishikin.jp.normalize.manage.kanrensha.service.address_rsdt.EditWkTblRsdtChangeService;
import net.seijishikin.jp.normalize.manage.kanrensha.service.util.SaveStackTraceService;

/**
 * アドレス・ベース・レジストリ変更編集Controller
 */
@RestController
@RequestMapping(PathRouteConstants.ROOT + "/wktbl-address-rsdt")
public class EditWkTblRsdtChangeController {

    /** アドレス・ベース・レジストリ変更編集Service */
    @Autowired
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(
        ...
        try {
            ...
            int deleteCount = editWkTblRsdtChangeService.practice(capsuleDto);
