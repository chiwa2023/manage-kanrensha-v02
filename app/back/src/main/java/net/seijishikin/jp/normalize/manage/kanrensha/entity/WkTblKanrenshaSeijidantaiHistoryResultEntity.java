...
/**
 * wk_tbl_kanrensha_seijidantai_history_result接続用Entity
 */
@Entity
@Table(name = "wk_tbl_kanrensha_seijidantai_history_result")
public class WkTblKanrenshaSeijidantaiHistoryResultEntity // NOPMD DataClass
    ...
    @Column(name = "wk_kanrensha_seijidantai_history_result_id")
    private Integer wkKanrenshaSeijidantaiHistoryResultId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkKanrenshaSeijidantaiHistoryResultId() {
        return wkKanrenshaSeijidantaiHistoryResultId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkKanrenshaSeijidantaiHistoryResultId テーブルId
     */
    public void setWkKanrenshaSeijidantaiHistoryResultId(final Integer wkKanrenshaSeijidantaiHistoryResultId) {
        this.wkKanrenshaSeijidantaiHistoryResultId = wkKanrenshaSeijidantaiHistoryResultId;
    }
     ...
     * 関連者企業・団体履歴Idを設定する
     *
     * @param wkKanrenshaSeijidantaiHistoryId 関連者企業・団体履歴Id
     */
