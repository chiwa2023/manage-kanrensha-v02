...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する10
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory10ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory10Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory10Repository 関連者企業履歴10Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory10ItemReader(
            final @Autowired KanrenshaKigyouDtHistory10Repository kanrenshaKigyouDtHistory10Repository) {
        super(kanrenshaKigyouDtHistory10Repository, new HashMap<String, Direction>());
