...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する37
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory37ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory37Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory37Repository 関連者企業履歴37Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory37ItemReader(
            final @Autowired KanrenshaKigyouDtHistory37Repository kanrenshaKigyouDtHistory37Repository) {
        super(kanrenshaKigyouDtHistory37Repository, new HashMap<String, Direction>());
