...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する01
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory01ItemReader
     ...
     */
    public DumpSabunKanrenshaSeijidantaiHistory01ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory01Repository partnerPoliOrgHistory01Repository) {
        super(partnerPoliOrgHistory01Repository, new HashMap<String, Direction>());
