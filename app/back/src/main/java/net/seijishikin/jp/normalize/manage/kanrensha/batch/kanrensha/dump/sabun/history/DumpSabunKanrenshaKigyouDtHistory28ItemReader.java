...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する28
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory28ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory28Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory28Repository 関連者企業履歴28Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory28ItemReader(
            final @Autowired KanrenshaKigyouDtHistory28Repository kanrenshaKigyouDtHistory28Repository) {
        super(kanrenshaKigyouDtHistory28Repository, new HashMap<String, Direction>());
