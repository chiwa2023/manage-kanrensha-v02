...
/**
 * kanrensha_seijidantai_history_37接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_37)
public class KanrenshaSeijidantaiHistory37Entity // NOPMD DataClass
