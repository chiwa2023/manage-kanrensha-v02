...
/**
 * kanrensha_person_history_06接続用Repository
 */
public interface KanrenshaPersonHistory06Repository extends JpaRepository<KanrenshaPersonHistory06Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory06Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_06"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory06Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_06 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory06Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory06Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
