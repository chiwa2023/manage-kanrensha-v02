...
/**
 * kanrensha_seijidantai_history_01接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_01)
public class KanrenshaSeijidantaiHistory01Entity // NOPMD DataClass
