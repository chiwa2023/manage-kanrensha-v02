...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する36
 */
@Component
public class DumpSabunKanrenshaPersonHistory36ItemReader extends RepositoryItemReader<KanrenshaPersonHistory36Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory36Repository 関連者企業履歴36Repository
     */
    public DumpSabunKanrenshaPersonHistory36ItemReader(
            final @Autowired KanrenshaPersonHistory36Repository partnerPersonHistory36Repository) {
        super(partnerPersonHistory36Repository, new HashMap<String, Direction>());
