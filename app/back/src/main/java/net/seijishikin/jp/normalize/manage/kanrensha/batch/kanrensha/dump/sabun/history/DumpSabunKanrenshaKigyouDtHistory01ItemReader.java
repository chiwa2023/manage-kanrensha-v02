...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する01
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory01ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory01Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory01Repository 関連者企業履歴01Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory01ItemReader(
            final @Autowired KanrenshaKigyouDtHistory01Repository kanrenshaKigyouDtHistory01Repository) {
        super(kanrenshaKigyouDtHistory01Repository, new HashMap<String, Direction>());
