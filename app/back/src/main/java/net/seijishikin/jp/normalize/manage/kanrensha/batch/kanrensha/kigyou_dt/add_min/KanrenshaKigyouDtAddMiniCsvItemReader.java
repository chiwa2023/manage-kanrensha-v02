 ...
 */
@Component
public class KanrenshaKigyouDtAddMiniCsvItemReader extends FlatFileItemReader<KanrenshaKigyouDtAddMiniDto> {
     ...
     */
    public KanrenshaKigyouDtAddMiniCsvItemReader(final @Autowired KanrenshaKigyouDtAddMiniLineMapper lineMapper) {
        super();
