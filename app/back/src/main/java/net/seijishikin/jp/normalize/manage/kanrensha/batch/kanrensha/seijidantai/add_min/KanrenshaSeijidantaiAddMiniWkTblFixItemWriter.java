 ...
 */
@Component
public class KanrenshaSeijidantaiAddMiniWkTblFixItemWriter extends JpaItemWriter<WkTblKanrenshaSeijidantaiAddMinEntity> {
     ...
     */
    public KanrenshaSeijidantaiAddMiniWkTblFixItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
