...
/**
 * wk_tbl_address_rsdt_change接続用Entity
 */
@Entity
@Table(name = "wk_tbl_address_rsdt_change")
public class WkTblAddressRsdtChangeEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "wk_tbl_address_rsdt_change_id")
    private Integer wkTblAddressRsdtChangeId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkTblAddressRsdtChangeId() {
        return wkTblAddressRsdtChangeId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkTblAddressRsdtChangeId テーブルId
     */
    public void setWkTblAddressRsdtChangeId(final Integer wkTblAddressRsdtChangeId) {
        this.wkTblAddressRsdtChangeId = wkTblAddressRsdtChangeId;
    }
