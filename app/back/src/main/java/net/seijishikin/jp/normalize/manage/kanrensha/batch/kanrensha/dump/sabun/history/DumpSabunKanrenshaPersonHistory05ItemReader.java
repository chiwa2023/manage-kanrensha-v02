 ...
 */
@Component
public class DumpSabunKanrenshaPersonHistory05ItemReader extends RepositoryItemReader<KanrenshaPersonHistory05Entity> {
     ...
     */
    public DumpSabunKanrenshaPersonHistory05ItemReader(
            final @Autowired KanrenshaPersonHistory05Repository partnerPersonHistory05Repository) {
        super(partnerPersonHistory05Repository, new HashMap<String, Direction>());
