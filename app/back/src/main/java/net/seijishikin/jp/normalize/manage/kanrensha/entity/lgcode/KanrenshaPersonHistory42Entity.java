...
/**
 * kanrensha_person_history_42接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_42)
public class KanrenshaPersonHistory42Entity // NOPMD DataClass
