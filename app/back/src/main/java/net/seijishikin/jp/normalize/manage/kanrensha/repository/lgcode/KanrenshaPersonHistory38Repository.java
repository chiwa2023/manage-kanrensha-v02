...
/**
 * kanrensha_person_history_38接続用Repository
 */
public interface KanrenshaPersonHistory38Repository extends JpaRepository<KanrenshaPersonHistory38Entity, Integer>,
        PagingAndSortingRepository<KanrenshaPersonHistory38Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_38"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaPersonHistory38Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_person_history_38 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory38Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaPersonHistory38Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
