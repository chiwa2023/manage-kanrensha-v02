...
/**
 * kanrensha_kigyou_dt_history_18接続用Repository
 */
public interface KanrenshaKigyouDtHistory18Repository extends JpaRepository<KanrenshaKigyouDtHistory18Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory18Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_18"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory18Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_18 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory18Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory18Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
