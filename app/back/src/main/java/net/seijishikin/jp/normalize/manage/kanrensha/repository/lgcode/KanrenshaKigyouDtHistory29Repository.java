...
/**
 * kanrensha_kigyou_dt_history_29接続用Repository
 */
public interface KanrenshaKigyouDtHistory29Repository extends JpaRepository<KanrenshaKigyouDtHistory29Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory29Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_29"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory29Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_29 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory29Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
