...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する33
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory33ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory33Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory33Repository 関連者企業履歴33Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory33ItemReader(
            final @Autowired KanrenshaKigyouDtHistory33Repository kanrenshaKigyouDtHistory33Repository) {
        super(kanrenshaKigyouDtHistory33Repository, new HashMap<String, Direction>());
