...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する30
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory30ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory30Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory30Repository 関連者企業履歴30Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory30ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory30Repository partnerPoliOrgHistory30Repository) {
        super(partnerPoliOrgHistory30Repository, new HashMap<String, Direction>());
