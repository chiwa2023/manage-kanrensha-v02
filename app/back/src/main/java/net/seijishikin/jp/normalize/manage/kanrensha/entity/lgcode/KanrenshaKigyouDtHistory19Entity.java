...
/**
 * kanrensha_kigyou_dt_history_19接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_19)
public class KanrenshaKigyouDtHistory19Entity // NOPMD DataClass
