 ...
 */
@Component
public class DumpKanrenshaSeijidantaiHistory32ItemReader
     ...
     */
    public DumpKanrenshaSeijidantaiHistory32ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory32Repository partnerPoliOrgHistory32Repository) {
        super(partnerPoliOrgHistory32Repository, new HashMap<String, Direction>());
