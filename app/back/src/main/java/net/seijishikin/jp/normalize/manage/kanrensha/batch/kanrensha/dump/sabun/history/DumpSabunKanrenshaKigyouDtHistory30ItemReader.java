...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する30
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory30ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory30Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory30Repository 関連者企業履歴30Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory30ItemReader(
            final @Autowired KanrenshaKigyouDtHistory30Repository kanrenshaKigyouDtHistory30Repository) {
        super(kanrenshaKigyouDtHistory30Repository, new HashMap<String, Direction>());
