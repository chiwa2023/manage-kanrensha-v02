...
/**
 * kanrensha_seijidantai_history_46接続用Repository
 */
public interface KanrenshaSeijidantaiHistory46Repository
        extends JpaRepository<KanrenshaSeijidantaiHistory46Entity, Integer>,
        PagingAndSortingRepository<KanrenshaSeijidantaiHistory46Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_46"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory46Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_46 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory46Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory46Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
