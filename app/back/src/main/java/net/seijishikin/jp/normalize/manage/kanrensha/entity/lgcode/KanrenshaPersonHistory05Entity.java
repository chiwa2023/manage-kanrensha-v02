...
/**
 * kanrensha_person_history_05接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_05)
public class KanrenshaPersonHistory05Entity // NOPMD DataClass
