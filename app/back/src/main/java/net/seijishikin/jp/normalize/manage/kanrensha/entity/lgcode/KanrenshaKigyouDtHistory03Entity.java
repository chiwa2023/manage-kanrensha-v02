...
/**
 * kanrensha_kigyou_dt_history_03接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_03)
public class KanrenshaKigyouDtHistory03Entity // NOPMD DataClass
