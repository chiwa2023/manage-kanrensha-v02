...
/**
 * kanrensha_seijidantai_history_34接続用Entity
 */
@Entity
@Table(name = KanrenshaSeijidantaiTableConstants.KANRENSHA_HISTORY_TABLE_SEIJIDANTAII_34)
public class KanrenshaSeijidantaiHistory34Entity // NOPMD DataClass
