...
/**
 * 開始日時以上かつ終了日時より小さい関連者個人最新履歴差分データを取得する27
 */
@Component
public class DumpSabunKanrenshaPersonHistory27ItemReader extends RepositoryItemReader<KanrenshaPersonHistory27Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPersonHistory27Repository 関連者企業履歴27Repository
     */
    public DumpSabunKanrenshaPersonHistory27ItemReader(
            final @Autowired KanrenshaPersonHistory27Repository partnerPersonHistory27Repository) {
        super(partnerPersonHistory27Repository, new HashMap<String, Direction>());
