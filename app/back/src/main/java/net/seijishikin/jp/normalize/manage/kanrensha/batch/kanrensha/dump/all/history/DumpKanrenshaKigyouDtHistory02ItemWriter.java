 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory02ItemWriter extends FlatFileItemWriter<KanrenshaKigyouDtHistory02Entity> {

    /**
     * コンストラクタ
     */
    public DumpKanrenshaKigyouDtHistory02ItemWriter() {
        super();
        DelimitedLineAggregator<KanrenshaKigyouDtHistory02Entity> lineAggregator = new DelimitedLineAggregator<>();
        lineAggregator.setDelimiter(","); // 区切り文字をカンマに設定
        lineAggregator.setQuoteCharacter("\"");
        BeanWrapperFieldExtractor<KanrenshaKigyouDtHistory02Entity> fieldExtractor = new BeanWrapperFieldExtractor<>();
