 ...
 */
@Service
public class SearchBulkHistorySeijidantaiService {
     ...
     * @return 検索結果
     */
    public SearchWkTblHistorySeijidantaiPagingResultDto practice(final SearchWkTbPagingCapsuleDto capsuleDto) {
        ...
        Integer allCount = wkTblKanrenshaSeijidantaiHistoryRepository
        ...
        SearchWkTblHistorySeijidantaiPagingResultDto resultDto = new SearchWkTblHistorySeijidantaiPagingResultDto();
        resultDto.setAllCount(allCount);
        resultDto.setLimit(limit);
        resultDto.setPageNumber(pageNumber);
        resultDto.setListWktblSeijidantai(wkTblKanrenshaSeijidantaiHistoryRepository
