...
public interface KanrenshaSeijidantaiHistory03Repository
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_seijidantai_history_03"
            + " WHERE search_text LIKE ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaSeijidantaiHistory03Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    Page<KanrenshaSeijidantaiHistory03Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime, boolean isLatest,
            Pageable pageable);
