...
/**
 * kanrensha_person_history_18接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_18)
public class KanrenshaPersonHistory18Entity // NOPMD DataClass
