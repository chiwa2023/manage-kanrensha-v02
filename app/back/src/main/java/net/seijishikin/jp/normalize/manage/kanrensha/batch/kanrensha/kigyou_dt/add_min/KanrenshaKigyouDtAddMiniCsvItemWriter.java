...
/**
 * 関連者企業・団体最小登録CsvItemReaer
 */
@Component
public class KanrenshaKigyouDtAddMiniCsvItemWriter extends JpaItemWriter<WkTblKanrenshaKigyouDtAddMinEntity> {
     ...
     */
    public KanrenshaKigyouDtAddMiniCsvItemWriter(final @Autowired EntityManagerFactory entityManagerFactory) {
        super();
