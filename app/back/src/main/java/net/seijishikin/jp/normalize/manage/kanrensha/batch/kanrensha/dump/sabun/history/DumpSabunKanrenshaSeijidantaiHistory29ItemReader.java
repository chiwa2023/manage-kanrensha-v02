...
/**
 * 開始日時以上かつ終了日時より小さい関連者政治団体最新履歴差分データを取得する29
 */
@Component
public class DumpSabunKanrenshaSeijidantaiHistory29ItemReader
        extends RepositoryItemReader<KanrenshaSeijidantaiHistory29Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerPoliOrgHistory29Repository 関連者企業履歴29Repository
     */
    public DumpSabunKanrenshaSeijidantaiHistory29ItemReader(
            final @Autowired KanrenshaSeijidantaiHistory29Repository partnerPoliOrgHistory29Repository) {
        super(partnerPoliOrgHistory29Repository, new HashMap<String, Direction>());
