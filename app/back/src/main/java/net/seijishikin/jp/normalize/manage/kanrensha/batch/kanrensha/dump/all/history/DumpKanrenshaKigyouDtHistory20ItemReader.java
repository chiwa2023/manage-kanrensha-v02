 ...
 */
@Component
public class DumpKanrenshaKigyouDtHistory20ItemReader extends RepositoryItemReader<KanrenshaKigyouDtHistory20Entity> {

    /**
     * コンストラクタ
     *
     * @param partnerCorpHistory20Repository 関連者企業履歴20Repository
     */
    public DumpKanrenshaKigyouDtHistory20ItemReader(
            final @Autowired KanrenshaKigyouDtHistory20Repository partnerCorpHistory20Repository) {
        super(partnerCorpHistory20Repository, new HashMap<String, Direction>());
