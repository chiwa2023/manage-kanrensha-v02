...
/**
 * 開始日時以上かつ終了日時より小さい関連者企業・団体最新履歴差分データを取得する07
 */
@Component
public class DumpSabunKanrenshaKigyouDtHistory07ItemReader
        extends RepositoryItemReader<KanrenshaKigyouDtHistory07Entity> {

    /**
     * コンストラクタ
     *
     * @param kanrenshaKigyouDtHistory07Repository 関連者企業履歴07Repository
     */
    public DumpSabunKanrenshaKigyouDtHistory07ItemReader(
            final @Autowired KanrenshaKigyouDtHistory07Repository kanrenshaKigyouDtHistory07Repository) {
        super(kanrenshaKigyouDtHistory07Repository, new HashMap<String, Direction>());
