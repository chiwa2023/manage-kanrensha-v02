...
/**
 * wk_tbl_kanrensha_seijidantai_master_result接続用Entity
 */
@Entity
@Table(name = "wk_tbl_kanrensha_seijidantai_master_result")
public class WkTblKanrenshaSeijidantaiMasterResultEntity // NOPMD DataClass
    ...
    @Column(name = "wk_tbl_kanrensha_seijidantai_master_result_id")
    private Integer wkTblKanrenshaSeijidantaiMasterResultId = INIT_INTEGER;
     ...
     * @return テーブルId
     */
    public Integer getWkTblKanrenshaSeijidantaiMasterResultId() {
        return wkTblKanrenshaSeijidantaiMasterResultId;
    }

    /**
     * テーブルIdを設定する
     *
     * @param wkTblKanrenshaSeijidantaiMasterResultId テーブルId
     */
    public void setWkTblKanrenshaSeijidantaiMasterResultId(final Integer wkTblKanrenshaSeijidantaiMasterResultId) {
        this.wkTblKanrenshaSeijidantaiMasterResultId = wkTblKanrenshaSeijidantaiMasterResultId;
    }
     ...
     * ワークテーブルマスタIdを設定する
     *
     * @param wkTblKanrenshaSeijidantaiMasterId ワークテーブルマスタId
     */
