...
/**
 * kanrensha_kigyou_dt_history_16接続用Repository
 */
public interface KanrenshaKigyouDtHistory16Repository extends JpaRepository<KanrenshaKigyouDtHistory16Entity, Integer>,
        PagingAndSortingRepository<KanrenshaKigyouDtHistory16Entity, Integer> {
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_16"
            + " WHERE search_text like ?1 AND is_latest=1", nativeQuery = true) // TODO MATCH AGAINST
    List<KanrenshaKigyouDtHistory16Entity> findFullText(String searchWords);
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM kanrensha_kigyou_dt_history_16 " + " WHERE all_name = ?1 AND all_address = ?2 "
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory16Entity> findByInsertTimestampLessThanAndIsLatest(LocalDateTime dateTime,
     ...
     * @return 検索結果
     */
    Page<KanrenshaKigyouDtHistory16Entity> findByInsertTimestampGreaterThanEqualAndInsertTimestampLessThanAndIsLatest(
