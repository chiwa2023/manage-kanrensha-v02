...
/**
 * kanrensha_kigyou_dt_history_12接続用Entity
 */
@Entity
@Table(name = KanrenshaKigyouDtTableConstants.KANRENSHA_HISTORY_TABLE_KIGYOU_12)
public class KanrenshaKigyouDtHistory12Entity // NOPMD DataClass
