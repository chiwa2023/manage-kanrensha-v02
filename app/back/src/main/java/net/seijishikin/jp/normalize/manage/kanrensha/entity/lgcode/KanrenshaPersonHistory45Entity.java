...
/**
 * kanrensha_person_history_45接続用Entity
 */
@Entity
@Table(name = KanrenshaPersonTableConstants.KANRENSHA_HISTORY_TABLE_PERSON_45)
public class KanrenshaPersonHistory45Entity // NOPMD DataClass
