...
import net.seijishikin.jp.normalize.manage.kanrensha.service.postal.DeletePostalCodeService;
...
public class DeletePostalCodeController {
    ...
    public ResponseEntity<FrameworkMessageAndResultDto> practice(final @RequestBody SavePostalCapsuleDto capsuleDto) {
        ...
        try {
            ...
            int deleteCount = deletePostalCodeService.practice(capsuleDto);
