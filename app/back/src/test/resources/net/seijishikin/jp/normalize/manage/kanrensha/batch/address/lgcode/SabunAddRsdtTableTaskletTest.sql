DROP TABLE IF EXISTS address_rsdt_368521;
DROP TABLE IF EXISTS address_rsdt_695123;
DROP TABLE IF EXISTS address_rsdt_827637;
...
CREATE TABLE IF NOT EXISTS `address_rsdt_368521` (
