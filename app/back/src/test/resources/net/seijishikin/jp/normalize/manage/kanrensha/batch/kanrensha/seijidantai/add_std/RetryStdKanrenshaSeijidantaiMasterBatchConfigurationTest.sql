...
(7001, 7001, 1, 0, '自由民主党', '東京都千代田区永田町1-11-23', '総裁K', 'A1', '10001', '100-8910', '千代田区永田町', '1-11-23', '100', '8910', '131016', '0001', '0001', '0001', '0001', '03', '3595', '1111', 'ldp@example.com', 'http://www.jimin.jp/', 'Twitter', '@jimin_koho', 'ジユウミンシュトウ', 'D011', 'A001', '会計責任者1', 1,1,  '正)', 1, 190, 'gemini-user', NOW()),
(7002, 7002, 1, 0, '立憲民主党', '東京都千代田区平河町2-12-4', '代表L', 'A1', '10002', '100-0010', '千代田区平河町', '2-12-4', '100', '0010', '131016', '0002', '0002', '0002', '0002', '03', '3595', '2222', 'cdp@example.com', 'http://cdp-japan.jp/', 'Facebook', 'cdp.japan', 'リッケンミンシュトウ', 'D012', 'A002', '会計責任者2', 1,1,  '正)', 1, 190, 'gemini-user', NOW()),
