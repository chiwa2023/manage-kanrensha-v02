...
DELETE FROM `wk_tbl_kanrensha_kigyou_dt_master_result`;
ALTER TABLE `wk_tbl_kanrensha_kigyou_dt_master_result` auto_increment = 0;
...
INSERT INTO `user_role` (`user_role_id`,`email`,`is_latest`,`role`,`kanrensha_code`,`riyousha_code`,`insert_user_id`,`insert_user_code`,`insert_user_name`,`insert_timestamp`,`delete_user_id`,`delete_user_code`,`delete_user_name`,`delete_timestamp`)
  ...
  ,(190,'ccc@politician.balanse.report.net',1,'kanrensha_kigyou_dt','',0,1,1,'aaa','2026-01-05 20:15:48',0,0,'','1948-07-28 22:59:59')
  ;
