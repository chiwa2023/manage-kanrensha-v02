CREATE TABLE IF NOT EXISTS `address_rsdt_131016` (
...
DELETE FROM `address_rsdt_131016`;
ALTER TABLE `address_rsdt_131016` auto_increment = 0;

INSERT INTO `address_rsdt_131016` (`address_rsdt_id`,`lg_code`,`postalcode1`,`postalcode2`,`is_latest`,`address_block`,`address_building`,`machiaza_id`,`blk_id`,`prc_id`,`rsdt_id`,`rsdt2_id`,`effect_date`,`abolish_date`,`insert_user_id`,`insert_user_code`,`insert_user_name`,`insert_timestamp`,`delete_user_id`,`delete_user_code`,`delete_user_name`,`delete_timestamp`) 
    VALUES 
      (623,'131016','100','6222',1,'１丁目11番1号','丸の内パシフィックセンチュリープレイス丸の内224号室','1','2','3','4','5','1948-07-29',NULL,0,0,'a',NULL,0,0,'a','1948-07-29 23:59:59')
    , (624,'131016','100','6222',1,'１丁目11番1号','丸の内パシフィックセンチュリープレイス丸の内225号室','1','2','3','4','5','1948-07-29',NULL,0,0,'a',NULL,0,0,'a','1948-07-29 23:59:59')
    , (625,'131016','100','6222',1,'１丁目11番1号','丸の内パシフィックセンチュリープレイス丸の内226号室','1','2','3','4','5','1948-07-29',NULL,0,0,'a',NULL,0,0,'a','1948-07-29 23:59:59')
    , (626,'131016','100','6222',0,'１丁目11番1号','丸の内パシフィックセンチュリープレイス丸の内227号室','1','2','3','4','5','1948-07-29',NULL,0,0,'a',NULL,0,0,'a','1948-07-29 23:59:59')
  ;
