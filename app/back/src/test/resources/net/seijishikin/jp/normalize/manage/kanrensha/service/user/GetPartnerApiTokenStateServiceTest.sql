...
INSERT INTO `partner_access_token` (`partner_access_token_id`,`user_code`,`user_name`,`access_token_hash`,`expires_at`,`created_at`,`last_used_at`,`revoked_at`,`ip_address`)
  VALUES 
    ...
    ,(326,190,'name_aaa','12345','2023-06-05 12:34:56','2022-12-05 12:34:56','2023-1-2 12:34:56',NULL,'127.0.0.1') --取得
    ,(327,190,'name','98765','2023-06-05 00:00:00','2022-12-05 00:00:00','2022-12-05 00:00:00','2022-12-05 00:00:00','127.0.0.1') --失効
    ;
