...
/**
 * DumpKanrenshaPersonHistory03ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaPersonHistory03ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/person_hisotry_03.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaPersonHistory03ItemWriter.beforeStep(stepExecution);

        KanrenshaPersonHistory03Entity entity00 = new KanrenshaPersonHistory03Entity();
        ...
        List<KanrenshaPersonHistory03Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaPersonHistory03Entity> items = new Chunk<>(list);
        dumpKanrenshaPersonHistory03ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaPersonHistory03ItemWriter.write(items);
