...
/**
 * DumpKanrenshaSeijidantaiHistory37ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory37ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_37.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory37ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory37Entity entity00 = new KanrenshaSeijidantaiHistory37Entity();
        ...
        List<KanrenshaSeijidantaiHistory37Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory37Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory37ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory37ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath37", output).toJobParameters();
