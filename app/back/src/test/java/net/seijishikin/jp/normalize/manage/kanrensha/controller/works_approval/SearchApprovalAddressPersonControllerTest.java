...
@Transactional
@Sql("../../service/works_approval/SearchApprovalAddressPersonServiceTest.sql")
class SearchApprovalAddressPersonControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/works-approval/search-person";
