...
/**
 * DumpKanrenshaSeijidantaiHistory10ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory10ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_10.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory10ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory10Entity entity00 = new KanrenshaSeijidantaiHistory10Entity();
        ...
        List<KanrenshaSeijidantaiHistory10Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory10Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory10ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory10ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath10", output).toJobParameters();
