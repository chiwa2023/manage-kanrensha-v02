...
/**
 * DumpKanrenshaSeijidantaiHistory16ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory16ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_16.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory16ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory16Entity entity00 = new KanrenshaSeijidantaiHistory16Entity();
        ...
        List<KanrenshaSeijidantaiHistory16Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory16Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory16ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory16ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath16", output).toJobParameters();
