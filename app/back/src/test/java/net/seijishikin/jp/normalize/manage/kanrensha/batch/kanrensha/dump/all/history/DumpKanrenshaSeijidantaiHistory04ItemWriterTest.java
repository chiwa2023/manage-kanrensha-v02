...
/**
 * DumpKanrenshaSeijidantaiHistory04ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory04ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_04.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory04ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory04Entity entity00 = new KanrenshaSeijidantaiHistory04Entity();
        ...
        List<KanrenshaSeijidantaiHistory04Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory04Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory04ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory04ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath04", output).toJobParameters();
