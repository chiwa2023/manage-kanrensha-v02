...
/**
 * DumpKanrenshaSeijidantaiHistory23ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory23ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_23.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory23ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory23Entity entity00 = new KanrenshaSeijidantaiHistory23Entity();
        ...
        List<KanrenshaSeijidantaiHistory23Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory23Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory23ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory23ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath23", output).toJobParameters();
