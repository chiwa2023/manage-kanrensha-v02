...
/**
 * DumpKanrenshaSeijidantaiHistory15ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory15ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_15.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory15ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory15Entity entity00 = new KanrenshaSeijidantaiHistory15Entity();
        ...
        List<KanrenshaSeijidantaiHistory15Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory15Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory15ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory15ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath15", output).toJobParameters();
