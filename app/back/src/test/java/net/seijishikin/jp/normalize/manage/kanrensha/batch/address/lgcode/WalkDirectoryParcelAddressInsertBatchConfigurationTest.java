...
/**
 * WalkDirectoryParcelAddressInsertBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
@Sql("WalkDirectoryParcelAddressInsertBatchConfigurationTest.sql")
class WalkDirectoryParcelAddressInsertBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(WalkDirectoryParcelAddressInsertBatchConfiguration.JOB_NAME,
                walkDirectoryParcelAddressInsert.getName(), "Job名が一致");
    }
