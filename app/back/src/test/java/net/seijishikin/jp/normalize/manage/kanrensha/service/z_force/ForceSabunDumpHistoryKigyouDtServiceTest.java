...
/**
 * ForceDumpHistorySabunKigyouDtService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceSabunDumpHistoryKigyouDtServiceTest.sql")
class ForceSabunDumpHistoryKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceSabunDumpHistoryKigyouDtService.practice(year, planDto, LocalDate.of(2024, 1, 1),
                LocalDate.of(2025, 1, 1), userDto));
    }
