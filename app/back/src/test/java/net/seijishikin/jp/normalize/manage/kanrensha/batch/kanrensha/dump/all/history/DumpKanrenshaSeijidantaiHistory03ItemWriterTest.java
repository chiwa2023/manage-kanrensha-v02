...
/**
 * DumpKanrenshaSeijidantaiHistory03ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory03ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_03.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory03ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory03Entity entity00 = new KanrenshaSeijidantaiHistory03Entity();
        ...
        List<KanrenshaSeijidantaiHistory03Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory03Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory03ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory03ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath03", output).toJobParameters();
