...
/**
 * DumpKanrenshaSeijidantaiHistory33ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory33ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_33.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory33ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory33Entity entity00 = new KanrenshaSeijidantaiHistory33Entity();
        ...
        List<KanrenshaSeijidantaiHistory33Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory33Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory33ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory33ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath33", output).toJobParameters();
