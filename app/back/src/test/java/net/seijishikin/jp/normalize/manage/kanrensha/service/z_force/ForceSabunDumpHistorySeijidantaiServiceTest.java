...
/**
 * ForceDumpHistorySabunSeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceSabunDumpHistorySeijidantaiServiceTest.sql")
class ForceSabunDumpHistorySeijidantaiServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceSabunDumpHistorySeijidantaiService.practice(year, planDto,
