...
/**
 * ExecuteBatchMasterMinKigyouDtController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_min/ExecuteBatchMasterMinKigyouDtServiceTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class ExecuteBatchMasterMinKigyouDtControllerTest {
    ...
    void test() throws Exception {
        ...
        final String fileName = "関連者企業団体最小登録.csv";
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/execute-kigyou-dt";
