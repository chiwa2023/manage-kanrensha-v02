...
/**
 * DumpKanrenshaSeijidantaiHistory44ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory44ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_44.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory44ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory44Entity entity00 = new KanrenshaSeijidantaiHistory44Entity();
        ...
        List<KanrenshaSeijidantaiHistory44Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory44Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory44ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory44ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath44", output).toJobParameters();
