...
/**
 * DumpKanrenshaSeijidantaiHistory18ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory18ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_18.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory18ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory18Entity entity00 = new KanrenshaSeijidantaiHistory18Entity();
        ...
        List<KanrenshaSeijidantaiHistory18Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory18Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory18ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory18ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath18", output).toJobParameters();
