...
/**
 * DumpKanrenshaSeijidantaiHistory40ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory40ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_40.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory40ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory40Entity entity00 = new KanrenshaSeijidantaiHistory40Entity();
        ...
        List<KanrenshaSeijidantaiHistory40Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory40Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory40ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory40ItemWriter.write(items);
