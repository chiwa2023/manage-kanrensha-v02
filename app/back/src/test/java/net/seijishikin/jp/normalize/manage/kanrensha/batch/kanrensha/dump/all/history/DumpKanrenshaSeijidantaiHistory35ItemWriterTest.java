...
/**
 * DumpKanrenshaSeijidantaiHistory35ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory35ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_35.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory35ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory35Entity entity00 = new KanrenshaSeijidantaiHistory35Entity();
        ...
        List<KanrenshaSeijidantaiHistory35Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory35Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory35ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory35ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath35", output).toJobParameters();
