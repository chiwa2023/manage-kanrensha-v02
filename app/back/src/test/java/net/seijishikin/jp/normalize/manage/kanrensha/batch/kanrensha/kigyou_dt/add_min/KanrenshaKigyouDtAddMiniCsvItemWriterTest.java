...
/**
 * KanrenshaKigyouDtAddMiniCsvItemWriter単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("KanrenshaKigyouDtAddMiniCsvItemWriterTest.sql")
class KanrenshaKigyouDtAddMiniCsvItemWriterTest {
    ...
    void test() throws Exception {
        ...
        kanrenshaKigyouDtAddMiniCsvItemWriter.beforeStep(this.getStepExecution());
        kanrenshaKigyouDtAddMiniCsvItemWriter.write(items);
