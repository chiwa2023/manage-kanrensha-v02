...
/**
 * DumpKanrenshaPersonHistory40ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaPersonHistory40ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/person_hisotry_40.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaPersonHistory40ItemWriter.beforeStep(stepExecution);

        KanrenshaPersonHistory40Entity entity00 = new KanrenshaPersonHistory40Entity();
        ...
        List<KanrenshaPersonHistory40Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaPersonHistory40Entity> items = new Chunk<>(list);
        dumpKanrenshaPersonHistory40ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaPersonHistory40ItemWriter.write(items);
