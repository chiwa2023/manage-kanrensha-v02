...
/**
 * UpdateWkTblAddressRsdtController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/address_rsdt/UpdateWkTblAddressRsdtServiceTest.sql")
class UpdateWkTblAddressRsdtControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/wktbl-address-rsdt/update";
