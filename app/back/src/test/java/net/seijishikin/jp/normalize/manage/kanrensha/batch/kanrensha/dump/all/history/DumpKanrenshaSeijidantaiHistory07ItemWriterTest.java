...
/**
 * DumpKanrenshaSeijidantaiHistory07ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory07ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_07.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory07ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory07Entity entity00 = new KanrenshaSeijidantaiHistory07Entity();
        ...
        List<KanrenshaSeijidantaiHistory07Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory07Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory07ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory07ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath07", output).toJobParameters();
