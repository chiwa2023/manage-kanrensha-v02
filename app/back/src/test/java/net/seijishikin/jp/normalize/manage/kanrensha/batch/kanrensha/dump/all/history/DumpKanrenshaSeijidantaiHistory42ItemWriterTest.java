...
/**
 * DumpKanrenshaSeijidantaiHistory42ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory42ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_42.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory42ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory42Entity entity00 = new KanrenshaSeijidantaiHistory42Entity();
        ...
        List<KanrenshaSeijidantaiHistory42Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory42Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory42ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory42ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath42", output).toJobParameters();
