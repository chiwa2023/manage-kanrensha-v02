...
/**
 * InsertKanrenshaKigyouDtHistoryBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
@Sql("InsertKanrenshaKigyouDtHistoryBatchConfigurationTest.sql")
class InsertKanrenshaKigyouDtHistoryBatchConfigurationTest {
    ...
    @Autowired
    private Job insertKanrenshaKigyouDtHistoryBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(InsertKanrenshaKigyouDtHistoryBatchConfiguration.JOB_NAME,
                insertKanrenshaKigyouDtHistoryBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(insertKanrenshaKigyouDtHistoryBatchConfiguration);
        ...
        JobParameters jobParameters = new JobParametersBuilder(insertKanrenshaKigyouDtHistoryBatchConfiguration // NOPMD
