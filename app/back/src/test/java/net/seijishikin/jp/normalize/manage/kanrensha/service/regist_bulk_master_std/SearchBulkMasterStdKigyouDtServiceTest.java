...
/**
 * SearchBulkMasterStdKigyouDtService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("SearchBulkMasterStdKigyouDtServiceTest.sql")
class SearchBulkMasterStdKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        SearchWkTblStdKigyouDtPagingResultDto resultDto00 = searchBulkMasterStdKigyouDtService.practice(capsuleDto00);
        ...
        SearchWkTblStdKigyouDtPagingResultDto resultDto01 = searchBulkMasterStdKigyouDtService.practice(capsuleDto01);
        ...
        SearchWkTblStdKigyouDtPagingResultDto resultDto02 = searchBulkMasterStdKigyouDtService.practice(capsuleDto02);
        ...
        SearchWkTblStdKigyouDtPagingResultDto resultDto03 = searchBulkMasterStdKigyouDtService.practice(capsuleDto03);
        ...
        SearchWkTblStdKigyouDtPagingResultDto resultDto04 = searchBulkMasterStdKigyouDtService.practice(capsuleDto04);
