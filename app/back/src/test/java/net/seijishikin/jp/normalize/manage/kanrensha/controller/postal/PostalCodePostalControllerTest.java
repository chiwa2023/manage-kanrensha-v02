...
/**
 * PostalCodePostalControllerｔ単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/postal/SearchAddressPostalServiceTest.sql")
class PostalCodePostalControllerTest {
    ...
    void test() throws Exception {
        ...
        capsuleDto.setPostal1("001");
        capsuleDto.setPostal2("0015");
        String path = PathRouteConstants.ROOT + "/postal-search/postal";
