...
/**
 * ForceDumpMinMasterPersonService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpMinMasterPersonServiceTest.sql")
class ForceDumpMinMasterPersonServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpMinMasterPersonService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
