...
/**
 * RetryBatchCombineOrgController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/regist_combine_org/RetryBatchCombineOrgServiceTest.sql")
class RetryBatchCombineOrgControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-combine/retry";
