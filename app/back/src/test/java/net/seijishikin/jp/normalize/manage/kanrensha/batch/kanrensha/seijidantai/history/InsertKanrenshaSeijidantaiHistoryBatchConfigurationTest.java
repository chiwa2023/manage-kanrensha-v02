...
/**
 * InsertKanrenshaSeijidantaiHistoryBatchConfiguration単体テスト
 */
@SpringJUnitConfig
@SpringBootTest
@SpringBatchTest
...
@Sql("InsertKanrenshaSeijidantaiHistoryBatchConfigurationTest.sql")
class InsertKanrenshaSeijidantaiHistoryBatchConfigurationTest {
    ...
    /** 起動をするJob */
    @Qualifier(InsertKanrenshaSeijidantaiHistoryBatchConfiguration.JOB_NAME)
    @Autowired
    private Job insertKanrenshaSeijidantaiHistoryBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(InsertKanrenshaSeijidantaiHistoryBatchConfiguration.JOB_NAME,
                insertKanrenshaSeijidantaiHistoryBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobOperatorTestUtils.setJob(insertKanrenshaSeijidantaiHistoryBatchConfiguration);
        ...
        JobParameters jobParameters = new JobParametersBuilder(insertKanrenshaSeijidantaiHistoryBatchConfiguration // NOPMD
