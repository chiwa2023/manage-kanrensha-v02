...
/**
 * SuspendDuplicateWkTblXmlDecideKanrenshaLogic単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("SuspendDuplicateWkTblXmlDecideKanrenshaLogicTest.sql")
class SuspendDuplicateWkTblXmlDecideKanrenshaLogicTest {
    ...
    void test() throws Exception {
        ...
        suspendDuplicateWkTblXmlDecideKanrenshaLogic.practice(CreateLeastUserForTestUtil.practice());

        // 処理内容変更
        WkTblMasterAllByXmlEntity entity00 = wkTblMasterAllByXmlRepository.findById(340).get();
        ...
        WkTblMasterAllByXmlEntity entity01 = wkTblMasterAllByXmlRepository.findById(341).get();
        ...
        WkTblMasterAllByXmlEntity entity02 = wkTblMasterAllByXmlRepository.findById(342).get();
