...
/**
 * ResetPasswordMailInputController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/security/ResetPasswordMailInputServiceTest.sql")
class ResetPasswordMailInputControllerTest {
    ...
    void testBadUser() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/reset-password/send-code";
