...
/**
 * SuspendDuplicateWkTblKanrenshaPersonAddMinTasklet単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("SuspendDuplicateWkTblKanrenshaPersonAddMinTaskletTest.sql")
class SuspendDuplicateWkTblKanrenshaPersonAddMinTaskletTest {
    ...
    void test() throws Exception {
        ...
        suspendDuplicateWkTblKanrenshaPersonAddMinTasklet.beforeStep(this.getStepExecution());
        suspendDuplicateWkTblKanrenshaPersonAddMinTasklet.execute(null, null);

        WkTblKanrenshaPersonAddMinEntity entity501 = wkTblKanrenshaPersonAddMinRepository.findById(5001).get();
        ...
        WkTblKanrenshaPersonAddMinEntity entity502 = wkTblKanrenshaPersonAddMinRepository.findById(5002).get();
        ...
        WkTblKanrenshaPersonAddMinEntity entity601 = wkTblKanrenshaPersonAddMinRepository.findById(6001).get();
