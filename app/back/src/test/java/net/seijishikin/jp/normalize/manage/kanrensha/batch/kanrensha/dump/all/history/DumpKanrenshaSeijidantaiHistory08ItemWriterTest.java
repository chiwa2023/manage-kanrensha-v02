...
/**
 * DumpKanrenshaSeijidantaiHistory08ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory08ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_08.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory08ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory08Entity entity00 = new KanrenshaSeijidantaiHistory08Entity();
        ...
        List<KanrenshaSeijidantaiHistory08Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory08Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory08ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory08ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath08", output).toJobParameters();
