...
/**
 * DumpKanrenshaSeijidantaiHistory45ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory45ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_45.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory45ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory45Entity entity00 = new KanrenshaSeijidantaiHistory45Entity();
        ...
        List<KanrenshaSeijidantaiHistory45Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory45Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory45ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory45ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath45", output).toJobParameters();
