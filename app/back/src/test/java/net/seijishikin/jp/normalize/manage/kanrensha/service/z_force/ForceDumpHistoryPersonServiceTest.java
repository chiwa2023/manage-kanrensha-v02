...
/**
 * ForceDumpHistoryPersonService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpHistoryPersonServiceTest.sql")
class ForceDumpHistoryPersonServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpHistoryPersonService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
