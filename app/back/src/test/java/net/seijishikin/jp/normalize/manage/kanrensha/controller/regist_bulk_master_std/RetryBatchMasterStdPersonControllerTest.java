...
/**
 * RetryBatchMasterStdPersonController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/regist_bulk_master_std/RetryBatchMasterStdPersonServiceTest.sql")
class RetryBatchMasterStdPersonControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-std/retry-person";
