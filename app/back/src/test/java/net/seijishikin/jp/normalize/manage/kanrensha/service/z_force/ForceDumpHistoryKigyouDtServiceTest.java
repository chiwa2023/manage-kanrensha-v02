...
/**
 * ForceDumpHistoryService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpHistoryKigyouDtServiceTest.sql")
class ForceDumpHistoryKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpHistoryKigyouDtService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
