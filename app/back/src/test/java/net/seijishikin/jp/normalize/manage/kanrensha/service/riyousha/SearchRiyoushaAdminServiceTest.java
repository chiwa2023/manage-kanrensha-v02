...
/**
 * SearchRiyoushaAdminService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("SearchRiyoushaAdminServiceTest.sql")
class SearchRiyoushaAdminServiceTest {
    ...
    void test() throws Exception {
        ...
        SearchRiyoushaAdminCapsuleDto capsuleDto = new SearchRiyoushaAdminCapsuleDto();
        ...
        assertNotNull(resultDto.getListRiyoushaAdmin());

        List<RiyoushaAdminMasterEntity> list = resultDto.getListRiyoushaAdmin();

        RiyoushaAdminMasterEntity entity00 = list.get(0);
        RiyoushaAdminMasterEntity entity01 = list.get(1);

        assertEquals(1, entity00.getRiyoushaAdminMasterId());
        assertEquals(3, entity01.getRiyoushaAdminMasterId());

        // 無茶なページ番号は補正
        capsuleDto.setPageNumber(66);
        SearchRiyoushaAdminResultDto resultDto1 = searchRiyoushaAdminService.practice(capsuleDto);
        ...
        assertEquals(2, resultDto1.getListRiyoushaAdmin().size());

        // 検索できなくても必要なDtoは戻る
        capsuleDto.setSearchNaturalWords("検索できない");
        capsuleDto.setPageNumber(3);
        SearchRiyoushaAdminResultDto resultDto2 = searchRiyoushaAdminService.practice(capsuleDto);
        ...
        assertTrue(resultDto2.getListRiyoushaAdmin().isEmpty());
