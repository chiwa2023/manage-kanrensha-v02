 ...
 *
 * <p>
 * 「英数＋条」の住所は漢数字に変換する。特に北海道(データの段階で修正)
 * 「（東・西・南・北）」の住所は〇丁目～〇丁目に展開する(データの段階で修正)
 * 建物住所が「×号館」となっていて、番地住所に号がない場合は号を補う
 * 処理後に事業所データで全角入れ位置がおかしいものがどうしても出てしまう(３丁目　左7とか)ので修正する
 * </p>
 */
@SpringJUnitConfig
