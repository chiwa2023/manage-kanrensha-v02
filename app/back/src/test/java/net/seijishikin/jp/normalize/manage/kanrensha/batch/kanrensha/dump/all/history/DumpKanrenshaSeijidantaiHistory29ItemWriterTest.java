...
/**
 * DumpKanrenshaSeijidantaiHistory29ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory29ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_29.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory29ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory29Entity entity00 = new KanrenshaSeijidantaiHistory29Entity();
        ...
        List<KanrenshaSeijidantaiHistory29Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory29Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory29ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory29ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath29", output).toJobParameters();
