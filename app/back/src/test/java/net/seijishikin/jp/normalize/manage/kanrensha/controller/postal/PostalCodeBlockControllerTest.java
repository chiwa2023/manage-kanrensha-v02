...
/**
 * PostalCodeBlockController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/postal/SearchAddressBlockServiceTest.sql")
class PostalCodeBlockControllerTest {
    ...
    void test() throws Exception {
        ...
        capsuleDto.setSelectedPostal(1254);
        capsuleDto.setIsGyouseikuData(false);

        String path = "/postal-search/block";
