...
@Transactional
@Sql("SuspendDuplicateWkTblXmlBikoLogicTest.sql")
class SuspendDuplicateWkTblXmlBikoLogicTest {
    ...
    void test() throws Exception {
        ...
        // WkTblMasterAllByXmlEntity entity01 =
        // wkTblMasterAllByXmlRepository.findById(141).get();
        // assertEquals(true, entity01.getIsLatest());
        // assertEquals(false, entity01.getIsAffected());
        // assertEquals(false, entity01.getIsFinish());
        // assertEquals(false, entity01.getIsDisabled());
