...
class GetRiyoushaAdminDtoServiceTest {
    ...
    void test() throws Exception {
        ...
        assertDoesNotThrow(() -> getRiyoushaAdminDtoService.practice(new RiyoushaAdminMasterEntity()));
        ...
        assertEquals(masterEntity.getRiyoushaAdminMasterId(), managerDto.getRiyoushaAdminMasterId());
        assertEquals(masterEntity.getRiyoushaAdminMasterCode(), managerDto.getRiyoushaAdminMasterCode());
