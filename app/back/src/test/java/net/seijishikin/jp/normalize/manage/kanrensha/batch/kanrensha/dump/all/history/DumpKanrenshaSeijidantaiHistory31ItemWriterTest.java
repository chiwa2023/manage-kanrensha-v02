...
/**
 * DumpKanrenshaSeijidantaiHistory31ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory31ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_31.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory31ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory31Entity entity00 = new KanrenshaSeijidantaiHistory31Entity();
        ...
        List<KanrenshaSeijidantaiHistory31Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory31Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory31ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory31ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath31", output).toJobParameters();
