...
/**
 * DeletePostalCodeController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/postal/DeletePostalCodeServiceTest.sql")
class DeletePostalCodeControllerTest {
    ...
    void test() throws Exception {
        ...
        capsuleDto.getAddressPostalEntity().setAddressPostalId(443);
        capsuleDto.setUserDto(CreateLeastUserForTestUtil.practice());

        String path = PathRouteConstants.ROOT + "/postal-code/delete";
