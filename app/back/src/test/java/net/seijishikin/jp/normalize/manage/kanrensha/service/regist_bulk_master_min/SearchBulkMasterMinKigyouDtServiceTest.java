...
/**
 * SearchBulkMasterMinKigyouDtService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("SearchBulkMasterMinKigyouDtServiceTest.sql")
class SearchBulkMasterMinKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        SearchWkTblMinKigyouDtPagingResultDto resultDto00 = searchBulkMasterMinKigyouDtService.practice(capsuleDto00);
        ...
        SearchWkTblMinKigyouDtPagingResultDto resultDto01 = searchBulkMasterMinKigyouDtService.practice(capsuleDto01);
        ...
        SearchWkTblMinKigyouDtPagingResultDto resultDto02 = searchBulkMasterMinKigyouDtService.practice(capsuleDto02);
        ...
        SearchWkTblMinKigyouDtPagingResultDto resultDto03 = searchBulkMasterMinKigyouDtService.practice(capsuleDto03);
        ...
        SearchWkTblMinKigyouDtPagingResultDto resultDto04 = searchBulkMasterMinKigyouDtService.practice(capsuleDto04);
