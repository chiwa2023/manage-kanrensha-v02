...
/**
 * DumpKanrenshaSeijidantaiHistory11ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory11ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_11.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory11ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory11Entity entity00 = new KanrenshaSeijidantaiHistory11Entity();
        ...
        List<KanrenshaSeijidantaiHistory11Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory11Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory11ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory11ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath11", output).toJobParameters();
