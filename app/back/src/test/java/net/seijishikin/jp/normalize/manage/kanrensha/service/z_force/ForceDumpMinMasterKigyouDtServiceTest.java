...
/**
 * ForceDumpMinMasterKigyouDtService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpMinMasterKigyouDtServiceTest.sql")
class ForceDumpMinMasterKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpMinMasterKigyouDtService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
