...
/**
 * MoveAddressRsdtByLgcodeController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/lgcode/MoveAddressRsdtByLgcodeServiceTest.sql")
class MoveAddressRsdtByLgcodeControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/lgcode-delete/move";
