...
/**
 * RetryBatchMasterStdSeijidantaiController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_std/RetryBatchMasterStdSeijidantaiServiceTest.sql")
class RetryBatchMasterStdSeijidantaiControllerTest {
