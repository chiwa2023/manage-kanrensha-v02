...
/**
 * InsertCombineOrgY2020Logic単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("InsertCombineOrgY2020LogicTest.sql")
class InsertCombineOrgY2020LogicTest {
    ...
    void test() throws Exception {
        ...
        entity00.setStartYear(Short.valueOf("2020"));
        entity00.setEndYear(Short.valueOf("2020"));
        entity00.setYearArrayText("2020");
        entity00.setIsAffected(true);
        entity00.setIsFinish(false);
        entity00.setJudgeReason("理由");

        Integer insertId = insertCombineOrgY2020Logic.practice(entity00, CreateLeastUserForTestUtil.practice());
        assertNotEquals(0, insertId); // 正常に登録

        KanrenshaCombineOrg2020Entity entityAns = kanrenshaCombineOrg2020Repository.findById(insertId).get();
