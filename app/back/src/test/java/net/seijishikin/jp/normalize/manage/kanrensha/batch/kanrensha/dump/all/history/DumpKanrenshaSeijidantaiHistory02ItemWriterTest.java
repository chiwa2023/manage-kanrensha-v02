...
/**
 * DumpKanrenshaSeijidantaiHistory02ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory02ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_02.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory02ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory02Entity entity00 = new KanrenshaSeijidantaiHistory02Entity();
        ...
        List<KanrenshaSeijidantaiHistory02Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory02Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory02ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory02ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath02", output).toJobParameters();
