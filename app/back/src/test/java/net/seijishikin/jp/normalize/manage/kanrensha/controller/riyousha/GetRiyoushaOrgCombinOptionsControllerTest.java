...
/**
 * GetRiyoushaOrgCombinOptionsController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/riyousha/GetRiyoushaOrgCombinOptionsServiceTest.sql")
class GetRiyoushaOrgCombinOptionsControllerTest {
