...
class InsertKanrenshaKigyouDtServiceTest { // NOPMD CouplingObjects
    ...
    void testOther() throws Exception {
        ...
        kanrenshaKigyouDtDto.setIsCombineUser(false);
    ...
    void testMyself() throws Exception {
        ...
        kanrenshaKigyouDtDto.setHoujinNo("1234567");
        InputOrgNameDto inputOrgNameDto = new InputOrgNameDto();
        inputOrgNameDto.setOrgName("テスト株式会社4");
        inputOrgNameDto.setOrgNameKana("テストカブシキガイシャよん");
        kanrenshaKigyouDtDto.setInputOrgNameDto(inputOrgNameDto);
        ...
        kanrenshaKigyouDtDto.setHoujinSbts(HoujinShubetsuConstants.GAIKOKU_KAISHA); // 外国籍
        kanrenshaKigyouDtDto.setIsShiten(true);
        kanrenshaKigyouDtDto.setIsCombineUser(true);
        ...
        List<UserRoleEntity> listRole = userRoleRepository.findByEmailAndRoleAndIsLatestTrue(
                "ccc@politician.balanse.report.net", UserRoleConstants.KANRENSHA_KIGYOU_DT);
