...
/**
 * ForceDumpStdMasterSeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpStdMasterSeijidantaiServiceTest.sql")
class ForceDumpStdMasterSeijidantaiServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpStdMasterSeijidantaiService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
