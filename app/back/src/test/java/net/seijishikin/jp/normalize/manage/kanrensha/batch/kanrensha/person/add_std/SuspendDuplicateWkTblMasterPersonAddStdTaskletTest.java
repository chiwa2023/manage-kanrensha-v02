...
@Transactional
@Sql("SuspendDuplicateWkTblMasterPersonAddStdTaskletTest.sql")
class SuspendDuplicateWkTblMasterPersonAddStdTaskletTest {
    ...
    void test() throws Exception {
        ...
        WkTblKanrenshaPersonMasterEntity entity501 = wkTblKanrenshaPersonMasterRepository.findById(5001).get();
        ...
        WkTblKanrenshaPersonMasterEntity entity502 = wkTblKanrenshaPersonMasterRepository.findById(5002).get();
        ...
        WkTblKanrenshaPersonMasterEntity entity601 = wkTblKanrenshaPersonMasterRepository.findById(6001).get();
