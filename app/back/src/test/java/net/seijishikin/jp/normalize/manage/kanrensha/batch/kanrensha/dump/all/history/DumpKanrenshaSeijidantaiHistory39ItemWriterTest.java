...
/**
 * DumpKanrenshaSeijidantaiHistory39ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory39ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_39.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory39ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory39Entity entity00 = new KanrenshaSeijidantaiHistory39Entity();
        ...
        List<KanrenshaSeijidantaiHistory39Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory39Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory39ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory39ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath39", output).toJobParameters();
