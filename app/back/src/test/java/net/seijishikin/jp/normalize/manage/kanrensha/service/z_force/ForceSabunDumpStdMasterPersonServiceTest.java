...
@Sql("ForceSabunDumpStdMasterPersonServiceTest.sql")
class ForceSabunDumpStdMasterPersonServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceSabunDumpStdMasterPersonService.practice(year, planDto, LocalDate.of(2024, 1, 1),
