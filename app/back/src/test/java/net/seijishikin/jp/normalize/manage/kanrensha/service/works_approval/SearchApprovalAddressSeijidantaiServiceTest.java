...
/**
 * SearchApprovalAddressSeijidantaiService単体テスト
 */
@SpringJUnitConfig
...
class SearchApprovalAddressSeijidantaiServiceTest {
    // CHECKSTYLE:OFF MagicNumber

    /** テスト対象 */
    @Autowired
    private SearchApprovalAddressSeijidantaiService searchApprovalAddressSeijidantaiService;
    ...
    void testPlusAccept() throws Exception {
        ...
        SearchApprovalAddressResultDto resultDto = searchApprovalAddressSeijidantaiService.practice(capsuleDto);
...
//        assertEquals(102, list.get(3).getKanrenshaAddressId());
        assertEquals(301, list.get(0).getKanrenshaAddressId());
        assertEquals(302, list.get(1).getKanrenshaAddressId());
    }
...
//        assertEquals(102, list.get(1).getKanrenshaAddressId());
        assertEquals(302, list.get(0).getKanrenshaAddressId());
...
//        assertEquals(false, entity1.getIsBuildingAccept());
        ...
        KanrenshaAddressBaseEntity entity2 = list.get(0);
