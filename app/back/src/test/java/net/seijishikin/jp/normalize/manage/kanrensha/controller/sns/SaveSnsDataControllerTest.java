...
/**
 * SaveSnsDataController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/sns/SaveSnsDataServiceTest.sql")
@Transactional
class SaveSnsDataControllerTest {
    ...
    void test() throws Exception {
        ...
        capsuleDto.setSnsServiceEntity(entityAdd);

        String path = PathRouteConstants.ROOT + "/sns-service/save";
