...
/**
 * SearchBulkMasterStdPersonController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/regist_bulk_master_min/SearchBulkMasterMinPersonServiceTest.sql")
class SearchBulkMasterMinPersonControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/search-person";
