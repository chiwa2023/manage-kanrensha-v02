...
/**
 * AddCombineOrgBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class AddCombineOrgBatchConfigurationTest {
    ...
    @Autowired
    private Job addCombineOrgBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(AddCombineOrgBatchConfiguration.JOB_NAME, addCombineOrgBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(addCombineOrgBatchConfiguration);
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                addCombineOrgBatchConfiguration.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
