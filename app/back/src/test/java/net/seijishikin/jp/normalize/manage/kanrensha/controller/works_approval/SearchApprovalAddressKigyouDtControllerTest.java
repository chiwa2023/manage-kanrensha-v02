...
/**
 * SearchApprovalAddressKigyouDtController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/works_approval/SearchApprovalAddressKigyouDtServiceTest.sql")
class SearchApprovalAddressKigyouDtControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/works-approval/search-kigyou-dt";
