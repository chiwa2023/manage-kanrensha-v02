...
/**
 * RetryMinKanrenshaKigyouDtMasterBatchConfiguration単体テスト
 */
@SpringJUnitConfig
@SpringBootTest
@SpringBatchTest
...
class RetryMinKanrenshaKigyouDtMasterBatchConfigurationTest {
    ...
    @Autowired
    private Job retryMinKanrenshaKigyouDtMasterBatchConfiguration;
    ...
    void testExecute() throws Exception {
        ...
        jobOperatorTestUtils.setJob(retryMinKanrenshaKigyouDtMasterBatchConfiguration);

        LeastUserDto userDto = CreateLeastUserForTestUtil.practice();

        JobParameters jobParameters = new JobParametersBuilder(retryMinKanrenshaKigyouDtMasterBatchConfiguration // NOPMD
                                                                                                                 // LowOfDemeter
