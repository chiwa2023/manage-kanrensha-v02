...
@Transactional
@Sql("../../service/regist_bulk_history/SearchBulkHistorySeijidantaiServiceTest.sql")
class SearchBulkHistorySeijidantaiControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-history/search-seijidantai";
