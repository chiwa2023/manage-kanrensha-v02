...
import net.seijishikin.jp.normalize.manage.kanrensha.dto.wktbl_std.SearchWkTblStdPersonPagingResultDto;
import net.seijishikin.jp.normalize.manage.kanrensha.utils.CreateLeastUserForTestUtil;

/**
 * SearchBulkMasterStdPersonService単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("SearchBulkMasterStdPersonServiceTest.sql")
class SearchBulkMasterStdPersonServiceTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private SearchBulkMasterStdPersonService searchBulkMasterStdPersonService;

    @Test
    @Tag("TableTruncate")
    void test() throws Exception {
        SearchWkTbPagingCapsuleDto capsuleDto00 = this.createCapsuleDto();
        SearchWkTblStdPersonPagingResultDto resultDto00 = searchBulkMasterStdPersonService.practice(capsuleDto00);
        ...
        SearchWkTblStdPersonPagingResultDto resultDto01 = searchBulkMasterStdPersonService.practice(capsuleDto01);
        ...
        SearchWkTblStdPersonPagingResultDto resultDto02 = searchBulkMasterStdPersonService.practice(capsuleDto02);
        ...
        SearchWkTblStdPersonPagingResultDto resultDto03 = searchBulkMasterStdPersonService.practice(capsuleDto03);
        ...
        SearchWkTblStdPersonPagingResultDto resultDto04 = searchBulkMasterStdPersonService.practice(capsuleDto04);
