...
/**
 * DumpKanrenshaKigyouDtHistory47ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaKigyouDtHistory47ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/kigyou_dt_hisotry_47.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaKigyouDtHistory47ItemWriter.beforeStep(stepExecution);

        KanrenshaKigyouDtHistory47Entity entity00 = new KanrenshaKigyouDtHistory47Entity();
        ...
        List<KanrenshaKigyouDtHistory47Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaKigyouDtHistory47Entity> items = new Chunk<>(list);
        dumpKanrenshaKigyouDtHistory47ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaKigyouDtHistory47ItemWriter.write(items);
