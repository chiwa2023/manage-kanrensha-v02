...
/**
 * DumpKanrenshaPersonHistory28ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaPersonHistory28ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/person_hisotry_28.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaPersonHistory28ItemWriter.beforeStep(stepExecution);

        KanrenshaPersonHistory28Entity entity00 = new KanrenshaPersonHistory28Entity();
        ...
        List<KanrenshaPersonHistory28Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaPersonHistory28Entity> items = new Chunk<>(list);
        dumpKanrenshaPersonHistory28ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaPersonHistory28ItemWriter.write(items);
