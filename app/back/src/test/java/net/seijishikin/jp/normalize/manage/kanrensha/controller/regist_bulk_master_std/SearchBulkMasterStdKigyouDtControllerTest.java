...
@Transactional
@Sql("../../service/regist_bulk_master_std/SearchBulkMasterStdKigyouDtServiceTest.sql")
class SearchBulkMasterStdKigyouDtControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-std/search-kigyou-dt";
