...
/**
 * ExecuteBatchMasterMinPersonController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_min/ExecuteBatchMasterMinPersonServiceTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class ExecuteBatchMasterMinPersonControllerTest {
    ...
    void test() throws Exception {
        ...
        final String fileName = "関連者個人最小登録.csv";
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/execute-person";
