...
/**
 * DumpKanrenshaSeijidantaiHistory47ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory47ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_47.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory47ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory47Entity entity00 = new KanrenshaSeijidantaiHistory47Entity();
        ...
        List<KanrenshaSeijidantaiHistory47Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory47Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory47ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory47ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath47", output).toJobParameters();
