...
/**
 * SearchBulkMasterStdSeijidantaiController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/regist_bulk_history/SearchBulkHistoryPersonServiceTest.sql")
class SearchBulkHistoryPersonControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-history/search-person";
