...
/**
 * DumpKanrenshaSeijidantaiHistory30ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory30ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_30.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory30ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory30Entity entity00 = new KanrenshaSeijidantaiHistory30Entity();
        ...
        List<KanrenshaSeijidantaiHistory30Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory30Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory30ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory30ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath30", output).toJobParameters();
