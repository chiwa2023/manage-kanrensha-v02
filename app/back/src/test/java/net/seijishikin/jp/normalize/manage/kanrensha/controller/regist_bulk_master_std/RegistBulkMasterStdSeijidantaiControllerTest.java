...
@Transactional
@Sql("../../service/regist_bulk_master_std/RegistBulkMasterStdSeijidantaiServiceTest.sql")
class RegistBulkMasterStdSeijidantaiControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        WkTblKanrenshaSeijidantaiMasterEntity entityInput01 = wkTblKanrenshaSeijidantaiMasterRepository.findById(533)
                .get();
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-std/update-seijidantai";
