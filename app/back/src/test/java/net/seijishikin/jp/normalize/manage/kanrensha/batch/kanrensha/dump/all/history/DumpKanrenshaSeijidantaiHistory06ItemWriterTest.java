...
/**
 * DumpKanrenshaSeijidantaiHistory06ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory06ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_06.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory06ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory06Entity entity00 = new KanrenshaSeijidantaiHistory06Entity();
        ...
        List<KanrenshaSeijidantaiHistory06Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory06Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory06ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory06ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath06", output).toJobParameters();
