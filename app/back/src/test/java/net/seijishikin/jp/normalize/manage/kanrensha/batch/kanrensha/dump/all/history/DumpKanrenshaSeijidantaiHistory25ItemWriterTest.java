...
/**
 * DumpKanrenshaSeijidantaiHistory25ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory25ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_25.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory25ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory25Entity entity00 = new KanrenshaSeijidantaiHistory25Entity();
        ...
        List<KanrenshaSeijidantaiHistory25Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory25Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory25ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory25ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath25", output).toJobParameters();
