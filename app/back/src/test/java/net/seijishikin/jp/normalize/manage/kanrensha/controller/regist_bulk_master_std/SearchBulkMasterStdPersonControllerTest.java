...
@Transactional
@Sql("../../service/regist_bulk_master_std/SearchBulkMasterStdPersonServiceTest.sql")
class SearchBulkMasterStdPersonControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-std/search-person";
