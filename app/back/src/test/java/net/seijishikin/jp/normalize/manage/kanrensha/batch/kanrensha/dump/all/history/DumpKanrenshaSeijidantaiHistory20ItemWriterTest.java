...
/**
 * DumpKanrenshaSeijidantaiHistory20ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory20ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_20.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory20ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory20Entity entity00 = new KanrenshaSeijidantaiHistory20Entity();
        ...
        List<KanrenshaSeijidantaiHistory20Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory20Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory20ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory20ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath20", output).toJobParameters();
