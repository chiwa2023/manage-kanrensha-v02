...
/**
 * EraseWkTblKanrenshaSeijidantaiHistoryTasklet単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("EraseWkTblKanrenshaSeijidantaiHistoryTaskletTest.sql")
class EraseWkTblKanrenshaSeijidantaiHistoryTaskletTest {
    ...
    void test() throws Exception {
        ...
        assertEquals(5, wkTblKanrenshaSeijidantaiHistoryRepository.count());
        assertEquals(5, wkTblKanrenshaSeijidantaiHistoryResultRepository.count());

        eraseWkTblKanrenshaSeijidantaiHistoryTasklet.beforeStep(this.getStepExecution());
        eraseWkTblKanrenshaSeijidantaiHistoryTasklet.execute(null, null);

        assertEquals(1, wkTblKanrenshaSeijidantaiHistoryRepository.count());
        assertEquals(1, wkTblKanrenshaSeijidantaiHistoryResultRepository.count());
    }
