...
@Sql("RepairPostalCodeIrregularBatchConfigurationTest.sql")
class RepairPostalCodeIrregularBatchConfigurationTest {
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RepairPostalCodeIrregularBatchConfiguration.JOB_NAME,
                repairPostalCodeIrregularBatchConfiguration.getName(), "Job名が一致");
    }
