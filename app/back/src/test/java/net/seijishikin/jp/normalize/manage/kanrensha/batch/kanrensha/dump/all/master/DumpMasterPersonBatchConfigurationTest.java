...
@Sql("DumpMasterPersonBatchConfigurationTest.sql")
...
class DumpMasterPersonBatchConfigurationTest {
    ...
    @Autowired
    private Job dumpMasterPersonBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(DumpMasterPersonBatchConfiguration.JOB_NAME, dumpMasterPersonBatchConfiguration.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobOperatorTestUtils.setJob(dumpMasterPersonBatchConfiguration);
