...
/**
 * RetryBatchMasterMinSeijidantaiController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_min/RetryBatchMasterMinSeijidantaiServiceTest.sql")
class RetryBatchMasterMinSeijidantaiControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/retry-seijidantai";
