...
/**
 * ExecuteBatchCombineKigyouDtController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_combine_org/ExecuteBatchCombineKigyouDtServiceTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class ExecuteBatchCombineKigyouDtControllerTest {
    ...
    void test() throws Exception {
        ...
        final String fileName = "sample_combine_corp.csv";
