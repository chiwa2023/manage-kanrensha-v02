...
class MockSendHoujinNoControllerTest {
    ...
    void testGetHoujinNo_ContainsA() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "あいうえお").param(PARAM_KEY_TYPE, "12"))
    ...
    void testGetHoujinNo_ContainsI() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "い").param(PARAM_KEY_TYPE, "12"))
                .andExpect(status().isOk()).andExpect(content().contentType(CONTENT_TYPE))
    ...
    void testGetHoujinNo_ContainsU() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "う").param(PARAM_KEY_TYPE, "12"))
                .andExpect(status().isOk()).andExpect(content().contentType(CONTENT_TYPE))
    ...
    void testGetHoujinNo_Other() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "さしすせそ").param(PARAM_KEY_TYPE, "12"))
                .andExpect(status().isOk()).andExpect(content().contentType(CONTENT_TYPE))
    ...
    void test403() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "か").param(PARAM_KEY_TYPE, "12"))
    ...
    void test404() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "きつつき").param(PARAM_KEY_TYPE, "12"))
    ...
    void test500() throws Exception {
        mockMvc.perform(
                get(ACCESS_URL).param("id", PARAM_TEST_ID).param(PARAM_KEY_NAME, "くじゃく").param(PARAM_KEY_TYPE, "12"))
