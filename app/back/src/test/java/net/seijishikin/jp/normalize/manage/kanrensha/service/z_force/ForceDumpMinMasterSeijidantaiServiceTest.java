...
/**
 * ForceDumpMinMasterSeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpMinMasterSeijidantaiServiceTest.sql")
class ForceDumpMinMasterSeijidantaiServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpMinMasterSeijidantaiService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
