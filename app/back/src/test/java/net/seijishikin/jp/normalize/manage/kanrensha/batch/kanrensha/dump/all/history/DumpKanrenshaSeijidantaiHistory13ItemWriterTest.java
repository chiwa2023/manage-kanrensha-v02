...
/**
 * DumpKanrenshaSeijidantaiHistory13ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory13ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_13.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory13ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory13Entity entity00 = new KanrenshaSeijidantaiHistory13Entity();
        ...
        List<KanrenshaSeijidantaiHistory13Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory13Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory13ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory13ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath13", output).toJobParameters();
