...
/**
 * SearchRiyoushaOrgController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/riyousha/SearchRiyoushaOrgServiceTest.sql")
class SearchRiyoushaOrgControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/riyousha-org/search";
