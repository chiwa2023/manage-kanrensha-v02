...
/**
 * ForceDumpHistorySeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpHistorySeijidantaiServiceTest.sql")
class ForceDumpHistorySeijidantaiServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpHistorySeijidantaiService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
