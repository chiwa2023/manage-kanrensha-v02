...
/**
 * ForceDumpMinMasterSabunPersonService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceSabunDumpMinMasterPersonServiceTest.sql")
class ForceSabunDumpMinMasterPersonServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceSabunDumpMinMasterPersonService.practice(year, planDto, LocalDate.of(2024, 1, 1),
