...
/**
 * RetryBatchHistoryPersonController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/regist_bulk_history/RetryBatchHistoryPersonServiceTest.sql")
class RetryBatchHistoryPersonControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-history/retry-person";
