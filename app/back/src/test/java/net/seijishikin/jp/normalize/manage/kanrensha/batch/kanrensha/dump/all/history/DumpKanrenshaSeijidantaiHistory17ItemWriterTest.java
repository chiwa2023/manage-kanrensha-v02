...
/**
 * DumpKanrenshaSeijidantaiHistory17ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory17ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_17.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory17ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory17Entity entity00 = new KanrenshaSeijidantaiHistory17Entity();
        ...
        List<KanrenshaSeijidantaiHistory17Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory17Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory17ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory17ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath17", output).toJobParameters();
