...
@Transactional
@Sql("../../service/regist_bulk_master_min/SearchBulkMasterMinKigyouDtServiceTest.sql")
class SearchBulkMasterMinKigyouDtControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/search-kigyou-dt";
