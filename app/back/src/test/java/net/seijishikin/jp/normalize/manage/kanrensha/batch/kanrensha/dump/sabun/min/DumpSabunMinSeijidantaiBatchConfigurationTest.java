...
/**
 * DumpSabunMinSeijidantaiBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
@Sql("DumpSabunMinSeijidantaiBatchConfigurationTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class DumpSabunMinSeijidantaiBatchConfigurationTest {
    ...
    @Autowired
    private Job dumpSabunMinSeijidantaiBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(DumpSabunMinSeijidantaiBatchConfiguration.JOB_NAME,
                dumpSabunMinSeijidantaiBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                ...
                .addString("writeFilePath", Paths.get(storageFolder, "sabun_master_min_seijidantai.csv").toString())
