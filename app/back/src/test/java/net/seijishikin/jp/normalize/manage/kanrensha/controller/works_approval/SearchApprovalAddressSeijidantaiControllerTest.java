...
/**
 * SearchApprovalAddressSeijidantaiController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/works_approval/SearchApprovalAddressSeijidantaiServiceTest.sql")
class SearchApprovalAddressSeijidantaiControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/works-approval/search-seijidantai";
