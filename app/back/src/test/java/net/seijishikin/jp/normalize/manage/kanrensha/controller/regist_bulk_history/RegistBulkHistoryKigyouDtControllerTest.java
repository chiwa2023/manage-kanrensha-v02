...
@Transactional
@Sql("../../service/regist_bulk_history/RegistBulkHistoryKigyouDtServiceTest.sql")
class RegistBulkHistoryKigyouDtControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        WkTblKanrenshaKigyouDtHistoryEntity entityInput01 = wkTblKanrenshaKigyouDtHistoryRepository.findById(101).get();
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-history/update-kigyou-dt";
