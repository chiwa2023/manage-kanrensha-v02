...
/**
 * AddMinKanrenshaKigyouDtMasterBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
@Sql("AddMinKanrenshaKigyouDtMasterBatchConfigurationTest.sql")
class AddMinKanrenshaKigyouDtMasterBatchConfigurationTest {
    ...
    @Autowired
    private Job addMinKanrenshaKigyouDtMasterBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(AddMinKanrenshaKigyouDtMasterBatchConfiguration.JOB_NAME,
                addMinKanrenshaKigyouDtMasterBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(addMinKanrenshaKigyouDtMasterBatchConfiguration);
        ...
        JobParameters jobParameters = new JobParametersBuilder(addMinKanrenshaKigyouDtMasterBatchConfiguration // NOPMD
