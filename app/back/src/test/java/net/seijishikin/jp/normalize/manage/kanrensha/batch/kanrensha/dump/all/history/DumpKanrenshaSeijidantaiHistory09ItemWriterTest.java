...
/**
 * DumpKanrenshaSeijidantaiHistory09ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory09ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_09.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory09ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory09Entity entity00 = new KanrenshaSeijidantaiHistory09Entity();
        ...
        List<KanrenshaSeijidantaiHistory09Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory09Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory09ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory09ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath09", output).toJobParameters();
