...
/**
 * ForceDumpStdMasterPersonService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceDumpStdMasterPersonServiceTest.sql")
class ForceDumpStdMasterPersonServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(
                () -> forceDumpStdMasterPersonService.practice(year, planDto, LocalDate.of(2024, 1, 1), userDto));
    }
