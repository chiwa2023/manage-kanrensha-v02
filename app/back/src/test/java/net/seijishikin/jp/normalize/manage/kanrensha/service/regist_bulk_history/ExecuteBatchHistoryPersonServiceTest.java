...
/**
 * ExecuteBatchHistoryPersonService単体テスト
 */
@SpringJUnitConfig
...
@Sql("ExecuteBatchHistoryPersonServiceTest.sql")
class ExecuteBatchHistoryPersonServiceTest {
    ...
    void test() throws Exception {
        ...
        assertDoesNotThrow(() -> executeBatchHistoryPersonService.practice(readFilePath.toString(), userDto));
    }
