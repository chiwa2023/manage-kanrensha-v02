...
/**
 * SaveRiyoushaPartnerApiEntityService単体テスト
 */
@SpringJUnitConfig
...
class SaveRiyoushaPartnerApiEntityServiceTest {
    ...
    void testAdd() throws Exception {
        ...
        // その他のidなどは空にすると新規登録
        capsuleDto.getRiyoushaPartnerApiDto().setIsCombineUser(true);
        ...
        RiyoushaPartnerApiMasterEntity savedMasterEntity = riyoushaPartnerApiMasterRepository.findById(newId).get();
        ...
        List<UserRoleEntity> listRole = userRoleRepository
                .findByEmailAndRoleAndIsLatestTrue("ccc@politician.balanse.report.net", UserRoleConstants.PARTNER_API);
        assertEquals(1, listRole.size());

        UserRoleEntity roleEntity = listRole.get(0);
        assertEquals(savedMasterEntity.getRiyoushaPartnerApiMasterCode(), roleEntity.getRiyoushaCode());
    }
    ...
    void testUpdate() throws Exception {
        ...
        capsuleDto.getRiyoushaPartnerApiDto().setInputAccessDto(accessDto);
        // id3のデータを編集したと仮定
        capsuleDto.getRiyoushaPartnerApiDto().setRiyoushaPartnerApiMasterId(3);
        capsuleDto.getRiyoushaPartnerApiDto().setRiyoushaPartnerApiMasterCode(13);
        capsuleDto.getRiyoushaPartnerApiDto().setRiyoushaPersonPropertyId(3);
        capsuleDto.getRiyoushaPartnerApiDto().setRiyoushaPersonPropertyCode(3);
