...
/**
 * GetKanrenshaKigyouDtSameHistoryService単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("GetKanrenshaKigyouDtSameHistoryServiceTest.sql")
class GetKanrenshaKigyouDtSameHistoryServiceTest { // NOPMD ManyMethod
    ...
    void test01() throws Exception {
        ...
        final String name = "ぼったくり企業"; // NOPMD
        final String address = "北海道架空市山麓町";
        final String delegate = "代表者　太郎"; // NOPMD

        List<KanrenshaKigyouDtHistoryBaseEntity> list = getKanrenshaKigyouDtSameHistoryService.practice(name, address,
                delegate);
        assertEquals(1, list.size());

        KanrenshaKigyouDtHistoryBaseEntity entity = list.get(0);
