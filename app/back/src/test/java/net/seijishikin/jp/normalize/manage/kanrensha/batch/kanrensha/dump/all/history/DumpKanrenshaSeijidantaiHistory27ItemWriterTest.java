...
/**
 * DumpKanrenshaSeijidantaiHistory27ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory27ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_27.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory27ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory27Entity entity00 = new KanrenshaSeijidantaiHistory27Entity();
        ...
        List<KanrenshaSeijidantaiHistory27Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory27Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory27ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory27ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath27", output).toJobParameters();
