...
/**
 * DumpKanrenshaKigyouDtHistory13ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaKigyouDtHistory13ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/kigyou_dt_hisotry_13.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaKigyouDtHistory13ItemWriter.beforeStep(stepExecution);

        KanrenshaKigyouDtHistory13Entity entity00 = new KanrenshaKigyouDtHistory13Entity();
        ...
        List<KanrenshaKigyouDtHistory13Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaKigyouDtHistory13Entity> items = new Chunk<>(list);
        dumpKanrenshaKigyouDtHistory13ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaKigyouDtHistory13ItemWriter.write(items);
