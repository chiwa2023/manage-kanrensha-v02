...
/**
 * SearchBulkHistoryKigyouDtService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("SearchBulkHistoryKigyouDtServiceTest.sql")
@Transactional
class SearchBulkHistoryKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        SearchWkTblHistoryKigyouDtPagingResultDto resultDto00 = searchBulkHistoryKigyouDtService.practice(capsuleDto00);
        ...
        SearchWkTblHistoryKigyouDtPagingResultDto resultDto01 = searchBulkHistoryKigyouDtService.practice(capsuleDto01);
        ...
        SearchWkTblHistoryKigyouDtPagingResultDto resultDto02 = searchBulkHistoryKigyouDtService.practice(capsuleDto02);
        ...
        SearchWkTblHistoryKigyouDtPagingResultDto resultDto03 = searchBulkHistoryKigyouDtService.practice(capsuleDto03);
        ...
        SearchWkTblHistoryKigyouDtPagingResultDto resultDto04 = searchBulkHistoryKigyouDtService.practice(capsuleDto04);
