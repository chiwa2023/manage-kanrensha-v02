...
/**
 * SearchPostalIrregularBuildingAllFloorController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/postal/SearchPostalIrregularBuildingAllFloorServiceTest.sql")
class SearchPostalIrregularBuildingAllFloorControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/postal-irregular/building-detail";
