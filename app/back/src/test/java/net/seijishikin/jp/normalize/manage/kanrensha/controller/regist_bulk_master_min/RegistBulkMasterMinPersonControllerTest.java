...
@Transactional
@Sql("../../service/regist_bulk_master_min/RegistBulkMasterMinPersonServiceTest.sql")
class RegistBulkMasterMinPersonControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        WkTblKanrenshaPersonAddMinEntity entityInput01 = wkTblKanrenshaPersonAddMinRepository.findById(218).get();
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/update-person";
