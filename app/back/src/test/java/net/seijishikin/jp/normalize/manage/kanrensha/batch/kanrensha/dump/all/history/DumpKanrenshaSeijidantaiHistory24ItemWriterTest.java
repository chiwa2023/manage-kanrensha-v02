...
/**
 * DumpKanrenshaSeijidantaiHistory24ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory24ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_24.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory24ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory24Entity entity00 = new KanrenshaSeijidantaiHistory24Entity();
        ...
        List<KanrenshaSeijidantaiHistory24Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory24Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory24ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory24ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath24", output).toJobParameters();
