...
/**
 * DeleteSnsDataController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/sns/DeleteSnsDataServiceTest.sql")
@Transactional
class DeleteSnsDataControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/sns-service/delete";
