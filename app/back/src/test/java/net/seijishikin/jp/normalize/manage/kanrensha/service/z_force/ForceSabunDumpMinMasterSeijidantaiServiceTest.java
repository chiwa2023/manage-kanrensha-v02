...
/**
 * ForceDumpMinMasterSabunSeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceSabunDumpMinMasterSeijidantaiServiceTest.sql")
class ForceSabunDumpMinMasterSeijidantaiServiceTest {
    // CHECKSTYLE:OFF
