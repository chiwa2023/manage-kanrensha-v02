...
/**
 * SearchWkTblRsdtDeleteService 単体テスト
 */
@SpringJUnitConfig
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("SearchWkTblRsdtDeleteServiceTest.sql")
class SearchWkTblRsdtDeleteServiceTest {
    ...
    void test() throws Exception {
        ...
        SearchWkTblRsdtDeleteResultDto resultDto0 = searchWkTblRsdtDeleteService.practice(capsuleDto0);
        ...
        SearchWkTblRsdtDeleteResultDto resultDto1 = searchWkTblRsdtDeleteService.practice(capsuleDto1);
        ...
        List<WkTblAddressRsdtDeleteEntity> listAns1 = resultDto1.getListEntity();

        assertEquals(2, listAns1.size());
        assertEquals(522, listAns1.get(0).getWkTblAddressRsdtDeleteId());
        assertEquals(523, listAns1.get(1).getWkTblAddressRsdtDeleteId());
        ...
        SearchWkTblRsdtDeleteResultDto resultDto2 = searchWkTblRsdtDeleteService.practice(capsuleDto2);
        ...
        List<WkTblAddressRsdtDeleteEntity> listAns2 = resultDto2.getListEntity();

        assertEquals(4, listAns2.size());
        assertEquals(522, listAns2.get(0).getWkTblAddressRsdtDeleteId());
        assertEquals(523, listAns2.get(1).getWkTblAddressRsdtDeleteId());
        assertEquals(524, listAns2.get(2).getWkTblAddressRsdtDeleteId());
        assertEquals(526, listAns2.get(3).getWkTblAddressRsdtDeleteId());
