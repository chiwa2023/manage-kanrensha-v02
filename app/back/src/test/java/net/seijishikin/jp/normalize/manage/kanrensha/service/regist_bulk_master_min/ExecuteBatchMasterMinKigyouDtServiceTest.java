...
/**
 * ExecuteBatchMasterMinKigyouDtService単体テスト
 */
@SpringJUnitConfig
...
@Sql("ExecuteBatchMasterMinKigyouDtServiceTest.sql")
class ExecuteBatchMasterMinKigyouDtServiceTest {
    ...
    void test() throws Exception {
        ...
        assertDoesNotThrow(() -> executeBatchMasterMinKigyouDtService.practice(readFilePath.toString(), userDto));
    }
