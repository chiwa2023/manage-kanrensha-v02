...
/**
 * DumpKanrenshaSeijidantaiHistory46ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory46ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_46.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory46ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory46Entity entity00 = new KanrenshaSeijidantaiHistory46Entity();
        ...
        List<KanrenshaSeijidantaiHistory46Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory46Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory46ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory46ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath46", output).toJobParameters();
