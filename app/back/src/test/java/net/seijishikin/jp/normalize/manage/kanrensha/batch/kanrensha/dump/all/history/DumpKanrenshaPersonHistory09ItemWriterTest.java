...
/**
 * DumpKanrenshaPersonHistory09ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaPersonHistory09ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/person_hisotry_09.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaPersonHistory09ItemWriter.beforeStep(stepExecution);

        KanrenshaPersonHistory09Entity entity00 = new KanrenshaPersonHistory09Entity();
        ...
        List<KanrenshaPersonHistory09Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaPersonHistory09Entity> items = new Chunk<>(list);
        dumpKanrenshaPersonHistory09ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaPersonHistory09ItemWriter.write(items);
