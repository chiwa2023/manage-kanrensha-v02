...
/**
 * SearchKanrenshaPersonListController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/kanrensha/SearchKanrenshaPersonListServiceTest.sql")
class SearchKanrenshaPersonListControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/user-kanrensha/search-person";
