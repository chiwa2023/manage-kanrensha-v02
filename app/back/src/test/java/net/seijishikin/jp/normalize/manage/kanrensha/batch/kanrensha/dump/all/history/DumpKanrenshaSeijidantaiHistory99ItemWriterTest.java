...
/**
 * DumpKanrenshaSeijidantaiHistory99ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory99ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/seijidantai_99.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory99ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory99Entity entity00 = new KanrenshaSeijidantaiHistory99Entity();
        ...
        List<KanrenshaSeijidantaiHistory99Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory99Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory99ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory99ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath99", output).toJobParameters();
