...
/**
 * DumpKanrenshaSeijidantaiHistory36ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory36ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_36.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory36ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory36Entity entity00 = new KanrenshaSeijidantaiHistory36Entity();
        ...
        List<KanrenshaSeijidantaiHistory36Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory36Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory36ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory36ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath36", output).toJobParameters();
