...
@Transactional
@Sql("../../service/regist_bulk_master_min/RegistBulkMasterMinKigyouDtServiceTest.sql")
class RegistBulkMasterMinKigyouDtControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        WkTblKanrenshaKigyouDtAddMinEntity entityInput01 = wkTblKanrenshaKigyouDtAddMinRepository.findById(102).get();
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/update-kigyou-dt";
