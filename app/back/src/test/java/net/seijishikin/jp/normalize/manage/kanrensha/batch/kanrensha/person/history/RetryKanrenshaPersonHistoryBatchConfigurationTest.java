...
/**
 * RetryKanrenshaPersonHistoryBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
@Sql("RetryKanrenshaPersonHistoryBatchConfigurationTest.sql")
class RetryKanrenshaPersonHistoryBatchConfigurationTest {
    ...
    @Autowired
    private Job retryKanrenshaPersonHistoryBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryKanrenshaPersonHistoryBatchConfiguration.JOB_NAME,
                retryKanrenshaPersonHistoryBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        JobParameters jobParameters = new JobParametersBuilder(retryKanrenshaPersonHistoryBatchConfiguration // NOPMD
