...
/**
 * ExecuteBatchHistoryKigyouDtService単体テスト
 */
@SpringJUnitConfig
...
@Sql("ExecuteBatchHistoryKigyouDtServiceTest.sql")
class ExecuteBatchHistoryKigyouDtServiceTest {
    ...
    void test() throws Exception {
        ...
        final String fileName = "関連者企業団体履歴.csv";
        ...
        assertDoesNotThrow(() -> executeBatchHistoryKigyouDtService.practice(readFilePath.toString(), userDto));
    }
