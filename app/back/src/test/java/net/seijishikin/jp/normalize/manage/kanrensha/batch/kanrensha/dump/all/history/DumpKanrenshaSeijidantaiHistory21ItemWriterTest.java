...
/**
 * DumpKanrenshaSeijidantaiHistory21ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory21ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_21.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory21ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory21Entity entity00 = new KanrenshaSeijidantaiHistory21Entity();
        ...
        List<KanrenshaSeijidantaiHistory21Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory21Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory21ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory21ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath21", output).toJobParameters();
