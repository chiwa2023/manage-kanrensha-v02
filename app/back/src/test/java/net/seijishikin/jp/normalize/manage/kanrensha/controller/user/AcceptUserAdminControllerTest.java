...
/**
 * AcceptUserAdminController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/user/AcceptUserAdminServiceTest.sql")
class AcceptUserAdminControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/user-role/accept";
