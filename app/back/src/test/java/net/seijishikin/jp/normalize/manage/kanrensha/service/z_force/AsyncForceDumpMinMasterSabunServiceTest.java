...
/**
 * AsyncForceDumpMinMasterSabunService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("AsyncForceDumpMinMasterSabunServiceTest.sql")
class AsyncForceDumpMinMasterSabunServiceTest {
    ...
    void test() throws Exception {
        ...
        capsuleDto.setDateEnd(LocalDate.of(2025, 1, 1));
