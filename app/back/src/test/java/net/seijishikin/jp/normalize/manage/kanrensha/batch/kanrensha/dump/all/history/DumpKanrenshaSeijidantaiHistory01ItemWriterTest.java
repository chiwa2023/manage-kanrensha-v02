...
/**
 * DumpKanrenshaSeijidantaiHistory01ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory01ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_01.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory01ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory01Entity entity00 = new KanrenshaSeijidantaiHistory01Entity();
        ...
        List<KanrenshaSeijidantaiHistory01Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory01Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory01ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory01ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath01", output).toJobParameters();
