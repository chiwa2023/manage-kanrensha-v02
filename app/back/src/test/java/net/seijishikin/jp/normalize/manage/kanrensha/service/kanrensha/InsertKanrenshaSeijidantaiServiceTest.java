...
class InsertKanrenshaSeijidantaiServiceTest { // NOPMD CouplingObjects
    ...
    void testOther() throws Exception {
        ...
        kanrenshaSeijidantaiDto.setIsCombineUser(false);
        ...
        final long rolePreCount = userRoleRepository.count();
        ...
        // 他人データとしたのでrole紐づけに何も起きない
        assertEquals(rolePreCount, userRoleRepository.count());
    }
    ...
    void testMyself() throws Exception {
        ...
        // DTOの準備
        InputOrgNameDto inputOrgNameDto = new InputOrgNameDto();
        inputOrgNameDto.setOrgName("ちゃらんぽらん政治団体4");
        inputOrgNameDto.setOrgNameKana("ちゃらんぽらんせいじだんたいよん");
        kanrenshaSeijidantaiDto.setInputOrgNameDto(inputOrgNameDto);
        ...
        kanrenshaSeijidantaiDto.setDantaiKbn("03");
        kanrenshaSeijidantaiDto.setPoliOrgNo("98-4321");
        kanrenshaSeijidantaiDto.setIsCombineUser(true); // 紐づける
        ...
        List<UserRoleEntity> listRole = userRoleRepository.findByEmailAndRoleAndIsLatestTrue(
                "ccc@politician.balanse.report.net", UserRoleConstants.KANRENSHA_SEIJIDANTAI);
        assertEquals(1, listRole.size());

        UserRoleEntity roleEntity = listRole.get(0);
        assertEquals(newCode, roleEntity.getKanrenshaCode());
    }
