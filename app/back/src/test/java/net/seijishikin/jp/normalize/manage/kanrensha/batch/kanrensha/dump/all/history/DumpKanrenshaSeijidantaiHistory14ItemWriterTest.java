...
/**
 * DumpKanrenshaSeijidantaiHistory14ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory14ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_14.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory14ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory14Entity entity00 = new KanrenshaSeijidantaiHistory14Entity();
        ...
        List<KanrenshaSeijidantaiHistory14Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory14Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory14ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory14ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath14", output).toJobParameters();
