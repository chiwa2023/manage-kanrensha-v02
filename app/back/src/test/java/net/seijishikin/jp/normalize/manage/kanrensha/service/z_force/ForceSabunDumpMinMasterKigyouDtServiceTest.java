...
/**
 * ForceDumpMinMasterSabunKigyouDtService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceSabunDumpMinMasterKigyouDtServiceTest.sql")
class ForceSabunDumpMinMasterKigyouDtServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceSabunDumpMinMasterKigyouDtService.practice(year, planDto,
