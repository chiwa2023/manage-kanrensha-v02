...
/**
 * DumpKanrenshaSeijidantaiHistory32ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory32ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_32.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory32ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory32Entity entity00 = new KanrenshaSeijidantaiHistory32Entity();
        ...
        List<KanrenshaSeijidantaiHistory32Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory32Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory32ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory32ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath32", output).toJobParameters();
