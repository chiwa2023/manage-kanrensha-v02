...
/**
 * InsertPartnerApiAccessHistoryY2026Logic単体テスト
 */
@SpringJUnitConfig
...
// @Transactional
@Sql("InsertPartnerApiAccessHistoryY2026LogicTest.sql")
class InsertPartnerApiAccessHistoryY2026LogicTest {
    ...
    void test() throws Exception {
        ...
        Integer newId = insertPartnerApiAccessHistoryY2026Logic.practice(baseEntity);
