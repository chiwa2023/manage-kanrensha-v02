...
/**
 * DumpKanrenshaSeijidantaiHistory19ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory19ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_19.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory19ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory19Entity entity00 = new KanrenshaSeijidantaiHistory19Entity();
        ...
        List<KanrenshaSeijidantaiHistory19Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory19Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory19ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory19ItemWriter.write(items);
