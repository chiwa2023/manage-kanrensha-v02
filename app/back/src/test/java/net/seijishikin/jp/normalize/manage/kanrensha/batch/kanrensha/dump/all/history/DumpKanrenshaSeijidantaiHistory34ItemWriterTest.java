...
/**
 * DumpKanrenshaSeijidantaiHistory34ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory34ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_34.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory34ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory34Entity entity00 = new KanrenshaSeijidantaiHistory34Entity();
        ...
        List<KanrenshaSeijidantaiHistory34Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory34Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory34ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory34ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath34", output).toJobParameters();
