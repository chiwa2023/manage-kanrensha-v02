...
/**
 * ExecuteBatchMasterMinSeijidantaiController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_min/ExecuteBatchMasterMinSeijidantaiServiceTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class ExecuteBatchMasterMinSeijidantaiControllerTest {
    ...
    void test() throws Exception {
        ...
        final String fileName = "関連者政治団体最小登録.csv";
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/execute-seijidantai";
