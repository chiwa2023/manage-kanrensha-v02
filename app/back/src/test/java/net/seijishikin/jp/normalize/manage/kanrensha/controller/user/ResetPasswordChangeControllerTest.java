...
/**
 * ResetPasswordChangeController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/security/ResetPasswordChangeServiceTest.sql")
class ResetPasswordChangeControllerTest {
    ...
    void testBadUser() throws Exception {
        ...
        capsuleDto.setEmail("eee@seijishikin.net");
        capsuleDto.setAccessCode("23456");
        capsuleDto.setPassword("998877");

        ObjectMapper objectMapper = GetObjectMapperWithTimeModuleUtil.practice();

        String path = PathRouteConstants.ROOT + "/reset-password/save";
