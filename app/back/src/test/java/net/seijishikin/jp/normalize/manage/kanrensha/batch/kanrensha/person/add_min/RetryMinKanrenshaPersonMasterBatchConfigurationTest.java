...
@Sql("RetryMinKanrenshaPersonMasterBatchConfigurationTest.sql")
class RetryMinKanrenshaPersonMasterBatchConfigurationTest {
    ...
    @Autowired
    private Job retryMinKanrenshaPersonMasterBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryMinKanrenshaPersonMasterBatchConfiguration.JOB_NAME,
                retryMinKanrenshaPersonMasterBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobOperatorTestUtils.setJob(retryMinKanrenshaPersonMasterBatchConfiguration);

        LeastUserDto userDto = CreateLeastUserForTestUtil.practice();

        JobParameters jobParameters = new JobParametersBuilder(retryMinKanrenshaPersonMasterBatchConfiguration // NOPMD
