...
/**
 * EditPostalCodeDeleteProcessor単体テスト
 */
class EditPostalCodeDeleteProcessorTest {

    @Test
    @Tag("TableTruncate")
    void test() throws Exception {

        EditPostalCodeDeleteProcessor processor = new EditPostalCodeDeleteProcessor();
        ...
        assertEquals(EditPostalConstants.DELETTE, editEntity.getFlgEdit());
