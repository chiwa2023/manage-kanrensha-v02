...
/**
 * ConvertKanrenshaPersonDtoToAddressEntityLogic単体テスト
 */
class ConvertKanrenshaPersonDtoToAddressEntityLogicTest {
    ...
    void test() throws Exception {
        ...
        ConvertKanrenshaPersonDtoToAddressEntityLogic logic = new ConvertKanrenshaPersonDtoToAddressEntityLogic();
        KanrenshaPersonDto kanrenshaPersonDto = this.createPersonDto();

        KanrenshaPersonAddressEntity addressEntity = logic.practice(kanrenshaPersonDto);

        assertEquals(kanrenshaPersonDto.getAddressId(), addressEntity.getKanrenshaPersonAddressId());
        assertEquals(kanrenshaPersonDto.getMasterId(), addressEntity.getKanrenshaPersonId());
        assertEquals(kanrenshaPersonDto.getPersonKanrenshaCode(), addressEntity.getPersonKanrenshaCode());
        assertEquals(kanrenshaPersonDto.getInputPersonNameDto().getAllName(), addressEntity.getKanrenshaName());
