...
/**
 * DumpKanrenshaSeijidantaiHistory12ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory12ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_12.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory12ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory12Entity entity00 = new KanrenshaSeijidantaiHistory12Entity();
        ...
        List<KanrenshaSeijidantaiHistory12Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory12Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory12ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory12ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath12", output).toJobParameters();
