...
/**
 * VerifyNewUserCodeController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/security/VerifyNewUserServiceTest.sql")
class VerifyNewUserCodeControllerTest {
    ...
    void test() throws Exception {
        ...
        capsuleDto.setVerifyToken("99da8d6f-92e3-466a-9f43-b2be7437b81b");
        
        ObjectMapper objectMapper = GetObjectMapperWithTimeModuleUtil.practice();

        String path = PathRouteConstants.ROOT + "/add-user/verify";
