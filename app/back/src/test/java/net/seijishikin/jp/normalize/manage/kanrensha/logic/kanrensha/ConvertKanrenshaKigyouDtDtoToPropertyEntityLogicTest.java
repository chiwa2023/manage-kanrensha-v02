...
/**
 * ConvertKanrenshaKigyouDtDtoToPropertyEntityLogic単体テスト
 */
class ConvertKanrenshaKigyouDtDtoToPropertyEntityLogicTest {
    ...
    void test() throws Exception {
        ...
        ConvertKanrenshaKigyouDtDtoToPropertyEntityLogic logic = new ConvertKanrenshaKigyouDtDtoToPropertyEntityLogic();

        KanrenshaKigyouDtDto kanrenshaKigyouDtDto = this.createKigyouDtDto();

        KanrenshaKigyouDtPropertyEntity propertyEntity = logic.practice(kanrenshaKigyouDtDto);

        assertEquals(kanrenshaKigyouDtDto.getPropertyId(), propertyEntity.getKanrenshaKigyouDtPropertyId());
        assertEquals(kanrenshaKigyouDtDto.getKigyouDtKanrenshaCode(), propertyEntity.getKigyouDtKanrenshaCode());
        assertEquals(kanrenshaKigyouDtDto.getMasterId(), propertyEntity.getKanrenshaKigyouDtId());
        assertEquals(kanrenshaKigyouDtDto.getInputOrgNameDto().getOrgName(), propertyEntity.getKanrenshaName());
        ...
        assertEquals(kanrenshaKigyouDtDto.getInputOrgNameDto().getOrgNameKana(), propertyEntity.getOrgNameKana());
