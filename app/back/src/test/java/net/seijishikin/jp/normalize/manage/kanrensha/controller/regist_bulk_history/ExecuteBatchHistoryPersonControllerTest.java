...
/**
 * ExecuteBatchHistoryPersonController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_history/ExecuteBatchHistoryPersonServiceTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class ExecuteBatchHistoryPersonControllerTest {
    ...
    void test() throws Exception {
        ...
        final String fileName = "関連者個人履歴.csv";
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-history/execute-person";
