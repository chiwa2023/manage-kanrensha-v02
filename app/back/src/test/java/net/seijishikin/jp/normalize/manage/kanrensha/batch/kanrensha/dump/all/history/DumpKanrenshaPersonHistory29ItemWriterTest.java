...
/**
 * DumpKanrenshaPersonHistory29ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaPersonHistory29ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/person_hisotry_29.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaPersonHistory29ItemWriter.beforeStep(stepExecution);

        KanrenshaPersonHistory29Entity entity00 = new KanrenshaPersonHistory29Entity();
        ...
        List<KanrenshaPersonHistory29Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaPersonHistory29Entity> items = new Chunk<>(list);
        dumpKanrenshaPersonHistory29ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaPersonHistory29ItemWriter.write(items);
