...
/**
 * GetRoleSomeoneTaskY2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("GetRoleSomeoneTaskY2025Logic.sql")
class GetRoleSomeoneTaskY2025LogicTest {
    ...
    void testAdmin() throws Exception {
        ...
        List<TaskPlanBaseEntity> listAns = getRoleSomeoneTaskY2025Logic.practice(userDto);
