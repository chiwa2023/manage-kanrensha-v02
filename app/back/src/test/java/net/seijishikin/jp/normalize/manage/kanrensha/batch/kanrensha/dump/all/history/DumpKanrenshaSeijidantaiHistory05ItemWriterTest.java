...
/**
 * DumpKanrenshaSeijidantaiHistory05ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory05ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_05.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory05ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory05Entity entity00 = new KanrenshaSeijidantaiHistory05Entity();
        ...
        List<KanrenshaSeijidantaiHistory05Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory05Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory05ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory05ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath05", output).toJobParameters();
