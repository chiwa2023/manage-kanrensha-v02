...
/**
 * RetryBatchMasterMinKigyouDtController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_min/RetryBatchMasterMinKigyouDtServiceTest.sql")
class RetryBatchMasterMinKigyouDtControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/retry-kigyou-dt";
