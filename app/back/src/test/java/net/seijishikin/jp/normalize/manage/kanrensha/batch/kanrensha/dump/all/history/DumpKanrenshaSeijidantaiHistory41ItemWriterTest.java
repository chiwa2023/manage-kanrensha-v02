...
/**
 * DumpKanrenshaSeijidantaiHistory41ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory41ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_41.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory41ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory41Entity entity00 = new KanrenshaSeijidantaiHistory41Entity();
        ...
        List<KanrenshaSeijidantaiHistory41Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory41Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory41ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory41ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath41", output).toJobParameters();
