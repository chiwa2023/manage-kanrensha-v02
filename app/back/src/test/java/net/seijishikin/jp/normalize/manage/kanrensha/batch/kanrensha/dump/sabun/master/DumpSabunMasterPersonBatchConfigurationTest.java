...
/**
 * DumpSabunMasterPersonBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
@Sql("DumpSabunMasterPersonBatchConfigurationTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class DumpSabunMasterPersonBatchConfigurationTest {
    ...
    @Autowired
    private Job dumpSabunMasterPersonBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(DumpSabunMasterPersonBatchConfiguration.JOB_NAME,
                dumpSabunMasterPersonBatchConfiguration.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(dumpSabunMasterPersonBatchConfiguration);

        JobParameters jobParameters = new JobParametersBuilder(
                dumpSabunMasterPersonBatchConfiguration.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
                ...
                .addString("writeFilePath", Paths.get(storageFolder, "sabun_master_person.csv").toString())
