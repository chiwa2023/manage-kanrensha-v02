...
/**
 * DumpKanrenshaKigyouDtHistory03ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaKigyouDtHistory03ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/kigyou_dt_hisotry_03.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaKigyouDtHistory03ItemWriter.beforeStep(stepExecution);

        KanrenshaKigyouDtHistory03Entity entity00 = new KanrenshaKigyouDtHistory03Entity();
        ...
        List<KanrenshaKigyouDtHistory03Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaKigyouDtHistory03Entity> items = new Chunk<>(list);
        dumpKanrenshaKigyouDtHistory03ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaKigyouDtHistory03ItemWriter.write(items);
