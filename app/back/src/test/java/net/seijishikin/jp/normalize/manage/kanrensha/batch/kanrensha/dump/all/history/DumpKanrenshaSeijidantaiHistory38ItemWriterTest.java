...
/**
 * DumpKanrenshaSeijidantaiHistory38ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory38ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_38.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory38ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory38Entity entity00 = new KanrenshaSeijidantaiHistory38Entity();
        ...
        List<KanrenshaSeijidantaiHistory38Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory38Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory38ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory38ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath38", output).toJobParameters();
