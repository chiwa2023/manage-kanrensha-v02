...
/**
 * ReplacePartnerApiRefreshTokenController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/security/ReplacePartnerApiRefreshTokenServiceTest.sql")
class ReplacePartnerApiRefreshTokenControllerTest {
    ...
    void testBadUser() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/partner-api/replace-token";
