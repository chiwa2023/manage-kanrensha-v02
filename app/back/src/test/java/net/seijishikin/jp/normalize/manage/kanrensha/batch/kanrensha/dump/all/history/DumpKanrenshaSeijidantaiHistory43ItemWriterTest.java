...
/**
 * DumpKanrenshaSeijidantaiHistory43ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory43ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_43.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory43ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory43Entity entity00 = new KanrenshaSeijidantaiHistory43Entity();
        ...
        List<KanrenshaSeijidantaiHistory43Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory43Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory43ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory43ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath43", output).toJobParameters();
