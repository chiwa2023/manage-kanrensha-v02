...
/**
 * RetryBatchHistorySeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("RetryBatchHistorySeijidantaiServiceTest.sql")
class RetryBatchHistorySeijidantaiServiceTest {
    ...
    void test() throws Exception {
        ...
        assertDoesNotThrow(() -> retryBatchHistorySeijidantaiService.practice(userDto, year, planDto));
