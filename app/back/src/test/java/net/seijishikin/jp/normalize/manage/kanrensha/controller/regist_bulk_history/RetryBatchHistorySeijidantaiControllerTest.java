...
/**
 * RetryBatchHistorySeijidantaiController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_history/RetryBatchHistorySeijidantaiServiceTest.sql")
class RetryBatchHistorySeijidantaiControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-history/retry-seijidantai";
