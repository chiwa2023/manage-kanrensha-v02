...
@Transactional
@Sql("../../service/regist_by_xml/SearchAddByXmlServiceTest.sql")
class SearchAddByXmlControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-by-xml/search";
