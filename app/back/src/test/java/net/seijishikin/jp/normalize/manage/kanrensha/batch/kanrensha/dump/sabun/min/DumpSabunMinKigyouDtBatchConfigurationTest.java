...
@Sql("DumpSabunMinKigyouDtBatchConfigurationTest.sql")
@ConfigurationProperties(prefix = "net.seijishikin.jp.normalize.kanrensha")
class DumpSabunMinKigyouDtBatchConfigurationTest {
    ...
    /** 起動をするJob */
    @Qualifier(DumpSabunMinKigyouDtBatchConfiguration.JOB_NAME)
    @Autowired
    private Job dumpSabunMinKigyouDtBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(DumpSabunMinKigyouDtBatchConfiguration.JOB_NAME, dumpSabunMinKigyouDtBatchConfiguration.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobOperatorTestUtils.setJob(dumpSabunMinKigyouDtBatchConfiguration);
