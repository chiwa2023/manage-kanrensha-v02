...
/**
 * RegistBulkMasterStdKigyouDtController単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("../../service/regist_bulk_master_std/RegistBulkMasterStdKigyouDtServiceTest.sql")
class RegistBulkMasterStdKigyouDtControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        WkTblKanrenshaKigyouDtMasterEntity entityInput01 = wkTblKanrenshaKigyouDtMasterRepository.findById(412).get();
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-std/update-kigyou-dt";
