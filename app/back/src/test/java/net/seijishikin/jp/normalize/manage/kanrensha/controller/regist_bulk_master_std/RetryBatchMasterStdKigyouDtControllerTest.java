...
/**
 * RetryBatchMasterStdKigyouDtController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/regist_bulk_master_std/RetryBatchMasterStdKigyouDtServiceTest.sql")
class RetryBatchMasterStdKigyouDtControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-std/retry-kigyou-dt";
