...
/**
 * SearchKanrenshaKigyouDtListController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/kanrensha/SearchKanrenshaKigyouDtListServiceTest.sql")
class SearchKanrenshaKigyouDtListControllerTest {
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/user-kanrensha/search-kigyou-dt";
