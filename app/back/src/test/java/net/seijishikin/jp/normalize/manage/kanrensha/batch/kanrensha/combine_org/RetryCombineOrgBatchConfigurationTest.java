...
@Sql("RetryCombineOrgBatchConfigurationTest.sql")
class RetryCombineOrgBatchConfigurationTest {
    ...
    @Autowired
    private Job retryCombineOrgBatchConfiguration;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(RetryCombineOrgBatchConfiguration.JOB_NAME, retryCombineOrgBatchConfiguration.getName(),
                "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        JobParameters jobParameters = new JobParametersBuilder(
                retryCombineOrgBatchConfiguration.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
