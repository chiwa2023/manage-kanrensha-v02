...
@Transactional
@Sql("../../service/regist_bulk_master_min/SearchBulkMasterMinSeijidantaiServiceTest.sql")
class SearchBulkMasterMinSeijidantaiControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        String path = PathRouteConstants.ROOT + "/regist-bulk-master-min/search-seijidantai";
