...
/**
 * ForceDumpStdMasterSabunSeijidantaiService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("ForceSabunDumpStdMasterSeijidantaiServiceTest.sql")
class ForceSabunDumpStdMasterSeijidantaiServiceTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> forceSabunDumpStdMasterSeijidantaiService.practice(year, planDto,
