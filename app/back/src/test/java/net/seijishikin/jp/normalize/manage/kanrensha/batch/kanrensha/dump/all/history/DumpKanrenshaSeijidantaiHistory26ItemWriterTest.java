...
/**
 * DumpKanrenshaSeijidantaiHistory26ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaSeijidantaiHistory26ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/output_test/seijidantai_26.csv";
        Path path = Paths.get(storageFolder, output);
        StepExecution stepExecution = this.getStepExecution(path.toString());
        dumpKanrenshaSeijidantaiHistory26ItemWriter.beforeStep(stepExecution);

        KanrenshaSeijidantaiHistory26Entity entity00 = new KanrenshaSeijidantaiHistory26Entity();
        ...
        List<KanrenshaSeijidantaiHistory26Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaSeijidantaiHistory26Entity> items = new Chunk<>(list);
        dumpKanrenshaSeijidantaiHistory26ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaSeijidantaiHistory26ItemWriter.write(items);
    ...
    private StepExecution getStepExecution(final String output) {
        ...
        JobParameters jobParameters = new JobParametersBuilder() // NOPMD
                .addString("writeFilePath26", output).toJobParameters();
