...
/**
 * DumpKanrenshaKigyouDtHistory11ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class DumpKanrenshaKigyouDtHistory11ItemWriterTest {
    ...
    void test() throws Exception {
        ...
        String output = "/test/dump/kigyou_dt_hisotry_11.csv";
        Path path = Paths.get(storageFolder, output);

        StepExecution stepExecution = this.getStepExecution(path.toString());

        dumpKanrenshaKigyouDtHistory11ItemWriter.beforeStep(stepExecution);

        KanrenshaKigyouDtHistory11Entity entity00 = new KanrenshaKigyouDtHistory11Entity();
        ...
        List<KanrenshaKigyouDtHistory11Entity> list = new ArrayList<>();
        list.add(entity00);

        // Chunkを作成してセット
        Chunk<? extends KanrenshaKigyouDtHistory11Entity> items = new Chunk<>(list);
        dumpKanrenshaKigyouDtHistory11ItemWriter.open(stepExecution.getExecutionContext());
        dumpKanrenshaKigyouDtHistory11ItemWriter.write(items);
