...
/**
 * wk_tbl_kanrensha_kigyou_dt_history接続用Entity
 */
@Entity
@Table(name = "wk_tbl_kanrensha_kigyou_dt_history")
public class WkTblKanrenshaKigyouDtHistoryEntity // NOPMD DataClass
     ...
     * テーブルIdを設定する
     *
     * @param wkKanrenshaKigyouDtHistoryId テーブルId
     */
    ...
    /** 関連者企業・団体コード */
    @Column(name = "wk_kanrensha_kigyou_dt_history_code")
    private Integer wkKanrenshaKigyouDtHistoryCode = INIT_INTEGER;
     ...
     * @return 関連者企業・団体コード
     */
    public Integer getWkKanrenshaKigyouDtHistoryCode() {
        return wkKanrenshaKigyouDtHistoryCode;
    }

    /**
     * 関連者企業・団体コードを設定する
     *
     * @param wkKanrenshaKigyouDtHistoryCode 関連者企業・団体コード
     */
    public void setWkKanrenshaKigyouDtHistoryCode(final Integer wkKanrenshaKigyouDtHistoryCode) {
        this.wkKanrenshaKigyouDtHistoryCode = wkKanrenshaKigyouDtHistoryCode;
    }
     ...
     * 団体代表者コードを設定する
     *
     * @param orgDelegateCode 団体代表者コード
     */
