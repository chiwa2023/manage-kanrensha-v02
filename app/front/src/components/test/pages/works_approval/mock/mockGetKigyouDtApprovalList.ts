import { KanrenshaKigyouDtAddressEntity, type KanrenshaKigyouDtAddressEntityInterface } from "../../../../main/entity/kanrenshaKigyouDtAddressEntity";

export default function mockGetKigyouDtApprovalList(): KanrenshaKigyouDtAddressEntityInterface[] {
    const list: KanrenshaKigyouDtAddressEntityInterface[] = [];
...
function createDto(index: number): KanrenshaKigyouDtAddressEntityInterface {
    const entity: KanrenshaKigyouDtAddressEntityInterface = new KanrenshaKigyouDtAddressEntity();
    entity.kanrenshaKigyouDtCode = "11-333" + index;
    entity.kanrenshaName = "超元素製造組合" + index;
