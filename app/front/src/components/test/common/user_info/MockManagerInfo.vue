...
import { FrameworkCapsuleDto, getErrorMessage, type FrameworkCapsuleDtoInterface, type LeastUserDtoInterface } from 'seijishikin-jp-normalize_common-tool';
...
const MESS_PAGE_NAME: string = "運営者ユーザ情報";
