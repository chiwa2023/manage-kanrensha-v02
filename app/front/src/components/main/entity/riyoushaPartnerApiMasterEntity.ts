interface RiyoushaPartnerApiMasterEntityInterface {
...
class RiyoushaPartnerApiMasterEntity implements RiyoushaPartnerApiMasterEntityInterface {
...
export { type RiyoushaPartnerApiMasterEntityInterface, RiyoushaPartnerApiMasterEntity }
