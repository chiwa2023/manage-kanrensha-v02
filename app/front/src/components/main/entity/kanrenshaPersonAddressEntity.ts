interface KanrenshaPersonAddressEntityInterface {

    /** テーブルId */
    kanrenshaPersonAddressId: number;
...
class KanrenshaPersonAddressEntity implements KanrenshaPersonAddressEntityInterface {
    ...
    constructor() {
        ...
        this.kanrenshaPersonAddressId = INIT_NUMBER;
...
export { type KanrenshaPersonAddressEntityInterface, KanrenshaPersonAddressEntity }
