interface KanrenshaSeijidantaiAddressEntityInterface {
    /** テーブルId */
    kanrenshaSeijidantaiAddressId: number;

    /** 関連者政治団体Id */
    kanrenshaSeijidantaiId: number;
...
class KanrenshaSeijidantaiAddressEntity implements KanrenshaSeijidantaiAddressEntityInterface {
    ...
    constructor() {
        ...
        this.kanrenshaSeijidantaiAddressId = INIT_NUMBER;
        this.kanrenshaSeijidantaiId = INIT_NUMBER;
...
export { type KanrenshaSeijidantaiAddressEntityInterface, KanrenshaSeijidantaiAddressEntity }
