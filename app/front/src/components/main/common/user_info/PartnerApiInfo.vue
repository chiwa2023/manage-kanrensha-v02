...
const MESS_PAGE_NAME: string = "利用者APIパートナーヘッダ";
...
<template>
    ...
    <div class="user-role-container-partner">
        <div class="user-role-content">
            <div class="user-role-title">
                <span class="user-role-text">APIパートナー</span><br>
            ...
            <div class="left-space user-role-icon-container" @click="viewPersonMenu">
                <img src="/partner_api.png" class="user-role-icon">
            </div>
        </div>
    </div>
    ...
    <div class="personMenuLayer" v-if="isVewPersonMenu">
        <PersonMenu :view-role="UserRoleConstants.ROLE_PARTNER_API" :user-dto="props.userDto"
