...
const MESS_PAGE_NAME: string = "マスタ最小強制ダンプ";
...
function onSave() {
    ...
    getAuthorizedPromiseArea().then(token => {
        const url = urlBack + "/dump-master-min/execute";
        const method = "POST";
...
<template>
    ...
    <div class="one-line">
        ...
        <div class="right-area">
            <InputDate :date="capsuleDto.dateEnd" :index="0" :is-edit="true" @send-date="recieveDateTime"></InputDate>
            <span class="left-space">まで</span>
        </div>
    </div>
