...
import { convertDateText, getErrorMessage, InputPref, MessageConstants, MessageView, PagingControl, type LeastUserDtoInterface } from 'seijishikin-jp-normalize_common-tool';
...
const MESS_PAGE_NAME: string = "地方自治体検索";
