CREATE TABLE `login_history_2026` (
  `login_history_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルid',
  `email` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'メールアドレス',
  `ip_address` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'IPアドレス',
  `user_agent` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'user-agent',
