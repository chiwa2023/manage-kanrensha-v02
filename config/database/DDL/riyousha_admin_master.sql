CREATE TABLE `riyousha_admin_master` (
  `riyousha_admin_master_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `riyousha_admin_master_code` int DEFAULT NULL COMMENT '利用者運営者コード',
  ...
  PRIMARY KEY (`riyousha_admin_master_id`),
