CREATE TABLE `wk_tbl_kanrensha_person_add_min` (
  `wk_tbl_kanrensha_person_add_min_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_kanrensha_person_add_min_code` int DEFAULT NULL COMMENT '関連者個人コード',
  ...
  PRIMARY KEY (`wk_tbl_kanrensha_person_add_min_id`)
