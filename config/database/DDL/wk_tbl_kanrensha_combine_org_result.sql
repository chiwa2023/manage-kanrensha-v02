CREATE TABLE `wk_tbl_kanrensha_combine_org_result` (
  `wk_tbl_kanrensha_combine_org_result_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_kanrensha_combine_org_id` int DEFAULT NULL COMMENT 'ワークテーブルマスタId',
  ...
  PRIMARY KEY (`wk_tbl_kanrensha_combine_org_result_id`)
