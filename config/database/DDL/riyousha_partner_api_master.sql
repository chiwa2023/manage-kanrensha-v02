CREATE TABLE `riyousha_partner_api_master` (
  `riyousha_partner_api_master_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `riyousha_partner_api_master_code` int DEFAULT NULL COMMENT '利用者運営者コード',
  ...
  `all_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '姓名',
  `all_name_kana` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '姓名かな',
  ...
  PRIMARY KEY (`riyousha_partner_api_master_id`),
