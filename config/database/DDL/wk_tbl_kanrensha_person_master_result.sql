CREATE TABLE `wk_tbl_kanrensha_person_master_result` (
  `wk_tbl_kanrensha_person_master_result_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_kanrensha_person_master_id` int DEFAULT NULL COMMENT 'ワークテーブルマスタId',
  ...
  PRIMARY KEY (`wk_tbl_kanrensha_person_master_result_id`)
