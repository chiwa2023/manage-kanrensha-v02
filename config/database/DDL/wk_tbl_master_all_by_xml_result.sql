CREATE TABLE `wk_tbl_master_all_by_xml_result` (
  `wk_tbl_master_all_by_xml_result_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_master_all_by_xml_id` int DEFAULT NULL COMMENT 'ワークテーブルマスタId',
  ...
  PRIMARY KEY (`wk_tbl_master_all_by_xml_result_id`)
