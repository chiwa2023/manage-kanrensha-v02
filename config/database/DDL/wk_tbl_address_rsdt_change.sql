CREATE TABLE `wk_tbl_address_rsdt_change` (
  `wk_tbl_address_rsdt_change_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  ...
  PRIMARY KEY (`wk_tbl_address_rsdt_change_id`)
