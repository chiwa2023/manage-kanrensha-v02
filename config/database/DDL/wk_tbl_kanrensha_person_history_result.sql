CREATE TABLE `wk_tbl_kanrensha_person_history_result` (
  `wk_kanrensha_person_history_result_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_kanrensha_person_history_id` int DEFAULT NULL COMMENT '関連者企業・団体履歴Id',
  ...
  PRIMARY KEY (`wk_kanrensha_person_history_result_id`)
