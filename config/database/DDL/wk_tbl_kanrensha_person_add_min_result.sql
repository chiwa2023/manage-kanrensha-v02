CREATE TABLE `wk_tbl_kanrensha_person_add_min_result` (
  `wk_tbl_kanrensha_person_add_min_result_id` int NOT NULL AUTO_INCREMENT COMMENT 'テーブルId',
  `wk_tbl_kanrensha_person_add_min_id` int DEFAULT NULL COMMENT '関連者個人最小登録Id',
  ...
  PRIMARY KEY (`wk_tbl_kanrensha_person_add_min_result_id`)
